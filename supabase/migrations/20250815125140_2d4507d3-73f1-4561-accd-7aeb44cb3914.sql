...
CREATE POLICY "staking_pools_authenticated_only"
ON public.staking_pools
FOR SELECT
TO authenticated
USING (true);

-- Only pool owners/admins can modify staking pools
CREATE POLICY "staking_pools_owner_insert"
ON public.staking_pools
FOR INSERT
TO authenticated
WITH CHECK (
...
CREATE POLICY "staking_pools_owner_update"
ON public.staking_pools
FOR UPDATE
TO authenticated
USING (
...
CREATE POLICY "staking_pools_owner_delete"
ON public.staking_pools
FOR DELETE
TO authenticated
USING (
...
CREATE POLICY "transaction_types_admin_manage"
ON public.transaction_types
FOR ALL
TO authenticated
USING (
