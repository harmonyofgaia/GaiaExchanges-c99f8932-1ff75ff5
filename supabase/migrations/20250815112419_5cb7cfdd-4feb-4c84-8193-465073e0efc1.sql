...
INSERT INTO public.security_audit_logs (
  ...
  '{"fix": "restricted_admin_accounts_access_to_super_admins_only", "previous_policy": "allowed_regular_admins_to_see_own_data", "new_policy": "super_admin_only_access"}',
  8
);
...
INSERT INTO public.security_incidents (
  ...
  'high',
  '{"vulnerability": "admin_accounts_table_exposed_to_regular_admins", "fix_applied": "restricted_access_to_super_admins_only", "timestamp": "' || now() || '"}',
  true,
  now(),
  auth.uid()
);