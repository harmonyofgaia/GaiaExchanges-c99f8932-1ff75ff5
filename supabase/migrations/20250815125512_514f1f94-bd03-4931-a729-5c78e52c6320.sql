...
-- 4. Secure VR animal experiences (authenticated users can view, only admins can manage since no creator column)
...
CREATE POLICY "vr_experiences_admin_insert"
ON public.vr_animal_experiences
FOR INSERT
TO authenticated
WITH CHECK (
...
CREATE POLICY "vr_experiences_admin_update"
ON public.vr_animal_experiences
FOR UPDATE
TO authenticated
USING (
...
CREATE POLICY "vr_experiences_admin_delete"
ON public.vr_animal_experiences
FOR DELETE
TO authenticated
USING (
