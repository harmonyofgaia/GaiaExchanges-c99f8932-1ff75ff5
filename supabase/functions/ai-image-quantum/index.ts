...
serve(async (req) => {
  ...
  try {
    ...
    console.log('🎨 AI IMAGE QUANTUM GENERATOR ACTIVATED:', { style, size, quality })
    ...
    const enhancedPrompt = styleEnhancements[style] || `${prompt}, ultra high resolution, masterpiece quality, professional artwork`
