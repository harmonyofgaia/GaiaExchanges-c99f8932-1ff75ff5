...
export const ENHANCED_GAIA_PROJECTS: GAiAProject[] = [
  {
    ...
    description: 'Revolutionary 7-phase land restoration combining regenerative agriculture with advanced soil recovery techniques. Transforming degraded land into productive, sustainable farming ecosystems that support local communities.',
    status: 'active',
    tags: ['Land Restoration', 'Regenerative Agriculture', 'Soil Recovery', 'Sustainable Farming', 'Community Support'],
    fundingGoal: 500000,
    ...
    progress: 25,
    impact: 'Very High',
    expectedImpact: 'Will restore 10,000 acres of degraded land and support 200+ farming families with sustainable livelihoods',
  ...
  },
  {
    ...
    description: 'Advanced research project to eliminate PVAS (Poly- and perfluoroalkyl substances) contamination from water systems using bio-engineered filtration and molecular breakdown technologies.',
    status: 'active',
    tags: ['Water Purification', 'PVAS Removal', 'Chemical Remediation', 'Bio-Engineering', 'Environmental Health'],
    fundingGoal: 350000,
    ...
    progress: 25,
    impact: 'Very High',
    expectedImpact: 'Will develop revolutionary PVAS removal technology to clean contaminated water systems affecting millions of people worldwide',
  ...
  },
  {
    ...
    description: 'Innovative program helping families relocate internationally while integrating elder care solutions. Creating sustainable communities where multiple generations can thrive together.',
    status: 'active',
    tags: ['Community Relocation', 'Elder Care', 'International Migration', 'Sustainable Housing', 'Family Integration'],
    fundingGoal: 750000,
    ...
    progress: 25,
    impact: 'High',
    expectedImpact: 'Will facilitate relocation for 500+ families and create 50+ integrated elder care communities worldwide',
...
export const PROJECT_INVESTMENT_TIERS = {
  ...
  gold: { min: 5000, max: 19999, reward: 'All Silver + Direct Researcher Contact' },
  platinum: { min: 20000, max: 49999, reward: 'All Gold + Co-Author Opportunities' },
  diamond: { min: 50000, max: Infinity, reward: 'All Platinum + Project Steering Committee' }
}