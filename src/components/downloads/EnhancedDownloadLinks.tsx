      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {downloadOptions.map((option, index) => (
            <Card key={index} className="border-gray-600/30 hover:border-blue-500/50 transition-colors">
        ...
        <div className="mt-6 p-4 bg-green-900/20 border border-green-500/30 rounded-lg">
          ...
          <p className="text-green-300 text-sm">
            All downloads are digitally signed and verified. Our applications use end-to-end encryption 
            and never store your private keys on our servers.
          </p>
        </div>
      </CardContent>
    </Card>
