...
export function EnhancedHabboTycoon() {
  ...
  const buildingTypes = [
    { id: 'hotel', name: 'Luxury Hotel', cost: 50000, income: 5000, icon: Building2 },
    { id: 'rollercoaster', name: 'Epic Rollercoaster', cost: 150000, income: 12000, icon: Rocket },
    { id: 'restaurant', name: 'Gourmet Restaurant', cost: 75000, income: 8000, icon: Star },
    { id: 'spa', name: 'Quantum Spa', cost: 200000, income: 18000, icon: Zap },
    { id: 'casino', name: 'Galaxy Casino', cost: 500000, income: 45000, icon: Crown }
  ]
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          ...
          <div className="text-center p-4 bg-blue-900/50 rounded-lg border-2 border-blue-500/50">
            ...
            <div className="text-2xl font-black text-blue-400">{tycoonState.dailyVisitors.toLocaleString()}</div>
          ...
          <div className="text-center p-4 bg-green-900/50 rounded-lg border-2 border-green-500/50">
            ...
            <div className="text-2xl font-black text-green-400">${tycoonState.totalRevenue.toLocaleString()}</div>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center space-y-4">
                ...
                <div className="grid grid-cols-3 gap-4 text-sm">
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-green-400">{tycoonState.attractions}</div>
                    <div>Attractions</div>
                  </div>
                  <div className="text-center">
