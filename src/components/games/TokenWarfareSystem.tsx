  ...
  const initiateBattle = (token: CustomToken) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        const updatedBattle = { ...newBattle, status: 'completed' as const, winner }
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {userTokens.map((token) => (
              <Card key={token.id} className="bg-gradient-to-br from-purple-800/20 to-red-800/20 border-purple-400/20">
          ...
          <CardContent>
            <div className="space-y-4">
              {activeBattles.map((battle) => (
                <Card key={battle.id} className="bg-gradient-to-br from-red-800/20 to-orange-800/20 border-red-400/20">
                  <CardContent className="p-4">
                    <div className="grid grid-cols-3 gap-4 items-center">
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-sm text-red-400">Power: {battle.player1Token.power}</div>
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-sm text-yellow-300">
                          {battle.status === 'active' ? 'FIGHTING!' : 
                           battle.status === 'completed' ? 'FINISHED' : 'PENDING'}
                        </div>
                        {battle.winner && (
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-sm text-red-400">Power: {battle.player2Token.power}</div>
                        <Badge variant="outline" className="mt-1">
                          {battle.player2}
                        </Badge>
                      </div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="text-center p-4 bg-green-800/20 rounded-lg">
              ...
              <p className="text-sm text-green-400/80">Purchase special terrains for Virtual World</p>
            </div>
          </div>
        </CardContent>
      </Card>
