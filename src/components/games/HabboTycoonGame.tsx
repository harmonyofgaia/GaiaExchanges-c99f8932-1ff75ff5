                ...
                <div className="h-64 bg-black/50 rounded-lg border border-blue-500/30 p-4 overflow-y-auto">
                  <div className="space-y-2 text-sm">
                    <div className="text-green-400">
                      🏨 TycoonMaster47: Anyone want to form an alliance?
                    </div>
                    <div className="text-blue-400">
                      👑 HotelEmperor: My casino is making bank today! 💰
                    </div>
                    <div className="text-purple-400">
                      🎢 RideBuilder: New rollercoaster design is amazing!
                    </div>
                    <div className="text-yellow-400">
                      💼 BusinessMogul: Trading rare building materials
                    </div>
                    <div className="text-pink-400">
                      🌟 StarManager: VIP event tonight at my resort!
                    </div>
                    <div className="text-cyan-400">
                      🎯 {playerData.name}: Ready to dominate the tycoon world!
                    </div>
                  </div>
                </div>
