    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card className="bg-black/30 border-yellow-500/30">
          <CardContent className="pt-6">
            <div className="text-center">
              <div className="text-2xl font-bold text-yellow-400">{gameStats.transitionBonuses}</div>
        ...
        <Card className="bg-gradient-to-r from-green-600/30 to-purple-600/30 border-green-500/30 animate-pulse">
          ...
          <CardContent>
            ...
            <div className="text-center text-lg font-bold text-purple-400">
              {transitionProgress < 50 ? '🐍 Snake Victory Sequence...' : '🪱 Transforming into Worms...'}
            </div>
          </CardContent>
        </Card>
      )}
      ...
      <Card className="bg-black/30 border-blue-500/30">
        ...
        <CardContent>
          <div className="grid grid-cols-30 gap-px bg-gray-800 p-2 rounded-lg mb-4" style={{ aspectRatio: '3/2' }}>
            {Array.from({ length: 600 }, (_, i) => {
              ...
              const isWorm = worms.some(worm => 
                worm.health > 0 && worm.segments.some(segment => segment.x === x && segment.y === y)
              )
        ...
        <Card className="bg-black/30 border-purple-500/30">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {worms.filter(w => w.health > 0).map((worm) => (
                <div 
                  key={worm.id} 
                ...
                >
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-purple-400 font-medium">Worm {worm.id.split('-')[1]}</span>
                  </div>
