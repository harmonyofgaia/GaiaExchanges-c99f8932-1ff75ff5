            ...
            {gameState === 'blackhole' && (
              <div className="absolute inset-0 flex items-center justify-center bg-black/90 rounded-lg">
                <div className="text-center">
                  ...
                  <div className="text-2xl font-bold text-purple-400 mb-4">BLACKHOLE ACTIVATED!</div>
                  <div className="text-sm text-muted-foreground mb-4">
                    You collected {gameStats.tokensCollected} GAIA tokens!<br/>
            ...
            {gameState === 'gameover' && (
              <div className="absolute inset-0 flex items-center justify-center bg-black/80 rounded-lg">
                <div className="text-center">
                  ...
                  <div className="text-sm text-muted-foreground mb-4">
                    Collected: {gameStats.tokensCollected} GAIA tokens<br/>
        ...
        {gameState === 'playing' && (
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              ...
              <span className="text-purple-400">{gameStats.tokensCollected}/{WIN_THRESHOLD} GAIA</span>
            </div>
            <Progress 
