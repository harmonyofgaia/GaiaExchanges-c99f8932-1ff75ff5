...
export function EnhancedBadgeSystem() {
  ...
  const categories = ['All', 'Starter', 'Transportation', 'Conservation', 'Energy', 'Achievement', 'Social']
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="p-4 bg-purple-900/20 rounded-lg border border-purple-500/20 text-center">
              ...
              <div className="text-2xl font-bold text-purple-400">{earnedBadges}/{badges.length}</div>
            ...
            {filteredBadges.map((badge) => (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div className={`p-2 rounded-lg ${badge.earned ? getRarityColor(badge.rarity) : 'bg-gray-700'}`}>
