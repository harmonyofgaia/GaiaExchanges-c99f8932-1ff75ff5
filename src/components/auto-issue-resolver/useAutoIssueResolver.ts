      ...
      try {
        ...
        const checkFileIntegrity = () => {
          ...
          allScripts.forEach((script) => {
            ...
            if (
              ...
              (content.includes("setTimeout(") && content.includes("atob("))
            ) {
              newIssues.push({
                id: `malware-${Date.now()}`,
                type: "error",
        ...
        const checkWalletSecurity = () => {
          ...
          walletKeys.forEach((key) => {
            if (localStorage.getItem(key) || sessionStorage.getItem(key)) {
              ...
              if (
                localStorage.getItem(key)?.includes("seed") ||
                localStorage.getItem(key)?.includes("private")
              ) {
                newIssues.push({
          ...
          const apps = [
            {
              ...
              selector: '[data-testid="trading-interface"]',
            },
            {
              name: "Wallet System",
              selector: '[data-testid="wallet-system"]',
            },
        ...
        const checkAdminSecurity = () => {
          ...
          buttons.forEach((button) => {
            if (
              button.textContent?.toLowerCase().includes("admin") ||
