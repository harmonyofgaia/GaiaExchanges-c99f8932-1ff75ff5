...
export const EmailTemplate: React.FC<EmailTemplateProps> = ({
  ...
  const getBackgroundColor = () => {
    switch (type) {
      case 'newsletter': return 'from-green-900/20 to-emerald-900/20'
      case 'announcement': return 'from-blue-900/20 to-purple-900/20'
      case 'trading-alert': return 'from-orange-900/20 to-red-900/20'
      default: return 'from-gray-900/20 to-black/20'
    }
  }
    ...
    <div className={`w-full max-w-2xl mx-auto bg-gradient-to-br ${getBackgroundColor()} border border-green-500/20 rounded-lg overflow-hidden`}>
      ...
      <div className="bg-black/30 p-4 text-center border-t border-green-500/10">
        ...
        <p className="text-gray-400 text-xs">
          © 2024 Harmony of Gaia. Making the world a better place through environmental cryptocurrency.
        </p>
      </div>
    </div>
  )
