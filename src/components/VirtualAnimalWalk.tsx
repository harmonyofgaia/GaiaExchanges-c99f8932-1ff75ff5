...
export function VirtualAnimalWalk() {
  ...
  const popularDestinations = [
    { name: 'Amazon Rainforest, Brazil', type: 'Jungle', difficulty: 'Advanced' },
    { name: 'Serengeti National Park, Tanzania', type: 'Savanna', difficulty: 'Intermediate' },
    { name: 'Yellowstone National Park, USA', type: 'Mountain', difficulty: 'Beginner' },
    { name: 'Great Barrier Reef, Australia', type: 'Ocean', difficulty: 'Expert' },
    { name: 'Norwegian Fjords, Norway', type: 'Arctic', difficulty: 'Intermediate' },
