    ...
    <div className="space-y-6">
        ...
        <CardHeader>
          <CardTitle className="flex items-center gap-3 text-green-400">
            ...
            <div>
              ...
              <div className="text-sm font-normal">🦁🐬 Lions & Dolphins Standard - 100% Perfect</div>
            </div>
            <Badge variant="outline" className="border-green-500/20 text-green-400 text-xl px-4 py-2 animate-pulse">
              ...
              <div className="bg-green-900/20 rounded-lg p-4 border border-green-500/20">
                <div className="text-center space-y-2">
                  ...
                  <div className="text-3xl font-bold text-green-400">
                    {new Intl.NumberFormat('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(gaiaWallet.balance)} GAiA
                  </div>
                  <div className="text-lg text-muted-foreground">
                    ≈ ${new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(gaiaWallet.balance * 3.00)}
                  </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {conditions.map((condition, index) => (
          <Card key={index} className="border border-gray-500/20 bg-gradient-to-br from-gray-900/50 to-gray-800/50 hover:border-green-500/30 transition-all duration-300">
        ...
        <CardContent className="p-8">
          <div className="text-center space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <h4 className="text-xl font-bold text-purple-400">🐬 DOLPHIN INTELLIGENCE PROMISE:</h4>
            ...
            <div className="bg-gradient-to-r from-green-900/40 to-blue-900/40 rounded-lg p-6 border border-green-500/30">
              ...
              <p className="text-lg text-muted-foreground mt-2">
                We work together like Lions of the System - Always upgrading, always improving, always becoming better!
              </p>
