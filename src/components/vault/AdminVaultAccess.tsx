...
export function AdminVaultAccess() {
  ...
  const getStepIcon = (step: number, verified: boolean) => {
    ...
    switch (step) {
      case 1: return <Key className="h-5 w-5 text-yellow-400" />
      case 2: return <Shield className="h-5 w-5 text-blue-400" />
      case 3: return <Fingerprint className="h-5 w-5 text-purple-400" />
      case 4: return <Eye className="h-5 w-5 text-red-400" />
        ...
        <CardContent className="space-y-6">
          {!access ? (
            ...
            <div className="space-y-6">
              ...
              <Card className={`border ${currentStep === 1 ? 'border-yellow-500/50 bg-yellow-500/5' : access.step_1_verified ? 'border-green-500/50 bg-green-500/5' : 'border-gray-500/20'}`}>
                <CardContent className="p-4">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <Badge className={access.step_1_verified ? 'bg-green-600' : currentStep === 1 ? 'bg-yellow-600' : 'bg-gray-600'}>
                      {access.step_1_verified ? 'Verified' : currentStep === 1 ? 'Active' : 'Pending'}
                    </Badge>
                  </div>
                  {currentStep === 1 && !access.step_1_verified && (
                    <div className="space-y-3">
                      <Input
                        ...
                        onChange={(e) => setStepInputs({ ...stepInputs, password: e.target.value })}
                      />
                      <Button 
              ...
              <Card className={`border ${currentStep === 2 ? 'border-blue-500/50 bg-blue-500/5' : access.step_2_verified ? 'border-green-500/50 bg-green-500/5' : 'border-gray-500/20'}`}>
                <CardContent className="p-4">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                    ...
                    <Badge className={access.step_2_verified ? 'bg-green-600' : currentStep === 2 ? 'bg-blue-600' : 'bg-gray-600'}>
                      {access.step_2_verified ? 'Verified' : currentStep === 2 ? 'Active' : 'Pending'}
                    </Badge>
                  </div>
                  {currentStep === 2 && !access.step_2_verified && (
                    <div className="space-y-3">
                      <Input
                        ...
                        onChange={(e) => setStepInputs({ ...stepInputs, twoFactor: e.target.value })}
                        maxLength={6}
                      />
                      <Button 
              ...
              <Card className={`border ${currentStep === 3 ? 'border-purple-500/50 bg-purple-500/5' : access.step_3_verified ? 'border-green-500/50 bg-green-500/5' : 'border-gray-500/20'}`}>
                <CardContent className="p-4">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                    ...
                    <Badge className={access.step_3_verified ? 'bg-green-600' : currentStep === 3 ? 'bg-purple-600' : 'bg-gray-600'}>
                      {access.step_3_verified ? 'Verified' : currentStep === 3 ? 'Active' : 'Pending'}
                    </Badge>
                  </div>
              ...
              {/* Step 4: Retinal Scan */}
              <Card className={`border ${currentStep === 4 ? 'border-red-500/50 bg-red-500/5' : access.step_4_verified ? 'border-green-500/50 bg-green-500/5' : 'border-gray-500/20'}`}>
                <CardContent className="p-4">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                    ...
                    <Badge className={access.step_4_verified ? 'bg-green-600' : currentStep === 4 ? 'bg-red-600' : 'bg-gray-600'}>
                      {access.step_4_verified ? 'Verified' : currentStep === 4 ? 'Active' : 'Pending'}
                    </Badge>
                  </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-r from-yellow-900/20 to-orange-900/20">
        <CardContent className="pt-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              This 4-step verification ensures that only authorized administrators can access vault funds for humanitarian projects and community surprises.
            </p>
          </div>
        </CardContent>
      </Card>
