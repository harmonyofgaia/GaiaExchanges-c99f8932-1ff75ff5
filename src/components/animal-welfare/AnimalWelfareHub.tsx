  ...
  const [animals, setAnimals] = useState<RealAnimal[]>([
    {
      ...
      urgencyLevel: 'high',
      story: 'Maya was rescued from illegal captivity. She needs specialized care and a larger habitat to prepare for potential release.',
    ...
    },
    {
      ...
      urgencyLevel: 'medium',
      story: 'Charlie lost his family to poaching. He\'s learning to trust humans again and needs ongoing therapy and care.',
      images: ['/api/placeholder/400/300'],
    ...
    },
    {
      ...
      story: 'Luna was found injured during harsh winter conditions. She needs immediate medical care and rehabilitation.',
      images: ['/api/placeholder/400/300'],
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <span className="font-bold">
                          {animal.currentFunding.toLocaleString()} / {animal.fundingGoal.toLocaleString()} GAiA
                        </span>
                      </div>
                      <Progress 
                    ...
                    <div className="bg-black/30 p-3 rounded border border-green-500/20">
                      <div className="text-xs text-muted-foreground mb-1">Dedicated Animal Wallet:</div>
