      ...
      <Card className="border-pink-500/30 bg-gradient-to-r from-pink-900/20 to-purple-900/20">
        <CardHeader>
          ...
          <p className="text-pink-300">
            Configure how your transaction fees automatically support global animal welfare initiatives
          </p>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="flex items-center justify-between p-4 rounded-lg bg-pink-500/10 border border-pink-500/20">
            <div>
              <Label className="text-base font-medium text-pink-400">🐾 Animal Welfare Support (Recommended)</Label>
            ...
            <>
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="animal_welfare">🐾 Animal Welfare (Recommended - Save Animals)</SelectItem>
                    <SelectItem value="vault">🏦 Community Vault (Admin Surprises)</SelectItem>
                    <SelectItem value="green_projects">🌱 Green Projects (Environmental)</SelectItem>
        ...
        <CardContent>
            ...
            <Card className="border-yellow-500/50 bg-gradient-to-r from-yellow-900/30 to-orange-900/30 animate-pulse mb-6">
              <CardContent className="pt-4">
                <div className="flex items-center justify-center gap-2 text-yellow-400">
                  ...
                  <span className="font-bold">LIVE FEE PROCESSING - Distributing to Animal Welfare Projects</span>
                  <Zap className="h-5 w-5 animate-bounce" />
                </div>
              </CardContent>
            </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {animalProjects.map((project) => (
              <Card key={project.id} className="border-pink-500/20 bg-gradient-to-br from-pink-900/10 to-purple-900/10">
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-pink-400">{project.allocation_percentage}%</span>
                    </div>
