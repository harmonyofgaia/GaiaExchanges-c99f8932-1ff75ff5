...
const realAnimalsInNeed: Animal[] = [
  {
    ...
    description: 'The world\'s rarest big cat with only 130 individuals left in the wild. Urgent conservation efforts needed.',
  ...
  },
  {
    ...
    description: 'One of the rarest mammals on Earth, confined to a single park in Java with extreme vulnerability.',
    image: '/api/placeholder/300/200',
  ...
  },
  {
    ...
    description: 'Critically endangered elephants losing habitat to rapid deforestation and agricultural expansion.',
    image: '/api/placeholder/300/200',
  ...
  },
  {
    ...
    description: 'Critically endangered sea turtles essential for coral reef health, threatened by human activities.',
    image: '/api/placeholder/300/200',
  ...
  },
  {
    ...
    description: 'Elusive big cats of the mountains, losing habitat due to climate change and human encroachment.',
    image: '/api/placeholder/300/200',
  ...
  },
  {
    ...
    description: 'Critically endangered great apes losing their rainforest homes to industrial agriculture.',
    image: '/api/placeholder/300/200',
  ...
  },
  {
    ...
    description: 'The world\'s most trafficked mammal, all 8 species are threatened with extinction.',
    image: '/api/placeholder/300/200',
  ...
  },
  {
    ...
    description: 'World\'s only flightless parrot, critically endangered with intensive management required.',
    image: '/api/placeholder/300/200',
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredAnimals.map((animal) => (
          <Card key={animal.id} className="border-gray-500/30 bg-gradient-to-br from-gray-900/30 to-slate-900/30 hover:border-green-500/50 transition-colors">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span>${animal.fundsRaised.toLocaleString()} / ${animal.fundsNeeded.toLocaleString()}</span>
                </div>
                <div className="w-full bg-gray-700 rounded-full h-2">
                  <div 
                    className="bg-green-600 h-2 rounded-full transition-all duration-300"
                    style={{ width: `${(animal.fundsRaised / animal.fundsNeeded) * 100}%` }}
                  ></div>
                </div>
              </div>
