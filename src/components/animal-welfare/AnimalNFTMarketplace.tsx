      ...
      <Card className="border-purple-500/30">
        <CardHeader>
          ...
          <p className="text-muted-foreground">
            Purchase NFTs to become an official guardian. 100% of proceeds go to the animal's
            dedicated wallet.
          </p>
        </CardHeader>
      </Card>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <Badge className={getRarityBadge(nft.rarity)}>{nft.rarity.toUpperCase()}</Badge>
                  </div>
                ...
                <div className="bg-black/40 p-3 rounded border border-green-500/20">
                  ...
                  <div className="text-xs text-muted-foreground">
                    Your purchase goes directly to this animal's wallet for care, food, and
                    rehabilitation.
                  </div>
                </div>
              </div>
