...
export function GlobalExchangeIntegration() {
  const [exchanges, setExchanges] = useState<Exchange[]>([
    ...
    { name: 'Kraken', status: 'pending', volume: '$456M', users: '9M', region: 'Global' },
    { name: 'KuCoin', status: 'active', volume: '$234M', users: '28M', region: 'Global' },
    { name: 'Huobi', status: 'negotiating', volume: '$567M', users: '45M', region: 'Asia' },
    { name: 'OKEx', status: 'listing', volume: '$678M', users: '32M', region: 'Global' }
  ])
