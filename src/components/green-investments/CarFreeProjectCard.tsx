...
export function CarFreeProjectCard() {
  ...
  return (
    <Card className="rounded-lg border border-white/10 bg-neutral-950/50 p-4 shadow-md backdrop-blur">
      ...
      <CardContent className="px-0 pt-4">
        <div className="grid grid-cols-3 gap-2 text-center">
          <div className="rounded-lg bg-neutral-900/50 border border-white/10 p-2">
