      ...
      <Card className="border-green-500/30 bg-gradient-to-r from-green-900/20 to-emerald-900/20">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex items-center justify-between p-4 rounded-lg bg-green-500/10 border border-green-500/20">
            <div>
              <Label className="text-base font-medium text-green-400">🌱 Green Project Support (Recommended)</Label>
      ...
      <Card className="border-emerald-500/30 bg-gradient-to-r from-emerald-900/20 to-green-900/20">
        <CardHeader>
          ...
          <p className="text-emerald-300">
            All community fees are automatically reinvested into global environmental and sustainability projects
          </p>
          <div className="bg-black/30 p-3 rounded-lg">
            <div className="text-sm text-muted-foreground mb-1">Official Green Investment Wallet:</div>
            <div className="font-mono text-green-400 text-sm break-all">{GREEN_INVESTMENT_WALLET}</div>
          </div>
        </CardHeader>
        <CardContent>
