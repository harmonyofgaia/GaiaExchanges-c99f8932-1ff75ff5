  ...
  const [defenseBots, setDefenseBots] = useState<AIDefenseBot[]>([
    {
      ...
      name: "Guardian Alpha",
      status: "hunting",
      targetsNeutralized: 67,
      attacksBlocked: 134,
      lastAction: "Blocked malware injection",
      powerLevel: 95,
    },
    {
      id: "sentinel-beta",
      name: "Sentinel Beta",
      status: "active",
      targetsNeutralized: 45,
      attacksBlocked: 89,
      lastAction: "Neutralized phishing attempt",
      powerLevel: 88,
    },
    {
      id: "defender-gamma",
      name: "Defender Gamma",
      status: "attacking",
      targetsNeutralized: 78,
      attacksBlocked: 156,
      lastAction: "Counter-attacking DDoS source",
      powerLevel: 92,
    },
    {
      id: "protector-delta",
      name: "Protector Delta",
      status: "defending",
      targetsNeutralized: 56,
      attacksBlocked: 112,
      lastAction: "Shielding user data",
      powerLevel: 85,
    },
    {
      id: "warrior-epsilon",
      name: "Warrior Epsilon",
      status: "hunting",
      targetsNeutralized: 89,
      attacksBlocked: 178,
      lastAction: "Tracking scammer network",
      powerLevel: 97,
    },
    {
      id: "guardian-zeta",
      name: "Guardian Zeta",
      status: "active",
      targetsNeutralized: 34,
      attacksBlocked: 67,
      lastAction: "Monitoring suspicious activity",
      powerLevel: 82,
    },
    {
      id: "sentinel-eta",
      name: "Sentinel Eta",
      status: "attacking",
      targetsNeutralized: 91,
      attacksBlocked: 201,
      lastAction: "Dismantling botnet",
      powerLevel: 99,
    },
    {
      id: "defender-theta",
      name: "Defender Theta",
      status: "defending",
      targetsNeutralized: 23,
      attacksBlocked: 45,
      lastAction: "Reinforcing network barriers",
      powerLevel: 78,
    },
  ]);
      ...
      <Card className="border-2 border-blue-500/50 bg-gradient-to-br from-blue-900/40 to-cyan-900/40 shadow-2xl">
        ...
        <CardContent>
          ...
          <div className="mt-6">
            ...
            {isDeployingBots && <Progress value={75} className="mt-2 h-3" />}
          </div>
        </CardContent>
      </Card>
