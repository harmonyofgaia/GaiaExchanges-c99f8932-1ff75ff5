    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {security.securityLayers.map((layer) => (
          <Card
            key={layer.id}
            className="border-green-500/30 bg-gradient-to-br from-green-900/20 to-black/50"
          >
            ...
            <CardContent>
              <div className="flex items-center justify-between">
                <Badge
                  className={`${layer.status === "active" ? "bg-green-600" : "bg-red-600"} text-white`}
                >
      ...
      <Card className="border-2 border-yellow-500/50 bg-gradient-to-br from-yellow-900/30 to-orange-900/30">
        ...
        <CardContent className="space-y-4">
          ...
          <Button
            onClick={launchEmergencyProtocol}
            ...
            <div className="max-h-32 overflow-y-auto space-y-2">
              {security.investorLeads.map((lead) => (
                ...
                >
                  ...
                  <Badge
                    className={`text-xs ${lead.priority === "high" ? "bg-red-600" : lead.priority === "medium" ? "bg-yellow-600" : "bg-green-600"} text-white`}
                  >
                    {lead.priority}
                  </Badge>
                </div>
