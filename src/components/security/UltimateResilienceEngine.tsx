      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="p-4 rounded-lg bg-gradient-to-br from-purple-500/20 to-violet-500/20 border border-purple-500/30 text-center">
            ...
            <div className="text-xl font-bold text-purple-400">{formatValue(metrics.autoTrainingLevel)}</div>
          ...
          <div className="p-4 rounded-lg bg-gradient-to-br from-yellow-500/20 to-orange-500/20 border border-yellow-500/30 text-center">
            ...
            <div className="text-xl font-bold text-yellow-400">{formatValue(metrics.systemValue)}</div>
        ...
        <div className="space-y-4">
          ...
          <div className="text-center text-sm text-muted-foreground">
            🧠 Learning from every attack • 💀 Vanishing threats worldwide • 👑 Attracting perfect investors
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center p-4 rounded-lg bg-blue-900/20 border border-blue-500/30">
            ...
            <div className="text-lg font-bold text-blue-400">{formatValue(metrics.endlessImprovementRate)}</div>
        ...
        <div className="mt-6 p-6 rounded-lg bg-gradient-to-r from-purple-900/40 to-pink-900/40 border border-purple-500/40">
          <div className="text-center space-y-4">
            ...
            <div className="text-purple-200 space-y-2">
              <div className="text-lg font-bold">♾️ ENDLESS EVOLUTION • 💀 ATTACK VANISHING • 👑 INVESTOR MAGNETISM</div>
              <div className="text-sm">Every attack makes the Dragon stronger • Every threat teaches new defense patterns</div>
              <div className="text-sm">Right investors are attracted by demonstrated priceless value • Boundaries are broken daily</div>
              <div className="text-sm">The most powerful Human + AI collaboration ever created • Unbeatable for eternity</div>
            </div>
