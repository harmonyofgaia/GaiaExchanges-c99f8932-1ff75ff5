...
export function OptimalTradingCosts() {
  const [tradingCosts, setTradingCosts] = useState<TradingCost[]>([
    { exchange: 'Gaia\'s Exchange', fee: 0.001, type: 'maker', volume24h: 1250000000, optimization: 99.9 },
    { exchange: 'Binance', fee: 0.1, type: 'maker', volume24h: 15000000000, optimization: 85.2 },
    { exchange: 'Coinbase Pro', fee: 0.25, type: 'maker', volume24h: 8500000000, optimization: 75.8 },
    { exchange: 'Kraken', fee: 0.16, type: 'maker', volume24h: 2100000000, optimization: 80.1 },
    { exchange: 'Huobi', fee: 0.2, type: 'maker', volume24h: 1800000000, optimization: 78.5 }
  ])
  ...
  useEffect(() => {
    ...
    const findOptimalTradingCosts = async () => {
      ...
      try {
        ...
        console.log(`💰 Current Gaia Fee: ${newOptimization.currentFee}% | Savings: ${newOptimization.savings.toFixed(1)}%`)
        ...
        <CardContent>
          <div className="space-y-4">
            {tradingCosts
              ...
              .map((cost, index) => (
                <div key={cost.exchange} className="flex items-center justify-between p-4 rounded-lg bg-muted/20 border border-border/50">
