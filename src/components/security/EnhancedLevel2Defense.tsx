        ...
        try {
          ...
          const detectLevel1Threats = () => {
            const basicThreatPatterns = [
              ...
              'hack_attempt', 'security_bypass', 'unauthorized_access'
            ]
              ...
              if (pageContent.includes(pattern)) {
                if (!level1BreachedIPs.current.has(userIP)) {
                  ...
                  toast.warning(`⚠️ Level 1 Defense Alert - IP: ${userIP}`, {
                    description: 'Suspicious activity detected from your IP. Enhanced monitoring active.',
                    duration: 8000
                  })
                }
              }
          ...
          const detectLevel2Breaches = () => {
            ...
            const advancedAttackPatterns = [
              ...
              'defense_bypass', 'wall_attack', 'security_breach', 'system_penetration',
              'admin_access', 'root_access', 'privilege_escalation'
            ]
                  ...
                  setTimeout(() => {
                    if (!enhancedInvisibilityIPs.current.has(userIP)) {
                      ...
                      toast.error(`👻 ENHANCED INVISIBILITY ACTIVE - IP: ${userIP}`, {
                        description: 'Level 2 breach triggered quantum invisibility. This IP is now isolated.',
                        duration: 20000
                      })
                      ...
                      setTimeout(() => {
                        if (!counterAttackLaunched.current.has(userIP)) {
                          ...
                          console.log('⚡ HIGH-SPEED DEMOLITION: Target system destruction initiated')
                          console.log('🔥 QUANTUM RETALIATION: Maximum force authorized')
                          
                          toast.error(`💀 COUNTER-ATTACK LAUNCHED: ${userIP}`, {
                            description: 'High-speed system demolition in progress - Quantum retaliation active',
                            duration: 15000
                          })
                        }
                      }, 5000)
