      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="space-y-2">
            ...
            <div className="text-2xl font-bold text-primary">{status.galacticDominations.completed}</div>
          </div>
          <div className="space-y-2">
            <div className="flex items-center gap-2">
        ...
        <div className="space-y-2">
          ...
          <div className="text-3xl font-bold text-primary">{status.universalAuthorityLevel.toLocaleString()}</div>
        </div>
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <Star className="h-4 w-4 text-primary" />
          ...
          <div className="text-sm text-muted-foreground">{(status.galacticDominations.averageDomination * 100).toFixed(1)}% Complete</div>
        </div>
