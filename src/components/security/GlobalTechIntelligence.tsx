...
export function GlobalTechIntelligence() {
  ...
  const generateAdvancedTacticsPDF = () => {
    ...
    const pdfBlob = new Blob([JSON.stringify(advancedPdfContent, null, 2)], {
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        <Badge
                          className={`${
                            innovation.priority === "critical"
                              ? "bg-red-600"
                              : innovation.priority === "high"
                                ? "bg-orange-600"
                                : innovation.priority === "medium"
                                  ? "bg-yellow-600"
                                  : "bg-green-600"
                          }`}
                        >
            ...
            {strategicPlans.slice(0, 6).map((plan) => (
              <div key={plan.id} className="p-4 rounded-lg bg-card/50 border border-border/50">
                <div className="flex items-center justify-between mb-2">
                  <Badge
                    className={`${
                      plan.category === "immediate"
                        ? "bg-red-600"
                        : plan.category === "short_term"
                          ? "bg-orange-600"
                          : "bg-blue-600"
                    }`}
                  >
