...
export function EnhancedLandscapeShowcase() {
      ...
      const landscapeData: Landscape[] = [
        {
          ...
          qualityLevel: 98,
          description: 'Endless underwater realm with dolphin transformation zones, quantum coral reefs, and 500+ unique marine species with AI behavior.'
        },
        {
          id: '2',
          ...
          qualityLevel: 96,
          description: 'Floating mountains with gravity-defying physics, crystal caves, and biomechanical wildlife. Features 1000+ levels of vertical exploration.'
        },
        {
          id: '3',
          ...
          qualityLevel: 99,
          description: 'Living forest with sentient trees, shape-shifting paths, and organic-digital fusion creatures. Self-evolving ecosystem powered by quantum AI.'
        },
        {
          id: '4',
          ...
          qualityLevel: 100,
          description: 'Reality-bending dimension where physics laws are optional. Infinite possibilities, shape-shifting landscapes, and mind-bending challenges.'
        }
      ]
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      case 'ocean': return 'from-blue-600 to-cyan-600'
      case 'mountain': return 'from-gray-600 to-stone-600'
  ...
  return (
    <Card className="bg-gradient-to-br from-indigo-900/20 to-purple-900/20 border-indigo-500/20 relative overflow-hidden">
      ...
      <CardContent className="relative z-10 space-y-6">
        ...
        {/* Selected Landscape Details */}
        {selectedLandscape && (
          <Card className={`bg-gradient-to-r ${getTypeColor(selectedLandscape.type)} bg-opacity-10 border-2`}>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    <div className="text-center p-3 bg-black/30 rounded">
                      <div className="text-2xl font-bold text-blue-400">{selectedLandscape.memorySize}</div>
                      <div className="text-xs text-muted-foreground">Memory Size</div>
                    </div>
                    <div className="text-center p-3 bg-black/30 rounded">
                      <div className="text-2xl font-bold text-green-400">{selectedLandscape.playerCount.toLocaleString()}</div>
                      <div className="text-xs text-muted-foreground">Active Players</div>
                    </div>
                    <div className="text-center p-3 bg-black/30 rounded">
                      <div className="text-2xl font-bold text-red-400">{selectedLandscape.biomechanicalCount}</div>
                      <div className="text-xs text-muted-foreground">Bio-Mechanical</div>
                    </div>
                    <div className="text-center p-3 bg-black/30 rounded">
                      <div className="text-2xl font-bold text-purple-400">{selectedLandscape.qualityLevel}%</div>
