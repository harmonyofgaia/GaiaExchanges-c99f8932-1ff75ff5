...
import { Handshake, Building, Users, TrendingUp, Globe, Star, MessageSquare, Send, Mail } from 'lucide-react'
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="bg-gradient-to-br from-green-900/20 to-black/50 border-green-500/20">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-green-400">Active Partnerships</CardTitle>
            ...
            <Card className="bg-gradient-to-br from-green-900/20 to-black/50 border-green-500/20">
              ...
              <CardContent>
                <div className="space-y-4">
                  {['GreenTech Solutions', 'Ocean Conservancy', 'Wildlife Foundation'].map((partner, index) => (
                    <div key={partner} className="p-3 bg-green-900/20 rounded-lg border border-green-500/20">
        ...
        <TabsContent value="community-contact" className="space-y-6">
          <Card className="bg-gradient-to-br from-blue-900/20 to-black/50 border-blue-500/20">
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                <label className="text-sm font-medium text-gray-300 mb-2 block">Partnership Type</label>
                <select 
              ...
              <Button onClick={handleContactSubmit} className="w-full bg-green-600 hover:bg-green-700">
            ...
            <CardContent>
              <div className="space-y-4">
                {communityQuestions.map((question) => (
                  <div key={question.id} className="p-4 bg-purple-900/20 rounded-lg border border-purple-500/20">
                    <div className="flex justify-between items-start mb-2">
                      <div>
