                ...
                <div key={user.id} className="p-3 rounded border border-border/50 bg-card/30">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="text-right text-xs">
                      <div className="text-muted-foreground">Visits: {user.pageVisits}</div>
              ...
              {securityEvents.slice(0, 10).map((event) => (
                <div key={event.id} className="p-2 rounded border border-border/50 bg-card/30">
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      <div className="flex items-center gap-2">
                        <Badge className={getThreatColor(event.severity)}>{event.type}</Badge>
                        {event.blocked && (
        ...
        <CardContent className="pt-6">
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground">
              Every user interaction is tracked and analyzed in real-time. Threat detection at 100%
              accuracy with quantum-level invisibility protection.
            </p>
            <div className="flex justify-center gap-4">
              <Badge className="bg-red-600 text-white px-4 py-2">👻 Complete Invisibility</Badge>
              <Badge className="bg-blue-600 text-white px-4 py-2">🔍 Real-time Tracking</Badge>
              <Badge className="bg-purple-600 text-white px-4 py-2">🛡️ Quantum Protection</Badge>
            </div>
          </div>
        </CardContent>
      </Card>
