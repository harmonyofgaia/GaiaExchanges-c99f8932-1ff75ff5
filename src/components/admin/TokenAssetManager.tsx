...
export function TokenAssetManager() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'monitoring': return 'border-blue-500/50 text-blue-400'
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
            <div className="text-center">
              <div className="text-2xl font-bold text-green-400">{discoveryMetrics.total_discovered}</div>
              <div className="text-sm text-muted-foreground">Total Discovered</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-blue-400">{discoveryMetrics.approved_today}</div>
              <div className="text-sm text-muted-foreground">Approved Today</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-yellow-400">{discoveryMetrics.pending_review}</div>
              <div className="text-sm text-muted-foreground">Pending Review</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-purple-400">{discoveryMetrics.eco_tokens_found}</div>
              <div className="text-sm text-muted-foreground">Eco Tokens</div>
            </div>
            <div className="text-center">
              <div className="text-lg font-bold text-cyan-400">{discoveryMetrics.sources_active.length}</div>
          ...
          <div className="mt-4">
            ...
            <div className="flex flex-wrap gap-2">
              {discoveryMetrics.sources_active.map((source) => (
                <Badge key={source} variant="outline" className="border-green-500/50 text-green-400">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-3">
                        ...
                        <div>
                          ...
                          <div className={`font-bold flex items-center gap-1 ${token.change_24h >= 0 ? 'text-green-400' : 'text-red-400'}`}>
                        ...
                        <div>
                          ...
                          <div className="font-bold text-white">${(token.market_cap / 1000000).toFixed(2)}M</div>
                        </div>
                        <div>
                          <div className="text-sm text-muted-foreground">Volume 24h</div>
                          <div className="font-bold text-white">${(token.volume_24h / 1000).toFixed(0)}K</div>
                        </div>
                      </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    {['CoinGecko', 'Binance', 'EcoToken API', 'DeFiPulse', 'CoinMarketCap'].map((source) => (
                      <div key={source} className="flex items-center justify-between p-3 border border-gray-500/20 rounded-lg">
                        <div className="flex items-center gap-3">
                          <div className={`w-3 h-3 rounded-full ${discoveryMetrics.sources_active.includes(source) ? 'bg-green-400' : 'bg-gray-400'}`} />
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card className="border-green-500/20">
              ...
              <CardContent>
                <div className="space-y-3">
                  {[
                    { category: 'Carbon Credits', count: 45, color: 'bg-green-400' },
                    { category: 'Renewable Energy', count: 38, color: 'bg-blue-400' },
                    { category: 'Conservation', count: 32, color: 'bg-purple-400' },
                    { category: 'Clean Transport', count: 28, color: 'bg-yellow-400' },
                    { category: 'Sustainable Tech', count: 23, color: 'bg-cyan-400' }
                  ].map((item) => (
