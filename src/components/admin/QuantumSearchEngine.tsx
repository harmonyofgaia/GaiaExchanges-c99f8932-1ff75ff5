          ...
          <CardContent>
            <div className="space-y-3">
              {searchResults.map((result) => (
                <div
                  key={result.id}
                  className="p-4 bg-black/50 rounded-lg border border-gray-600/30"
                >
