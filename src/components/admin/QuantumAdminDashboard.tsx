    ...
    <div className="space-y-6">
      ...
      <Card className="border-2 border-green-500/50 bg-gradient-to-br from-green-900/30 to-emerald-900/30">
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-orange-400">{quantumSecurity.metrics.quantumResistanceLevel}%</div>
              <div className="text-xs text-muted-foreground">Resistance</div>
              <Progress value={quantumSecurity.metrics.quantumResistanceLevel} className="mt-2 h-2" />
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="border-2 border-orange-500/50 bg-gradient-to-br from-orange-900/30 to-red-900/30">
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center">
              <div className="text-2xl font-bold text-orange-400">{quantumPerformance.metrics.processingSpeed}x</div>
              <div className="text-xs text-muted-foreground">Processing Speed</div>
              <Progress value={Math.min(100, quantumPerformance.metrics.processingSpeed / 10)} className="mt-2 h-2" />
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-red-400">{quantumPerformance.metrics.evolutionRate}%</div>
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-yellow-400">{quantumPerformance.metrics.dominanceLevel}%</div>
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-pink-400">{quantumPerformance.metrics.untouchableStatus}%</div>
