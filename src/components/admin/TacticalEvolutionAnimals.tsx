  ...
  const [tacticalAnimals, setTacticalAnimals] = useState<TacticalAnimal[]>([
    {
      ...
      selfTrainingModules: [
        {
          module: "Advanced Pattern Recognition",
          progress: 92,
          efficiency: 98,
        },
    ...
    },
    {
      ...
      selfTrainingModules: [
        {
          module: "Temporal Mechanics Master Class",
          progress: 98,
          efficiency: 100,
        },
        { module: "Causality Loop Management", progress: 96, efficiency: 99 },
        {
          module: "Timeline Convergence Theory",
          progress: 99,
          efficiency: 100,
        },
      ],
    ...
    evolutionRef.current = setInterval(() => {
      setTacticalAnimals((prev) =>
        prev.map((animal) => {
          ...
          if (
            newPower >= animal.currentPower * 1.5 &&
      ...
      if (Math.random() < 0.15) {
        setTacticalAnimals((prev) => {
          ...
          const statuses: TacticalAnimal["status"][] = [
            "training",
            "active",
            "evolving",
            "mission",
        ...
        <Card className="bg-gradient-to-br from-pink-900/40 to-red-900/40 border-pink-500/50">
          <CardContent className="p-4 text-center">
            ...
            <div className="text-2xl font-bold text-pink-400">
              {(averageEvolution * 100).toFixed(1)}%
            </div>
        ...
        <TabsContent value="animals" className="space-y-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {tacticalAnimals.map((animal) => (
              <Card
                key={animal.id}
                className="bg-gradient-to-br from-gray-900/50 to-gray-800/50 border-gray-700/50 hover:border-purple-500/50 transition-all duration-300"
              >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <Badge
                            className={`text-xs ${
                              animal.powerClass === "INFINITE"
                                ? "bg-gradient-to-r from-purple-600 to-pink-600"
                                : animal.powerClass === "MULTIVERSE"
                                  ? "bg-gradient-to-r from-blue-600 to-purple-600"
                                  : animal.powerClass === "UNIVERSE"
                                    ? "bg-gradient-to-r from-green-600 to-blue-600"
                                    : animal.powerClass === "ALPHA_PLUS"
                          ...
                          <Badge
                            variant={
                              animal.status === "ascending"
                                ? "default"
                                : animal.status === "active"
                                  ? "secondary"
                                  : animal.status === "evolving"
                                    ? "destructive"
                                    : "outline"
                            }
                          >
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <div className="text-purple-400 font-bold">
                        {animal.currentPower.toLocaleString()}
                      </div>
                      <Progress
                        value={(animal.currentPower / animal.maxPower) * 100}
                        className="mt-1"
                      />
                    </div>
                    <div>
        ...
        <TabsContent value="training" className="space-y-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {tacticalAnimals.map((animal) => (
              <Card
                key={animal.id}
                className="bg-gradient-to-br from-cyan-900/30 to-blue-900/30 border-cyan-500/30"
              >
                <CardHeader>
                        ...
                        <div key={idx} className="space-y-1">
                          ...
                          <div className="flex justify-between text-xs">
                            <span className="text-muted-foreground">
                              Efficiency: {module.efficiency.toFixed(1)}%
                            </span>
                          </div>
                        </div>
                      ))}
