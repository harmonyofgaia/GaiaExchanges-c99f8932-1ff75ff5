...
export function UniversalStyleController() {
  ...
  const handleStyleChange = (category: keyof StyleState, property: string, value: unknown) => {
    const updatedStyle = {
      ...currentStyle,
      [category]: {
  ...
  const sections = {
    typography: {
      icon: Type,
      label: "Typography Master",
      color: "text-green-400",
    },
    background: {
      icon: Image,
      label: "Neural Matrix Control",
      color: "text-blue-400",
    },
    colors: {
      icon: Palette,
          ...
          <Card className="bg-black/95 backdrop-blur-sm border-purple-500/30">
            <CardHeader className="pb-2">
              ...
              <div className="flex gap-1 flex-wrap">
                ...
                <Button
                  size="sm"
                  onClick={() => saveVersion("Master Style")}
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div>
                        <label className="text-gray-300 text-xs">
                          Size: {currentStyle.typography.size}%
                        </label>
                        <Slider
                          value={[currentStyle.typography.size]}
                          onValueChange={([value]) =>
                            handleStyleChange("typography", "size", value)
                          }
                          min={50}
                          max={300}
                          step={5}
                      ...
                      <div>
                        <label className="text-gray-300 text-xs">
                          Weight: {currentStyle.typography.weight}
                        </label>
                        <Slider
                          value={[currentStyle.typography.weight]}
                          onValueChange={([value]) =>
                            handleStyleChange("typography", "weight", value)
                          }
                          min={100}
                          max={900}
                          step={100}
                ...
                {activeSection === "matrix" && (
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-2">
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleStyleChange("matrix", "enabled", checked)
                        }
                      />
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div>
                        <label className="text-gray-300 text-xs">
                          Speed: {currentStyle.matrix.speed}s
                        </label>
                        <Slider
                      ...
                      <div>
                        <label className="text-gray-300 text-xs">
                          Density: {currentStyle.matrix.density}%
                        </label>
                        <Slider
                ...
                {activeSection === "effects" && (
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="flex items-center gap-1">
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            handleStyleChange("effects", "shadows", checked)
                          }
                        />
                      ...
                      <div className="flex items-center gap-1">
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            handleStyleChange("effects", "glow", checked)
                          }
                        />
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div>
                        <label className="text-gray-300 text-xs">
                          Brightness: {currentStyle.effects.brightness}%
                        </label>
                        <Slider
                          value={[currentStyle.effects.brightness]}
                          onValueChange={([value]) =>
                            handleStyleChange("effects", "brightness", value)
                          }
                          min={50}
                          max={200}
                          step={5}
                      ...
                      <div>
                        <label className="text-gray-300 text-xs">
                          Contrast: {currentStyle.effects.contrast}%
                        </label>
                        <Slider
                          value={[currentStyle.effects.contrast]}
                          onValueChange={([value]) =>
                            handleStyleChange("effects", "contrast", value)
                          }
                          min={50}
                          max={200}
                          step={5}
