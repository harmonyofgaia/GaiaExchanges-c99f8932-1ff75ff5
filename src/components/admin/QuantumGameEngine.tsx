      ...
      <Card className="border-green-500/50 bg-gradient-to-br from-green-900/30 to-black/80">
        <CardHeader>
          ...
          <p className="text-green-300">
            10x Better Than Unreal Engine • Live Animal NFTs • Virtual Reality • Global Investment
            Platform
          </p>
        </CardHeader>
        <CardContent>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="bg-purple-900/20 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-purple-300 text-sm mb-2">
                  The biggest fantasy MMORPG ever conceived, featuring infinite realms, quantum
                  magic systems, and consciousness-driven adventures that transcend reality itself.
                </p>
            ...
            <CardContent className="space-y-4">
              <div className="text-center mb-6">
                ...
                <p className="text-lg text-purple-300 mb-4">
                  {nftAnimals.toLocaleString()} Live animals tracked with individual NFTs for
              ...
              <div className="bg-black/50 p-4 rounded-lg">
                ...
                <p className="text-sm text-purple-300 mb-2">
                  Investors can virtually visit animals through integrated Google Earth, see their
                  current environment, and vote on relocation to better habitats for improved living
                  conditions.
                </p>
            ...
            <CardContent className="space-y-4">
              <div className="text-center mb-6">
                ...
                <p className="text-lg text-blue-300 mb-4">
                  {gameWorlds} Unique virtual worlds with infinite possibilities for exploration and
                  adventure
                </p>
                <Button
                  onClick={createGameWorld}
            ...
            <CardContent className="space-y-4">
              <div className="text-center mb-6">
                ...
                <p className="text-lg text-yellow-300 mb-4">
                  {activeInvestors.toLocaleString()} Active investors funding animal conservation
                  through gaming
                </p>
              </div>
