        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-3">
            {healthItems.map((item) => {
              ...
              return (
                <div key={item.key} className="flex items-center justify-between p-3 bg-black/20 rounded border border-border/50">
                  <div className="flex items-center gap-3">
                    <IconComponent className={`h-5 w-5 ${isHealthy ? 'text-green-400' : 'text-red-400'}`} />
