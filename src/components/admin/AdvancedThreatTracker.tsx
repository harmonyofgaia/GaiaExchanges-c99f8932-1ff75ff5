  ...
  const [monkeys, setMonkeys] = useState<TrainingMonkey[]>([
    {
      id: 1,
      name: "Neo-Monkey",
      skill: "Screen Recording Block",
      level: 99,
      defending: true,
      location: "Quantum Firewall",
      power: 9999,
    },
    {
      id: 2,
    ...
    },
    {
      id: 3,
      name: "Ghost-Ape",
      skill: "WiFi Protection",
      level: 97,
      defending: true,
      location: "RedMi Tablet Shield",
      power: 9654,
    },
    {
      id: 4,
      ...
      level: 96,
      defending: true,
      location: "File Encryption",
      power: 9432,
    },
    {
      id: 5,
      name: "Stealth-Baboon",
      skill: "Trace Prevention",
      level: 95,
      defending: true,
      location: "Anonymous Layer",
      power: 9210,
    },
    {
      id: 6,
      name: "Titan-Orangutan",
      skill: "Platform Security",
      level: 94,
      defending: true,
      location: "Universal Guard",
      power: 8988,
    },
    {
      id: 7,
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {monkeys.map((monkey) => (
              <Card
                key={monkey.id}
                className="bg-gradient-to-br from-purple-900/30 to-blue-900/30 border-purple-500/20"
              >
