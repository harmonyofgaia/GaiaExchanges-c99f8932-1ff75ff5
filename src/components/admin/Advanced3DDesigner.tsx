      ...
      <Card className="bg-gradient-to-r from-purple-900/30 to-cyan-900/30 border-purple-500/30">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-5 gap-3">
            <Button onClick={() => createNewProject('weapon')} className="bg-red-600 hover:bg-red-700">
              <Sword className="h-4 w-4 mr-2" />
              Weapon
            </Button>
            <Button onClick={() => createNewProject('tool')} className="bg-yellow-600 hover:bg-yellow-700">
              <Wrench className="h-4 w-4 mr-2" />
              Tool
            </Button>
            <Button onClick={() => createNewProject('landscape')} className="bg-green-600 hover:bg-green-700">
              <Globe className="h-4 w-4 mr-2" />
              Landscape
            </Button>
            <Button onClick={() => createNewProject('character')} className="bg-blue-600 hover:bg-blue-700">
              <Eye className="h-4 w-4 mr-2" />
              Character
            </Button>
            <Button onClick={() => createNewProject('building')} className="bg-purple-600 hover:bg-purple-700">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="bg-black/40 p-4 rounded-lg">
                  ...
                  <div className="text-sm text-green-400">Performance: {activeProject.performance}% optimized</div>
                </div>
