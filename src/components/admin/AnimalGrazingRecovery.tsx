      ...
      <Card className="bg-gradient-to-br from-green-900/30 to-emerald-900/30 border border-green-500/30">
        <CardHeader>
          ...
          <p className="text-muted-foreground">
            Advanced ecological restoration using systematic animal grazing to remove chemicals and
            restore healthy land
          </p>
        </CardHeader>
      </Card>
                      ...
                      {[1, 2, 3, 4, 5, 6, 7].map((phaseNum) => {
                        ...
                        return (
                          <div key={phaseNum} className="flex items-center gap-3">
                            <Badge className={getStatusColor(status)}>Phase {phaseNum}</Badge>
