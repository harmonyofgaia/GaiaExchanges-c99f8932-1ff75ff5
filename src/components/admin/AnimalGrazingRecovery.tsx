  ...
  const grazingPhases: GrazingPhase[] = [
    {
      ...
      description:
        "Sheep remove surface vegetation and begin soil compaction correction",
      animals: ["Sheep", "Lambs"],
      duration: "3-4 months",
      objectives: [
    ...
    },
    {
      ...
      description:
        "Goats target woody plants and shrubs, clearing overgrown areas",
      animals: ["Goats", "Kids"],
      duration: "2-3 months",
      objectives: [
        "Clear brush and shrubs",
    ...
    },
    {
      ...
      description:
        "Cattle provide deep soil compaction and nutrient distribution",
      animals: ["Cattle", "Calves"],
      duration: "4-5 months",
      objectives: [
        "Heavy soil processing",
        "Nutrient distribution",
        "Deep root system creation",
      ],
    ...
    },
    {
      ...
      duration: "2-3 months",
      objectives: [
        "Natural soil tilling",
        "Root and debris removal",
        "Soil mixture enhancement",
      ],
    ...
    },
    {
      ...
      description:
        "Chickens and poultry control harmful insects and add nitrogen",
      ...
      chemicalRemoval: [
        ...
        "Chemical pest control remnants",
      ],
      progress: 10,
      status: "pending",
    },
      ...
      <Card className="bg-gradient-to-br from-green-900/30 to-emerald-900/30 border border-green-500/30">
        <CardHeader>
          ...
          <p className="text-muted-foreground">
            Advanced ecological restoration using systematic animal grazing to
            remove chemicals and restore healthy land
          </p>
        </CardHeader>
      </Card>
            ...
            <Card className="bg-gradient-to-br from-purple-900/30 to-pink-900/30 border border-purple-500/30">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-3xl font-bold text-purple-400">
                  {landProjects.reduce(
                    (acc, project) => acc + project.totalArea,
                    0,
                  )}
                </div>
                <div className="text-sm text-muted-foreground">
                  Hectares Under Recovery
                </div>
              </CardContent>
            </Card>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {phase.animals.map((animal) => (
                          <Badge key={animal} className="bg-green-600">
                            {animal}
                          </Badge>
                        ))}
                      </div>
        ...
        <TabsContent value="projects" className="space-y-6">
          <div className="grid gap-6">
            {landProjects.map((project) => (
              <Card
                key={project.id}
                className="bg-gradient-to-br from-cyan-900/30 to-blue-900/30 border border-cyan-500/30"
              >
                <CardHeader>
                ...
                <CardContent>
                  ...
                  <div className="mb-6">
                    <h4 className="font-semibold text-red-400 mb-3">
                      ☢️ Contamination Types
                    </h4>
                    <div className="flex flex-wrap gap-2">
                      {project.contamination.map((contaminant) => (
                        <Badge key={contaminant} className="bg-red-600">
                          {contaminant}
                        </Badge>
                      ))}
                    </div>
