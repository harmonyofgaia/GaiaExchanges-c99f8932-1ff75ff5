          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div className="text-center space-y-2">
              <div className="text-4xl font-bold text-cyan-400">
                {Math.floor(systemChecks.reduce((sum, s) => sum + s.responseTime, 0) / systemChecks.length)}ms
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card className="bg-gradient-to-br from-green-900/30 to-emerald-900/30 border border-green-500/30">
              <CardContent className="p-4 text-center">
                ...
                <Badge className={`${
                  appStoreStatus.googlePlay === 'preparing' ? 'bg-yellow-600' :
                  appStoreStatus.googlePlay === 'submitting' ? 'bg-blue-600' : 'bg-green-600'
                } mb-2`}>
            ...
            <Card className="bg-gradient-to-br from-blue-900/30 to-purple-900/30 border border-blue-500/30">
              <CardContent className="p-4 text-center">
                ...
                <Badge className={`${
                  appStoreStatus.appleStore === 'preparing' ? 'bg-yellow-600' :
                  appStoreStatus.appleStore === 'submitting' ? 'bg-blue-600' : 'bg-green-600'
                } mb-2`}>
