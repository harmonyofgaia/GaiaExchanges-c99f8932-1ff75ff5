...
export function AdvancedSecurityCenter() {
  const [securityMetrics, setSecurityMetrics] = useState<SecurityMetric[]>([
    { name: 'Firewall Protection', value: 99.8, status: 'excellent', trend: 'stable' },
    { name: 'Intrusion Detection', value: 98.5, status: 'excellent', trend: 'up' },
    { name: 'Data Encryption', value: 100, status: 'excellent', trend: 'stable' },
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            ...
            <div className="text-center p-3 rounded-lg bg-orange-900/30 border border-orange-500/20">
              ...
              <div className="text-2xl font-bold text-orange-400">{systemStats.dataTransfer.toFixed(1)}GB</div>
          ...
          <Card className="border-red-500/20">
            ...
            <CardContent className="space-y-3">
              {threatAlerts.map((alert) => (
                <div key={alert.id} className="flex items-center justify-between p-3 rounded-lg bg-black/20 border border-gray-500/20">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Badge className={alert.type === 'blocked' ? 'bg-red-600' : 
                                    alert.type === 'resolved' ? 'bg-green-600' : 'bg-yellow-600'}>
              ...
              <CardContent className="space-y-4">
                <div>
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="text-sm text-blue-400">{systemStats.cpuUsage.toFixed(1)}%</span>
                  </div>
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="text-sm text-green-400">{systemStats.memoryUsage.toFixed(1)}%</span>
                  </div>
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="text-sm text-yellow-400">{systemStats.diskUsage.toFixed(1)}%</span>
                  </div>
              ...
              <CardContent className="space-y-4">
                <div>
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="text-sm text-purple-400">{systemStats.networkLoad.toFixed(1)}%</span>
                  </div>
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-sm text-orange-400">{systemStats.dataTransfer.toFixed(2)} GB/s</span>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <Card className="border-purple-500/20 bg-purple-900/20">
              <CardContent className="p-4 text-center">
                ...
                <p className="text-xs text-muted-foreground mb-3">Deep database vulnerability scan</p>
            ...
            <Card className="border-cyan-500/20 bg-cyan-900/20">
              <CardContent className="p-4 text-center">
                ...
                <p className="text-xs text-muted-foreground mb-3">Verify all encryption protocols</p>
