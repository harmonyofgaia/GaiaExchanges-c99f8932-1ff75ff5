      ...
      <Card className="border-purple-500/30 bg-purple-900/20">
        <CardHeader>
          ...
          <p className="text-muted-foreground text-sm mt-2">
            This secure admin dashboard displays all innovative ideas generated by our
        ...
        <CardContent className="space-y-6">
                ...
                <CardContent className="pt-4">
                  <div className="flex items-start justify-between mb-2">
                    <div className="flex-1">
                      ...
                      <div className="text-xs text-gray-400">Timeframe: {prediction.timeframe}</div>
                    </div>
          ...
          <div className="flex gap-4">
            ...
            <Button onClick={() => toast.info("Historical data exported")} variant="outline">
