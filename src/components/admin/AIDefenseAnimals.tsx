...
export function AIDefenseAnimals() {
  ...
  const addNewAnimal = (animalData: Partial<AnimalDefense>) => {
    const newAnimal = {
      ...animalData,
      ...
      <Card className="border-green-500/30 bg-gradient-to-br from-green-900/30 to-blue-900/30">
        <CardHeader>
          ...
          <div className="flex gap-2 flex-wrap">
            ...
            <Button
              onClick={batchDeactivateAnimals}
              size="sm"
        ...
        <Card className="border-yellow-500/50 bg-gradient-to-br from-yellow-900/30 to-orange-900/30">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex gap-2">
              ...
              <Button onClick={() => setEditingAnimal(null)} variant="outline">
                Cancel
              </Button>
            </div>
          </CardContent>
