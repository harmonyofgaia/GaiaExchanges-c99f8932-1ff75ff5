...
export function BlockchainSecurityLogs() {
  ...
  const [blockchainHash, setBlockchainHash] = useState('0x7f83b1657ff1fc53b92dc18148a1d65dfc2d4b1fa3d677284addd200126d9069')
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3 max-h-64 overflow-y-auto">
          ...
          {recentLogs.length === 0 ? (
            ...
            recentLogs.map((log) => (
              <div key={log.id} className={`p-3 rounded-lg border bg-black/20 ${getSeverityColor(log.severity)}`}>
        ...
        <div className="text-center p-4 bg-gradient-to-r from-cyan-900/20 to-blue-900/20 rounded-lg border border-cyan-500/20">
          ...
          <div className="text-green-400 text-sm mt-1">IMMUTABLE RECORDS • GAiA SECURED • CRYPTOGRAPHICALLY VERIFIED</div>
        </div>
      </CardContent>
    </Card>
  )
