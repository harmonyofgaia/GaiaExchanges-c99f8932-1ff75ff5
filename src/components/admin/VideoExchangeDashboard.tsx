  ...
  const tabs = [
    {
      value: "overview",
      label: "Overview",
      icon: <Video className="h-4 w-4 mb-1" />,
    },
    {
      value: "channels",
      label: "Channels",
      icon: <Users className="h-4 w-4 mb-1" />,
    },
    {
      value: "upload",
      label: "Upload",
      icon: <Upload className="h-4 w-4 mb-1" />,
    },
    {
      value: "music",
      label: "Music",
      icon: <Music className="h-4 w-4 mb-1" />,
    },
    {
      value: "subscriptions",
      label: "Subscribe",
      icon: <Bell className="h-4 w-4 mb-1" />,
    },
    {
      value: "player",
      label: "Player",
    ...
    },
    {
      value: "chat",
      label: "Chat",
      icon: <MessageCircle className="h-4 w-4 mb-1" />,
    },
    {
      value: "tokens",
      label: "Tokens",
      icon: <Coins className="h-4 w-4 mb-1" />,
    },
    {
      value: "leaderboards",
      label: "Leaderboards",
      icon: <Trophy className="h-4 w-4 mb-1" />,
    },
    {
      value: "events",
      label: "Events",
      icon: <Calendar className="h-4 w-4 mb-1" />,
    },
    {
      value: "admin",
      label: "Admin",
        ...
        <Card className="border-purple-500/30">
          <CardContent className="p-4 text-center">
            ...
            <div className="text-2xl font-bold text-purple-400">
              {stats.totalMusicTracks.toLocaleString()}
            </div>
        ...
        <Card className="border-pink-500/30">
          <CardContent className="p-4 text-center">
            ...
            <div className="text-2xl font-bold text-pink-400">
              {stats.totalMusicPlays.toLocaleString()}
            </div>
