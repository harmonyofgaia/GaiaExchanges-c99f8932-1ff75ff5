      ...
      <CardContent className="space-y-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="bg-black/30 p-4 rounded-lg border border-yellow-500/20">
            <div className="text-2xl font-bold text-yellow-400">{secureConnections.toLocaleString()}</div>
        ...
        <div className="text-center p-4 bg-gradient-to-r from-blue-900/20 to-purple-900/20 rounded-lg border border-blue-500/20">
          ...
          <div className="text-green-400 text-sm mt-1">ALL CHANNELS SECURE • QUANTUM PROTECTED • UNBREAKABLE</div>
        </div>
      </CardContent>
    </Card>
  )
