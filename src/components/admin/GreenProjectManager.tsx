...
export function GreenProjectManager() {
  ...
  const getCategoryIcon = (category: string) => {
    switch (category) {
      case 'trees': return <TreePine className="h-4 w-4" />
      case 'ocean': return <Droplets className="h-4 w-4" />
      case 'renewable': return <Sun className="h-4 w-4" />
      case 'conservation': return <Wind className="h-4 w-4" />
  ...
  const getCategoryColor = (category: string) => {
    switch (category) {
      case 'trees': return 'bg-green-600'
      case 'ocean': return 'bg-blue-600'
      case 'renewable': return 'bg-yellow-600'
      case 'conservation': return 'bg-purple-600'
  ...
  const addProject = () => {
    ...
    setNewProject({ title: '', description: '', category: 'trees', budget: 0, impact: '' })
              ...
              <CardContent className="pt-6 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <Input
                    ...
                    onChange={(e) => setNewProject(prev => ({ ...prev, impact: e.target.value }))}
                  />
                </div>
                  ...
                  <div className="flex justify-between items-start mb-3">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <Badge className={`${getCategoryColor(project.category)} text-white text-xs`}>
