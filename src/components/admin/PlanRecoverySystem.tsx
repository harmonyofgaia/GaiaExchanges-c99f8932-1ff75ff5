    ...
    const mockPlans: PlanRecord[] = [
      {
        ...
        description:
          "Comprehensive plan for GAIA token ecosystem with bike integration",
        content:
      ...
      },
      {
        ...
        description:
          "Beautiful underwater NFT marketplace with conservation focus",
        content:
          "Immersive coral reef themed NFT marketplace with environmental storytelling...",
        source: "deleted",
        status: "deleted",
...
Generated by: GAIA Plan Recovery System
  ...
  useEffect(() => {
    const newStats = {
      total: plans.length,
      recovered: plans.filter(
        (p) => p.source === "deleted" || p.source === "hidden",
      ).length,
      ...
      <Card className="border-blue-500/30 bg-gradient-to-r from-blue-900/30 to-purple-900/30">
        <CardHeader>
          ...
          <p className="text-blue-300">
            Comprehensive plan recovery from GitHub repository
            GaiaExchanges-c99f8932 • 24/7 Monitoring Active
          </p>
        </CardHeader>
        <CardContent>
