    ...
    return (
      <Card className="border-2 border-red-500/50">
        <CardContent className="p-8 text-center">
          ...
          <p className="text-muted-foreground">Only authenticated admins can access the NFT marketplace management</p>
        </CardContent>
      </Card>
    )
  }
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-center">
            ...
            <div className="p-3 rounded-lg bg-green-900/30 border border-green-500/20">
              <div className="text-xl font-bold text-green-400">{nfts.filter(n => n.forSale).length}</div>
            ...
            <div className="p-3 rounded-lg bg-blue-900/30 border border-blue-500/20">
              <div className="text-xl font-bold text-blue-400">{nfts.filter(n => n.createdBy === 'admin').length}</div>
            ...
            <div className="p-3 rounded-lg bg-orange-900/30 border border-orange-500/20">
              <div className="text-xl font-bold text-orange-400">{Math.round(nfts.reduce((sum, n) => sum + n.burnRate, 0) / nfts.length)}%</div>
            ...
            <div className="p-3 rounded-lg bg-yellow-900/30 border border-yellow-500/20">
              <div className="text-xl font-bold text-yellow-400">{nfts.reduce((sum, n) => sum + n.price, 0).toLocaleString()}</div>
      ...
      <Tabs defaultValue="marketplace" className="w-full">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    type="number"
                    value={newNFT.price || ''}
                    onChange={(e) => setNewNFT(prev => ({ ...prev, price: Number(e.target.value) }))}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setNewNFT(prev => ({ ...prev, specialAbility: e.target.value }))}
        ...
        <TabsContent value="inventory" className="space-y-4">
          <div className="text-center py-8">
            ...
            <p className="text-muted-foreground">Complete overview of all NFT assets and their status</p>
          </div>
        </TabsContent>
