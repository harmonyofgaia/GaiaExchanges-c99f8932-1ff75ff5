        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            <div className="text-center p-4 bg-green-900/30 rounded-lg border border-green-500/30">
              ...
              <div className="text-2xl font-bold text-green-400">{overviewStats.totalAnimals}</div>
            ...
            <div className="text-center p-4 bg-purple-900/30 rounded-lg border border-purple-500/30">
              ...
              <div className="text-2xl font-bold text-purple-400">{overviewStats.immortalCreatures}</div>
            ...
            <div className="text-center p-4 bg-red-900/30 rounded-lg border border-red-500/30">
              ...
              <div className="text-2xl font-bold text-red-400">{overviewStats.totalThreatsRepelled}</div>
            ...
            <div className="text-center p-4 bg-blue-900/30 rounded-lg border border-blue-500/30">
              ...
              <div className="text-2xl font-bold text-blue-400">{overviewStats.combinedPower.toLocaleString()}</div>
          ...
          <div className="space-y-4 mb-6">
            <div>
              <div className="flex justify-between text-sm mb-2">
                ...
                <span className="text-green-400">{overviewStats.systemIntegrity.toFixed(1)}%</span>
              </div>
          ...
          <div className="flex gap-2 flex-wrap">
            ...
            <Button onClick={activateEmergencyProtocol} className="bg-orange-600 hover:bg-orange-700">
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="text-blue-400 font-bold">{overviewStats.evolutionRate.toLocaleString()}</span>
              </div>
              <div className="flex justify-between text-sm">
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="text-red-400 font-bold">{securityMetrics.attackersNeutralized}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span>🔍 Global Scanning:</span>
                <Badge className={securityMetrics.globalScanningActive ? 'bg-green-600' : 'bg-red-600'}>
                  {securityMetrics.globalScanningActive ? 'ACTIVE' : 'INACTIVE'}
                </Badge>
              </div>
              <div className="flex justify-between text-sm">
                <span>🎯 Defense Animals:</span>
                <span className="text-blue-400 font-bold">{securityMetrics.defenseAnimalsActive}</span>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <div className="space-y-2 max-h-60 overflow-y-auto">
            {recentActivity.length === 0 ? (
              ...
              recentActivity.map((activity, index) => (
                <div key={index} className="flex items-center gap-2 p-2 bg-black/20 rounded text-sm">
      ...
      <Card className="border-green-500/30 bg-gradient-to-r from-green-900/30 to-emerald-900/30">
        <CardContent className="pt-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-green-200">
            <div className="space-y-2">
              <div>✅ <strong>AI Animals:</strong> 14 guardians active and protecting</div>
              <div>✅ <strong>Creature Army:</strong> 12 legendary defenders deployed</div>
              <div>✅ <strong>Immortal Core:</strong> 11 eternal protectors online</div>
            </div>
            <div className="space-y-2">
              <div>⚡ <strong>Combined Power:</strong> Over 8.5 million defense points</div>
              <div>🌍 <strong>Global Coverage:</strong> Worldwide protection active</div>
              <div>🔒 <strong>Security Level:</strong> Maximum protection engaged</div>
            </div>
            <div className="space-y-2">
              <div>♾️ <strong>Immortality:</strong> Absolute and eternal</div>
              <div>🎯 <strong>Effectiveness:</strong> 98.7% threat prevention</div>
              <div>🚀 <strong>Evolution:</strong> Continuously improving</div>
            </div>
          </div>
        </CardContent>
      </Card>
