    ...
    <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-center">
            <div className="p-3 rounded-lg bg-blue-900/30 border border-blue-500/20">
              <div className="text-xl font-bold text-blue-400">
                {creatures.filter((c) => c.type === "defender").length}
              </div>
            ...
            <div className="p-3 rounded-lg bg-red-900/30 border border-red-500/20">
              <div className="text-xl font-bold text-red-400">
                {creatures.filter((c) => c.type === "attacker").length}
              </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredCreatures.map((creature) => (
          <Card
            key={creature.id}
            className={`border-2 bg-gradient-to-br ${getRarityColor(creature.rarity)}/20 hover:scale-105 transition-all`}
          >
            <CardContent className="p-4 space-y-4">
              <div className="text-center">
                ...
                <div className="flex items-center justify-center gap-2 mt-2">
                  ...
                  <Badge
                    className={`bg-gradient-to-r ${getRarityColor(creature.rarity)} text-white`}
                  >
                    {creature.rarity}
                  </Badge>
                </div>
