                ...
                <Card key={scan.id} className="bg-black/30">
                  <CardContent className="p-4">
                    ...
                    <div className="grid grid-cols-4 gap-4 text-sm">
                      <div>Critical: <span className="text-red-400">{scan.critical_issues}</span></div>
                      <div>High: <span className="text-orange-400">{scan.high_issues}</span></div>
                      <div>Medium: <span className="text-yellow-400">{scan.medium_issues}</span></div>
                      <div>Low: <span className="text-blue-400">{scan.low_issues}</span></div>
                    </div>
                    <Progress 
