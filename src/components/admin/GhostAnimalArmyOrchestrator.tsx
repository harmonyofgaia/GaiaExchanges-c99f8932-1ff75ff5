...
export function GhostAnimalArmyOrchestrator() {
  ...
  useEffect(() => {
    const initialAnimals: GhostAnimal[] = [
      ...
      { id: '1', name: 'Ghost Cyber Koala', type: 'reconnaissance', level: 25, power: 5000, specialAbility: 'Digital infiltration detection', status: 'available', effectiveness: 85, deploymentCount: 234, successRate: 94, emoji: '👻🐨' },
      { id: '2', name: 'Phantom Sky Eagle', type: 'reconnaissance', level: 30, power: 6500, specialAbility: 'Network perimeter surveillance', status: 'available', effectiveness: 88, deploymentCount: 189, successRate: 96, emoji: '👻🦅' },
      { id: '3', name: 'Spirit Wolf Scout', type: 'reconnaissance', level: 28, power: 6000, specialAbility: 'Behavior pattern analysis', status: 'available', effectiveness: 82, deploymentCount: 156, successRate: 91, emoji: '👻🐺' },
      { id: '4', name: 'Ghost AI Dolphin', type: 'reconnaissance', level: 32, power: 7000, specialAbility: 'Deep system scanning', status: 'available', effectiveness: 90, deploymentCount: 278, successRate: 97, emoji: '👻🐬' },
      
      // Level 2 - Defense
      { id: '5', name: 'Ghost Lion Guardian', type: 'defense', level: 45, power: 15000, specialAbility: 'Access control enforcement', status: 'available', effectiveness: 92, deploymentCount: 345, successRate: 95, emoji: '👻🦁' },
      { id: '6', name: 'Phantom Monkey Squad', type: 'defense', level: 40, power: 12000, specialAbility: 'Multi-vector defense', status: 'available', effectiveness: 89, deploymentCount: 267, successRate: 93, emoji: '👻🐒' },
      { id: '7', name: 'Spirit Serpent', type: 'defense', level: 42, power: 13500, specialAbility: 'Data flow protection', status: 'available', effectiveness: 87, deploymentCount: 198, successRate: 92, emoji: '👻🐍' },
      { id: '8', name: 'Ghost Gecko', type: 'defense', level: 38, power: 11000, specialAbility: 'System restoration', status: 'available', effectiveness: 85, deploymentCount: 223, successRate: 89, emoji: '👻🦎' },
      
      // Level 3 - Elite
      { id: '9', name: 'Ghost Dragon Prime', type: 'elite', level: 75, power: 45000, specialAbility: 'Maximum threat elimination', status: 'available', effectiveness: 98, deploymentCount: 89, successRate: 99, emoji: '👻🐉' },
      { id: '10', name: 'Phantom Phoenix', type: 'elite', level: 70, power: 40000, specialAbility: 'System resurrection capabilities', status: 'available', effectiveness: 96, deploymentCount: 67, successRate: 98, emoji: '👻🔥' },
      { id: '11', name: 'Spirit Thunder Cat', type: 'elite', level: 68, power: 38000, specialAbility: 'Lightning-fast response', status: 'available', effectiveness: 94, deploymentCount: 78, successRate: 97, emoji: '👻⚡' },
      { id: '12', name: 'Ghost Storm Bear', type: 'elite', level: 72, power: 42000, specialAbility: 'Overwhelming defense force', status: 'available', effectiveness: 95, deploymentCount: 56, successRate: 98, emoji: '👻🌪️' },
      
      // Level 4 - Ultimate
      { id: '13', name: 'Quantum Ghost Dragon', type: 'ultimate', level: 100, power: 999999, specialAbility: 'Infinite power deployment', status: 'available', effectiveness: 100, deploymentCount: 12, successRate: 100, emoji: '👻💎' },
      { id: '14', name: 'Celestial Spirit Phoenix', type: 'ultimate', level: 95, power: 500000, specialAbility: 'Immortal system protection', status: 'available', effectiveness: 99, deploymentCount: 8, successRate: 100, emoji: '👻🌟' },
      { id: '15', name: 'Ghost Warrior Legion', type: 'ultimate', level: 90, power: 300000, specialAbility: 'Coordinated army assault', status: 'available', effectiveness: 98, deploymentCount: 15, successRate: 100, emoji: '👻⚔️' },
      { id: '16', name: 'Ultimate Defense Specter', type: 'ultimate', level: 98, power: 750000, specialAbility: 'Absolute system shielding', status: 'available', effectiveness: 100, deploymentCount: 5, successRate: 100, emoji: '👻🛡️' }
    ]
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'engaging': return 'bg-orange-500'
              ...
              threats.map((threat) => (
                <div key={threat.id} className="flex items-center justify-between p-3 border rounded-lg">
                  <div className="flex items-center space-x-3">
                    <div className={`w-3 h-3 rounded-full ${getThreatSeverityColor(threat.severity)}`} />
                    <div>
                      <p className="font-medium">{threat.type}</p>
                      <p className="text-sm text-muted-foreground">{threat.location} • Severity: {threat.severity}/10</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-2">
            ...
            {deploymentLogs.length === 0 ? (
              ...
              deploymentLogs.map((log) => (
                <div key={log.id} className="flex items-center justify-between p-3 border rounded-lg">
                  ...
                  <div className="flex items-center space-x-2">
                    <Badge variant={log.status === 'successful' ? 'default' : log.status === 'failed' ? 'destructive' : 'secondary'}>
