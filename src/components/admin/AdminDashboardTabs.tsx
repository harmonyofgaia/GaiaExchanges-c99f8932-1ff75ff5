...
import { Settings, Palette, Heart, Shield, Wrench, RotateCcw, FileText, BarChart3, Crown } from 'lucide-react'
...
const AbsoluteSystemRule = React.lazy(() => import('./AbsoluteSystemRule'))
  ...
  const tabConfigs: TabConfig[] = useMemo(() => [
    {
      ...
      label: '🚨 RULES',
      icon: Shield,
      component: AbsoluteSystemRule,
      description: 'Absolute System Rules and Protection Protocols',
      priority: 'high',
      ...
      return (
        <TabsTrigger
          ...
          className={`
            ...
            ${tab.id === 'rules' ? 'bg-gradient-to-r from-red-600 to-orange-600 text-white font-bold' : ''}
