...
export function CriticalSystemFixes() {
  ...
  const activateAutoFix = () => {
    ...
    toast.success(`🤖 Auto-Fix ${autoFixEnabled ? 'Disabled' : 'Activated'}!`, {
      description: autoFixEnabled ? 'Manual control restored' : 'System will automatically fix issues',
      duration: 5000
    })
  }
      ...
      <Card className="border-orange-500/50 bg-gradient-to-br from-orange-900/30 to-red-900/30">
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-purple-400">{autoFixEnabled ? 'AUTO' : 'MANUAL'}</div>
          ...
          <CardContent className="pt-6">
            <div className="text-center space-y-4">
              ...
              <p className="text-red-300">
                {criticalIssues} critical database issues require immediate attention. 
                The Supabase function parameters need to be properly configured for full system functionality.
              </p>
