      ...
      <Card className="bg-gradient-to-br from-indigo-900/30 to-purple-900/30 border border-indigo-500/30">
        <CardHeader>
          ...
          <p className="text-muted-foreground">
            Complete transaction tracking with automated PDF generation organized by project and source
          </p>
        </CardHeader>
      </Card>
        ...
        <Card className="bg-gradient-to-br from-green-900/20 to-emerald-900/20 border border-green-500/30">
          <CardContent className="p-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-2xl font-bold text-green-400">{totalIncome.toLocaleString()} GAIA</div>
        ...
        <Card className="bg-gradient-to-br from-red-900/20 to-pink-900/20 border border-red-500/30">
          <CardContent className="p-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-2xl font-bold text-red-400">{totalOutcome.toLocaleString()} GAIA</div>
        ...
        <Card className="bg-gradient-to-br from-blue-900/20 to-cyan-900/20 border border-blue-500/30">
          <CardContent className="p-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-2xl font-bold text-blue-400">{netBalance.toLocaleString()} GAIA</div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                  ...
                  {walletSummaries
                    ...
                    <div key={index} className="flex items-center justify-between p-3 bg-gray-800/50 rounded">
                      ...
                      <div className="text-right">
                        <div className="text-green-400 font-medium">{wallet.totalIncome.toLocaleString()} GAIA</div>
                ...
                <div className="space-y-4">
                  ...
                  {walletSummaries
                    ...
                    <div key={index} className="flex items-center justify-between p-3 bg-gray-800/50 rounded">
                      ...
                      <div className="text-right">
                        <div className="text-red-400 font-medium">{wallet.totalOutcome.toLocaleString()} GAIA</div>
                        <div className="text-xs text-muted-foreground">{wallet.transactionCount} transactions</div>
                      </div>
                    </div>
                  ))}
        ...
        <TabsContent value="by-category" className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {walletSummaries.map((wallet, index) => (
              <Card key={index} className="bg-gradient-to-br from-gray-900/50 to-gray-800/50 border border-gray-700/50">
                <CardHeader>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <div className="font-medium text-green-400">{wallet.totalIncome.toLocaleString()} GAIA</div>
                    </div>
                    <div>
                      <span className="text-muted-foreground">Outcome:</span>
                      <div className="font-medium text-red-400">{wallet.totalOutcome.toLocaleString()} GAIA</div>
                    </div>
                  </div>
                  
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-muted-foreground">Net Balance:</span>
                    <span className={`font-medium ${(wallet.totalIncome - wallet.totalOutcome) >= 0 ? 'text-green-400' : 'text-red-400'}`}>
        ...
        <TabsContent value="reports" className="space-y-4">
          <Card className="bg-gradient-to-br from-orange-900/20 to-yellow-900/20 border border-orange-500/30">
            <CardHeader>
              <CardTitle className="text-lg text-orange-400">📑 Automated Report Generation</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Button 
