        ...
        <CardContent>
          <Tabs defaultValue="security" className="w-full">
            ...
            <TabsContent value="security" className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="p-3 bg-muted rounded-lg text-center">
                  ...
                  <div className="text-lg font-bold text-green-400">{verifiedUsers.toLocaleString()}</div>
                </div>
                <div className="p-3 bg-muted rounded-lg text-center">
              ...
              <div className="p-4 bg-muted rounded-lg">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Overall platform compliance rating</p>
                  </div>
            ...
            <TabsContent value="audit" className="space-y-4">
              ...
              <div className="p-4 bg-muted rounded-lg">
                <p className="text-muted-foreground">Comprehensive audit logging system tracks all platform activities for security and compliance purposes.</p>
              </div>
            </TabsContent>
          </Tabs>
        </CardContent>
