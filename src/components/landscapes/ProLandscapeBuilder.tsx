              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  <Slider
                    ...
                    onValueChange={(value) =>
                      setCurrentProject((prev) => ({ ...prev, size: value[0] }))
                    }
                    max={5000}
                    min={10}
                    step={10}
              ...
              <CardContent className="p-6">
                <div className="space-y-2">
                  ...
                  <div className="text-xs text-muted-foreground text-center">
                    {isRendering
                      ? "☁️ Unlimited storage processing..."
                      : "🤖 Quantum AI analyzing infinite possibilities..."}
                  </div>
                </div>
              </CardContent>
            </Card>
