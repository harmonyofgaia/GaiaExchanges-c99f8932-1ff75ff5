          ...
          <TabsContent value="pairs" className="space-y-4">
            <div className="space-y-3">
              {pairs.map((pair, index) => (
                <div
                  key={index}
                  className="flex items-center justify-between p-3 bg-black/30 rounded-lg border border-gray-500/30"
                >
                  ...
                  <div className="text-right">
                    <Badge
                      className={`${pair.change >= 0 ? "bg-green-600" : "bg-red-600"} text-white`}
                    >
                      {pair.change >= 0 ? "+" : ""}
