        ...
        <div className="space-y-6">
          ...
          <div className="bg-muted/30 rounded-lg p-4">
            ...
            <div className="text-sm text-muted-foreground">
              <span className="text-green-400">↗ +2.34%</span> in the last 24 hours
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4 p-4 rounded-lg bg-red-500/5 border border-red-500/20">
              ...
              <div className="space-y-3">
                ...
                >
                  {isLoading ? 'Processing...' : 'Sell GAiA'}
                </Button>
              </div>
            </div>
          </div>
          ...
          <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
            ...
            <p className="text-sm text-blue-300">
              ...
              that supports environmental causes through our burning and reinvestment system.
            </p>
          </div>
        </div>
      </CardContent>
