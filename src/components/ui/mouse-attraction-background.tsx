    ...
    const animate = () => {
      ...
      if (mouseAttraction.isActive) {
        ...
        const gradient = ctx.createRadialGradient(
          mouseAttraction.x, mouseAttraction.y, 0,
          mouseAttraction.x, mouseAttraction.y, glowRadius
        )
        ...
        return currentParticles.map(particle => {
          ...
          switch (particle.type) {
            ...
            case 'glow': {
              ...
              glowGradient.addColorStop(0, particle.color + Math.floor(finalAlpha * 255).toString(16).padStart(2, '0'))
            ...
            case 'quantum':
              ...
              ctx.strokeStyle = particle.color + Math.floor(finalAlpha * 255).toString(16).padStart(2, '0')
              ctx.lineWidth = 1
