    ...
    const optimizeCloudPerformance = () => {
      ...
      setMetrics(prev => ({
        ...
        overallPerformance: Math.round(
          (prev.connectionSpeed + prev.loadBalancing + prev.cacheOptimization + prev.serverResponse) / 4
        )
      }))
    }
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex justify-between mb-2">
              ...
              <span className="text-sm text-green-400">{metrics.cacheOptimization.toFixed(1)}%</span>
            </div>
