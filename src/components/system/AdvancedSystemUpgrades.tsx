...
export function AdvancedSystemUpgrades() {
  ...
  const installUpgrade = async (upgradeId: string) => {
    ...
    setTimeout(() => {
      setSystemStats(prev => ({
        ...
        revolutionaryFeatures: prev.revolutionaryFeatures + (upgrade.impact === 'revolutionary' ? 1 : 0)
      }))
    }, 3000)
  }
  ...
  const getImpactColor = (impact: string) => {
    switch (impact) {
      case 'revolutionary': return 'text-red-400 bg-red-900/30 border-red-500/50'
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center p-4 bg-blue-900/30 rounded-lg">
              ...
              <div className="text-2xl font-bold text-blue-400">{systemStats.exclusivityScore}/80</div>
            ...
            <div className="text-center p-4 bg-cyan-900/30 rounded-lg">
              ...
              <div className="text-2xl font-bold text-cyan-400">{systemStats.revolutionaryFeatures}</div>
            ...
            <div className="text-center p-4 bg-green-900/30 rounded-lg">
              ...
              <div className="text-2xl font-bold text-green-400">{systemStats.activeUpgrades}/{systemStats.totalUpgrades}</div>
              ...
              <CardHeader>
                <CardTitle className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <Badge className={`${upgrade.impact === 'revolutionary' ? 'bg-red-600' : upgrade.impact === 'high' ? 'bg-orange-600' : 'bg-blue-600'}`}>
