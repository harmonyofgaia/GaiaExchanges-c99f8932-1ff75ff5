...
export function MultiExchangeIntegration() {
  ...
  const submitAllApplications = async () => {
    ...
    const submissionOrder = [
      "Uniswap V3",
      "PancakeSwap",
      "Solflare Wallet Exchange",
      "ZenGo Wallet Exchange",
      "Binance DEX",
    ];
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Badge
                    variant="outline"
                    className={`border-${
                      exchange.securityLevel === "Military-Grade"
                        ? "red"
                        : exchange.securityLevel === "Enhanced"
                          ? "blue"
                          : "green"
                    }-500/20`}
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="mt-3 flex gap-2">
                    ...
                    <Button size="sm" variant="outline" asChild>
                      <a
                        href={`mailto:${exchange.contactEmail}?subject=GAiA Token Listing Application`}
                      >
