...
export function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b border-gray-800/50 bg-gray-900/95 backdrop-blur-xl supports-[backdrop-filter]:bg-gray-900/90 shadow-lg text-white">
