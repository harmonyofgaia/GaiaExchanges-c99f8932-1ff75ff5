      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="text-center">
            ...
            <div className="text-2xl font-bold text-cyan-400">{cloudData.visibility.toFixed(1)}%</div>
          ...
          <div className="text-center">
            ...
            <div className="text-2xl font-bold text-red-400">{cloudData.temperature.toFixed(1)}°C</div>
            <div className="text-sm text-muted-foreground">Temperature</div>
          </div>
          
          <div className="text-center">
            <Wind className="h-6 w-6 mx-auto mb-2 text-green-400" />
            <div className="text-2xl font-bold text-green-400">{cloudData.windSpeed.toFixed(1)} km/h</div>
