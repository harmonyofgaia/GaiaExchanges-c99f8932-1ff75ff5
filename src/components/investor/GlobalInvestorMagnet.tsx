      ...
      <CardContent className="space-y-6">
                ...
                <Card key={index} className="border-green-500/20 bg-green-900/10">
                  <CardContent className="p-4">
                    ...
                    <div className="text-sm space-y-1">
                      <div>
                        <span className="text-blue-400">Focus:</span> {investor.focus}
                      </div>
                      <div>
                        <span className="text-purple-400">Contact:</span> {investor.contact}
                      </div>
                    </div>
        ...
        <Card className="border-2 border-gold-500/50 bg-gradient-to-r from-gold-900/30 to-green-900/30">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              GAiA's revolutionary conservation technology is attracting investors worldwide who
              want to save the planet while earning returns!
            </p>
          </CardContent>
        </Card>
      </CardContent>
