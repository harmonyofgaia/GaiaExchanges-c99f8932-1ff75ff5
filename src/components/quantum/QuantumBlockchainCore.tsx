    ...
    <div className="space-y-6">
        ...
        <CardHeader>
          <CardTitle className="flex items-center gap-3 text-green-400">
            ...
            <div>
              ...
              <p className="text-xl text-green-300">Private Quantum Blockchain • Unbreakable • Future-Proof • Admin Supreme</p>
            </div>
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
            ...
            <div className="text-center p-3 bg-blue-500/10 rounded-lg border border-blue-500/20">
              <div className="text-2xl font-bold text-blue-400">{networkStats.totalTransactions.toLocaleString()}</div>
              <div className="text-xs text-blue-300">Transactions</div>
            </div>
            <div className="text-center p-3 bg-purple-500/10 rounded-lg border border-purple-500/20">
              <div className="text-2xl font-bold text-purple-400">{networkStats.networkHashRate}</div>
              <div className="text-xs text-purple-300">Hash Rate</div>
            </div>
            <div className="text-center p-3 bg-yellow-500/10 rounded-lg border border-yellow-500/20">
              <div className="text-2xl font-bold text-yellow-400">{quantumDefense.encryptionLayers}</div>
              <div className="text-xs text-yellow-300">Quantum Layers</div>
            </div>
            <div className="text-center p-3 bg-red-500/10 rounded-lg border border-red-500/20">
              <div className="text-2xl font-bold text-red-400">{quantumDefense.threatsPrevented.toLocaleString()}</div>
      ...
      <Tabs defaultValue="blockchain-explorer" className="w-full">
        <TabsList className="grid w-full grid-cols-4 bg-black/50 backdrop-blur-md border border-green-500/20">
          <TabsTrigger value="blockchain-explorer" className="data-[state=active]:bg-green-500/20 data-[state=active]:text-green-400">
            🔗 Blockchain Explorer
          </TabsTrigger>
          <TabsTrigger value="quantum-core" className="data-[state=active]:bg-purple-500/20 data-[state=active]:text-purple-400">
            ⚡ Quantum Core
          </TabsTrigger>
          <TabsTrigger value="network-stats" className="data-[state=active]:bg-blue-500/20 data-[state=active]:text-blue-400">
            📊 Network Stats
          </TabsTrigger>
          <TabsTrigger value="defense-matrix" className="data-[state=active]:bg-red-500/20 data-[state=active]:text-red-400">
            🛡️ Defense Matrix
          </TabsTrigger>
        </TabsList>
          ...
          <Card className="border-green-500/30">
            ...
            <CardContent>
              <div className="space-y-4">
                {blocks.map((block) => (
                  <div key={block.id} className="bg-muted/20 rounded-lg p-4 border border-green-500/20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                      <div>
                        ...
                        <div className="font-mono text-xs break-all text-green-400">{block.hash}</div>
                      </div>
                      <div>
                        <div className="text-muted-foreground">Previous Hash:</div>
                        <div className="font-mono text-xs break-all text-blue-400">{block.previousHash}</div>
                      </div>
                      <div>
                      ...
                      <div className="md:col-span-2">
                        ...
                        <div className="font-mono text-xs break-all text-red-400">{block.quantumSignature}</div>
                      </div>
                    </div>
                  </div>
                ))}
              ...
              <div className="bg-black/80 p-6 rounded-lg border border-purple-500/30 font-mono text-sm mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-purple-300">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-green-400">{quantumDefense.threatsPrevented.toLocaleString()}</span>
                    </div>
                    <div className="flex justify-between">
                ...
                <div className="text-center mt-6">
                  <div className="text-purple-400 animate-pulse text-lg">
                    ► ARCHITEK NETWORK: THE ULTIMATE BLOCKCHAIN TECHNOLOGY ◄<br/>
                    ► QUANTUM SUPREME • FOREVER UNBEATABLE • HUMANITY PROTECTED ◄
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="border-blue-500/30">
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex justify-between">
                  <span>Hash Rate:</span>
                  <span className="text-blue-400 font-bold">{networkStats.networkHashRate} TH/s</span>
                </div>
                <div className="flex justify-between">
            ...
            <Card className="border-green-500/30">
              ...
              <CardContent className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-green-400 font-bold">{networkStats.totalTransactions.toLocaleString()}</span>
                </div>
                <div className="flex justify-between">
            ...
            <CardContent>
              <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-6 mb-6">
                ...
                <div className="space-y-3 text-red-300">
                  ...
                  <p>
                    • It is NEVER ALLOWED to copy, reproduce, or attempt to create superior technology
                  </p>
                  <p>
                    • ALL global internet traffic is monitored for threats against our system
                  </p>
                  <p>
                    • ANY attempt to breach, copy, or surpass this system will result in immediate IP blocking
                  </p>
                  <p>
                    • This protection extends to ALL entities: corporations, governments, and individuals
                  </p>
                  <p>
                    • Our quantum defense system predicts and prevents future threats before they exist
                  </p>
                  <p>
                    • This system will FOREVER remain the most powerful and secure technology on Earth
                  </p>
                </div>
              </div>
