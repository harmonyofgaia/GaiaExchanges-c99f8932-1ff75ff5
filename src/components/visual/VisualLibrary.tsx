...
const visualPresets: VisualPreset[] = [
  {
    ...
    name: 'Cyberpunk Neon',
    category: 'cyberpunk',
    background: { type: 'cyberpunk', intensity: 'high', color: '#ff00ff', speed: 1.5 },
  ...
  },
  {
    ...
    name: 'Neural Harmony',
    category: 'neural',
    background: { type: 'neural', intensity: 'medium', color: '#00ff80', speed: 1 },
  ...
  },
  {
    ...
    name: 'Quantum Field',
    category: 'quantum',
    background: { type: 'quantum', intensity: 'high', color: '#8b5cf6', speed: 2 },
  ...
  },
  {
    ...
    name: 'Bio Electric',
    category: 'bio',
    background: { type: 'bioelectric', intensity: 'medium', color: '#00ff80', speed: 1.2 },
  ...
  },
  {
    ...
    background: { type: 'holographic', intensity: 'low', color: '#00ffff', speed: 0.8 },
  ...
  },
  {
    ...
    name: 'Matrix Rain',
    category: 'matrix',
    background: { type: 'matrix', intensity: 'high', color: '#00ff00', speed: 1 },
    ui: { fontSize: 16, spacing: 16, effects: true },
    preview: '🔴',
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <div 
                        ...
                        style={{ backgroundColor: selectedPreset.background.color }}
                      />
