      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          ...
          <CardContent>
            ...
            <div className={`text-xs flex items-center gap-1 ${getPriceChangeColor(portfolioData.totalChange)}`}>
        ...
        <CardContent>
          <div className="space-y-4">
            {portfolioData.holdings.map((holding) => {
              ...
              return (
                <div key={holding.symbol} className="flex items-center justify-between p-4 rounded-lg bg-muted/30">
