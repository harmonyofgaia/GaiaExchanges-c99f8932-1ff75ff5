...
export function SearchAllData() {
    ...
    try {
      ...
      const mockResults: SearchResult[] = [
        ...
        },
        {
          ...
          relevance: 92,
          status: 'blocked',
          metadata: { severity: 'high', action: 'blocked', source: 'automated' }
        }
      ]
  ...
  const getTypeIcon = (type: string) => {
    switch (type) {
      ...
      case 'transaction': return <Coins className="h-4 w-4" />
      case 'location': return <MapPin className="h-4 w-4" />
      case 'project': return <TreePine className="h-4 w-4" />
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            <div className="text-center">
              <div className="text-2xl font-bold text-green-400">{realTimeMetrics.totalRecords.toLocaleString()}</div>
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-red-400">{realTimeMetrics.threatsDetected}</div>
              <div className="text-sm text-muted-foreground">Threats Detected</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-purple-400">{realTimeMetrics.locationsTracked.toLocaleString()}</div>
              <div className="text-sm text-muted-foreground">Locations Tracked</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-yellow-400">{realTimeMetrics.transactionsMonitored.toLocaleString()}</div>
