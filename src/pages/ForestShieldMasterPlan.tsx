...
import { Shield, TreePine, Users, Target, Brain, Zap } from 'lucide-react'
...
// Define roadmapPhases at the top level before it's used
...
export default function ForestShieldMasterPlan() {
  ...
  const [totalProgress, setTotalProgress] = useState(63)
  ...
  const getPhaseIcon = (phase: number) => {
    switch (phase) {
      ...
      case 2: return <Brain className="h-6 w-6" />
      case 3: return <Zap className="h-6 w-6" />
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-green-900 text-white">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Overall Progress */}
        <Card className="mb-8 bg-gradient-to-br from-green-900/20 to-blue-900/20 border-green-500/20">
          <CardHeader>
