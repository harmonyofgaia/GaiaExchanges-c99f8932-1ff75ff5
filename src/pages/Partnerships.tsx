...
const Partnerships = () => {
  ...
  const partners: Partner[] = [
    {
      ...
      type: 'NGO',
      logo: '🐼',
      description: 'Global wildlife conservation organization working to protect endangered species and their habitats.',
    ...
    },
    {
      ...
      type: 'Technology',
      logo: '🚀',
      description: 'Leading provider of renewable energy solutions and environmental monitoring technologies.',
    ...
    },
    {
      ...
      type: 'Government',
      logo: '🏛️',
      description: 'Government agency focused on environmental protection and public health safeguarding.',
      website: 'epa.gov',
      projects: 6,
    ...
    },
    {
      ...
      type: 'Research',
      logo: '🔬',
      description: 'Marine research organization studying ocean health and developing conservation strategies.',
    ...
    },
    {
      ...
      type: 'Corporate',
      logo: '⚡',
      description: 'Fortune 500 company committed to sustainable business practices and carbon neutrality.',
  ...
  const handlePartnershipApplication = (e: React.FormEvent) => {
    ...
    setPartnershipForm({ organization: '', type: '', description: '', contact: '' })
  }
  ...
  const getTypeIcon = (type: Partner['type']) => {
    switch (type) {
      ...
      case 'Research': return <Award className="h-4 w-4" />
      case 'Corporate': return <TrendingUp className="h-4 w-4" />
    }
  }
        ...
        <Card className="mb-8 border-2 border-blue-500/50 bg-gradient-to-r from-blue-900/40 to-purple-900/40">
          <CardHeader>
            ...
            <p className="text-center text-xl text-blue-300">
              Collaborate with leading organizations • Amplify environmental impact • Build stronger communities
            </p>
          </CardHeader>
        </Card>
          ...
          <div className="lg:col-span-2">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {filteredPartners.map((partner) => (
                <Card key={partner.id} className="border-blue-500/30 hover:border-blue-400/50 transition-colors">
              ...
              <CardContent>
                <div className="space-y-4 text-sm">
                  <div className="p-3 bg-yellow-900/20 rounded-lg border border-yellow-500/30">
                    ...
                    <div className="text-muted-foreground">WWF + CleanTech partnership planted 500K trees using IoT monitoring</div>
                  </div>
                  <div className="p-3 bg-blue-900/20 rounded-lg border border-blue-500/30">
                    <div className="font-bold text-blue-400 mb-1">Ocean Cleanup</div>
                    <div className="text-muted-foreground">Research Institute + EPA removed 50 tons of plastic waste</div>
                  </div>
                </div>
              </CardContent>
            </Card>
