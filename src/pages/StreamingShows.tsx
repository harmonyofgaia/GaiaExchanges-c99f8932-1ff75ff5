...
export default function StreamingShows() {
  ...
  const categories = [
    ...
    { id: 'retro-70s-80s', name: '70s & 80s Life', icon: Calendar, color: 'bg-orange-600' },
    { id: 'nature-wildlife', name: 'Nature & Wildlife', icon: TreePine, color: 'bg-green-600' },
    { id: 'mad-science', name: 'Mad Science', icon: Atom, color: 'bg-blue-600' },
    { id: 'live-shows', name: 'Live Shows', icon: Radio, color: 'bg-red-600' },
    { id: 'happiness', name: 'Feel Good', icon: Smile, color: 'bg-yellow-600' },
    { id: 'hidden-secrets', name: 'Hidden Secrets', icon: Camera, color: 'bg-indigo-600' }
  ]
      ...
      const mockShows: Show[] = [
        {
          ...
          description: 'Explore the authentic happiness and simplicity of 1970s life - better cars, genuine communities, and real human connections.',
          thumbnail: '🌅',
          duration: '48:32',
          year: '1975',
          rating: 4.9,
        ...
        },
        {
          ...
          category: 'retro-70s-80s',
          description: 'Discover why the 1980s represented peak human culture - from innovative automobiles to tight-knit neighborhoods.',
          thumbnail: '🚗',
          duration: '52:18',
          year: '1983',
          rating: 4.8,
        ...
        },
        {
          ...
          description: 'Never-before-seen footage of forest elephants and their mysterious behaviors in remote African jungles.',
          thumbnail: '🐘',
          duration: '41:25',
          year: '2024',
          rating: 4.7,
        ...
        },
        {
          ...
          description: 'Mind-bending experiments that challenge everything we thought we knew about physics and reality.',
          thumbnail: '⚛️',
          duration: '55:43',
          year: '2024',
          rating: 4.6,
        ...
        },
        {
          ...
          category: 'live-shows',
          description: 'Live underwater exploration of never-seen ocean creatures and mysterious depths.',
          thumbnail: '🌊',
          duration: 'LIVE',
          year: '2024',
          rating: 4.9,
        ...
        },
        {
          ...
          category: 'happiness',
          description: 'Discover the forgotten secrets of true happiness from simpler times and how to apply them today.',
          thumbnail: '😊',
          duration: '44:12',
          year: '2023',
          rating: 4.8,
        ...
        },
        {
          ...
          description: 'Uncover archaeological discoveries that challenge official history and reveal hidden truths.',
          thumbnail: '🏛️',
          duration: '58:27',
          year: '2024',
          rating: 4.5,
          ...
          {isLoading ? (
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-primary flex items-center gap-2">
                {selectedCategory === 'all' ? '🌟 All Shows' : 
