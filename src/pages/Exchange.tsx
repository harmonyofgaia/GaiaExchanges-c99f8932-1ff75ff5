...
const Exchange = () => {
  const marketData = [
    { symbol: 'GAiA/USDT', price: '$0.00012456', change: '+12.67%', volume: '$2.8M', trend: 'up' },
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="text-center p-4 bg-green-900/20 rounded-lg">
                ...
                <div className="text-2xl font-bold text-green-400">$28.4M</div>
                <div className="text-sm text-muted-foreground">24h Volume</div>
              </div>
              <div className="text-center p-4 bg-blue-900/20 rounded-lg">
                <Activity className="h-8 w-8 text-blue-400 mx-auto mb-2" />
                <div className="text-2xl font-bold text-blue-400">189,567</div>
              ...
              <div className="text-center p-4 bg-orange-900/20 rounded-lg">
                ...
                <div className="text-2xl font-bold text-orange-400 mt-2">3,421</div>
