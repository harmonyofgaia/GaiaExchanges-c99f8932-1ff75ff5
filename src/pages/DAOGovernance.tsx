...
export default function DAOGovernance() {
    ...
    const mockProposals: Proposal[] = [
      {
        ...
        description: 'Allocate 50,000 GAIA tokens to support ocean plastic cleanup projects in Southeast Asia',
        type: 'funding',
        status: 'active',
        votesFor: 12500,
        votesAgainst: 3200,
      ...
      },
      {
        ...
        description: 'Implement a more accurate carbon credit calculation system based on latest scientific research',
        type: 'technical',
        status: 'active',
        votesFor: 8900,
        votesAgainst: 4100,
      ...
      },
      {
        ...
        description: 'Establish official partnerships with 5 major reforestation organizations worldwide',
        type: 'community',
        status: 'passed',
        votesFor: 18500,
        votesAgainst: 2100,
    ...
    setProposals(prev => prev.map(proposal => {
      if (proposal.id === proposalId) {
        return {
          ...
          votesAgainst: vote === 'against' ? proposal.votesAgainst + voteAmount : proposal.votesAgainst,
  ...
  const handleCreateProposal = () => {
    ...
    setNewProposal({ title: '', description: '', type: 'governance', requiredTokens: 1000 })
    ...
    <div className="container mx-auto px-4 py-6 space-y-6">
          ...
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-purple-400">{userTokenBalance.toLocaleString()}</p>
              </div>
          ...
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-400">{proposals.filter(p => p.status === 'active').length}</p>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setNewProposal(prev => ({ ...prev, requiredTokens: parseInt(e.target.value) || 0 }))}
                  placeholder="0"
                />
              </div>
            </div>
      ...
      <div className="space-y-4">
        {proposals.map((proposal) => {
          const progressFor = (proposal.votesFor / Math.max(proposal.quorum, proposal.totalVotes)) * 100
          const progressAgainst = (proposal.votesAgainst / Math.max(proposal.quorum, proposal.totalVotes)) * 100
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <Progress value={progressFor} className="h-2 bg-gray-700">
                      <div className="h-full bg-green-500 rounded-full" style={{ width: `${progressFor}%` }} />
                    </Progress>
                    ...
                    <Progress value={progressAgainst} className="h-2 bg-gray-700">
                      <div className="h-full bg-red-500 rounded-full" style={{ width: `${progressAgainst}%` }} />
                    </Progress>
