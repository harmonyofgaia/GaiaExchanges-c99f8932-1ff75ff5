    ...
    <SupabaseBackground bucket="public-bucket" folderPrefix="">
      <div className="relative mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <section className="lg:col-span-2 rounded-xl border border-white/10 bg-neutral-900/50 p-6 shadow-xl backdrop-blur-md">
          ...
          <aside className="rounded-xl border border-white/10 bg-neutral-900/50 p-6 shadow-xl backdrop-blur-md">
