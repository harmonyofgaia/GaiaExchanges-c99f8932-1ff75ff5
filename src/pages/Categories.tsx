...
export default function Categories() {
  ...
  const allActivities: ActivityComponent[] = [
    // Foundation Activities
    {
      ...
      description:
        "Build and maintain bee hotels to support local pollinator populations",
      icon: Home,
      points: "25 pts",
      difficulty: "Easy",
      category: "foundation",
    ...
    },
    {
      ...
      description:
        "Purchase and manage carbon offset credits for environmental impact",
      icon: TreePine,
      points: "10 pts/kg",
      difficulty: "Easy",
      category: "foundation",
    ...
    },
    {
      ...
      description:
        "Learn about sustainability through interactive courses and quizzes",
      icon: GraduationCap,
      points: "15 pts",
      difficulty: "Easy",
      category: "foundation",
    ...
    },
    {
      ...
      title: "Tree Planting",
      description:
        "Participate in local tree planting initiatives and track growth",
      icon: TreePine,
      points: "50 pts/tree",
      difficulty: "Medium",
      category: "foundation",
    ...
    // Lifestyle Activities
    {
      ...
      description:
        "Track your home garden and food production with detailed analytics",
      icon: Carrot,
      points: "Variable",
      difficulty: "Medium",
      category: "lifestyle",
    ...
    },
    {
      ...
      description:
        "Choose eco-friendly products and track sustainable purchases",
      icon: ShoppingBag,
      points: "2 pts/$",
      difficulty: "Easy",
      category: "lifestyle",
    ...
    },
    {
      ...
      description:
        "Discover and use bike-friendly routes with real-time tracking",
      icon: Bike,
    ...
    },
    {
      ...
      description:
        "Participate in advanced recycling and upcycling initiatives",
      icon: RotateCcw,
    ...
    },
    {
      ...
      description:
        "Organize and participate in local environmental cleanup events",
      icon: Users,
    ...
    },
    {
      ...
      description:
        "Collaborate in teams for large-scale environmental projects",
      icon: Trophy,
      points: "Team bonus",
      difficulty: "Medium",
      category: "community",
    ...
    },
    {
      ...
      title: "Badge System",
      description:
        "Earn and display achievement badges for completed activities",
      icon: Award,
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-green-600/20 via-blue-600/20 to-purple-600/20 border border-green-500/30 p-8">
          ...
          <div className="relative">
            ...
            <p className="text-xl text-muted-foreground max-w-4xl mx-auto text-center mb-8">
              Explore our comprehensive environmental activities through
              categories or discover them on our interactive global map! 🌍
            </p>
          ...
          {filteredActivities.map((activity) => {
            ...
            if (viewMode === "list") {
              return (
                <Card
                  key={activity.id}
                  className="bg-black/20 border border-gray-500/30 hover:border-blue-500/50 transition-all"
                >
            ...
            return (
              <Card
                key={activity.id}
                className="bg-black/20 border border-gray-500/30 hover:border-blue-500/50 transition-all hover:scale-105 group"
              >
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span
                        className={`text-xs ${getImpactColor(activity.carbonImpact)}`}
                      >
