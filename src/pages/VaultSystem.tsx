    ...
    if (distribution.length > 0) {
      setTimeout(() => {
        toast.info('Distribution Complete', {
          description: distribution.map(d => `${d.project}: ${d.amount.toFixed(2)} GAiA`).join('\n'),
          duration: 5000
        })
      }, 1000)
    }
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <Card className="bg-gradient-to-br from-green-900/30 to-emerald-900/30 border-green-500/50">
            <CardContent className="p-6 text-center">
              ...
              <div className="text-2xl font-bold text-green-400">{metrics.vaultBalance.toLocaleString()}</div>
          ...
          <Card className="bg-gradient-to-br from-red-900/30 to-orange-900/30 border-red-500/50">
            <CardContent className="p-6 text-center">
              ...
              <div className="text-2xl font-bold text-red-400">{metrics.totalBurned.toLocaleString()}</div>
          ...
          <Card className="bg-gradient-to-br from-blue-900/30 to-cyan-900/30 border-blue-500/50">
            <CardContent className="p-6 text-center">
              ...
              <div className="text-2xl font-bold text-blue-400">{metrics.totalLocked.toLocaleString()}</div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  {burningOptions.map((option) => {
                    ...
                    const isSelected = selectedProjects.includes(option.id) || (option.id === 'free_transactions' && payForFree)
