      ...
      <div className="container mx-auto px-4 py-6">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-muted-foreground mt-4">
            Complete Review & Global Command Center - Always 2 Steps Ahead
          </p>
          <p className="text-sm text-green-400 mt-2">
            🌍 Gaia's Exchange - World's Most Advanced & Secure Platform
          </p>
        </div>
        ...
        <Tabs defaultValue="overview" className="w-full">
          <TabsList className="grid w-full grid-cols-5 bg-black/50 backdrop-blur-md border border-green-500/20">
            ...
            <TabsTrigger value="global" className="data-[state=active]:bg-blue-500/20 data-[state=active]:text-blue-400">
              🌍 Global Intel
            </TabsTrigger>
