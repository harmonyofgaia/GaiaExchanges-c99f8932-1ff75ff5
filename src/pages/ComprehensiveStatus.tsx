            ...
            <Card className="border-orange-500/30 bg-orange-900/20">
              ...
              <CardContent>
                <div className="text-center space-y-4">
                  ...
                  <div className="text-2xl font-bold text-orange-400">4 DRAGONS ACTIVE & IMMORTAL</div>
                  <div className="text-lg text-muted-foreground">
          ...
          <TabsContent value="admin" className="space-y-6">
            <Card className="border-gold-500/30 bg-yellow-900/20">
              ...
              <CardContent>
                <div className="text-center space-y-4">
                  <div className="text-6xl animate-pulse">👑</div>
                  <div className="text-2xl font-bold text-yellow-400">SUPREME ADMIN CONTROL ACTIVE</div>
                  <div className="text-lg text-muted-foreground">
