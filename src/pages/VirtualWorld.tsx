...
import { Globe, Users, Gamepad2, Zap, Crown, Star, Rocket, Cpu, Mountain, Trees, Waves, Sun, Settings, Palette, Layers, Sparkles } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-purple-900/20 to-blue-900/20">
      <div className="container mx-auto px-4 py-6">
        <div className="flex items-center justify-center mb-8">
          <UniversalGaiaLogo className="hover:scale-105 transition-transform duration-300" />
        </div>
        ...
        <Tabs defaultValue="virtual-world" className="w-full">
          <TabsList className="grid w-full grid-cols-5 mb-8">
            ...
            <TabsTrigger value="landscape-builder">🏔️ Landscape Builder</TabsTrigger>
            <TabsTrigger value="advanced-creator">🎨 Advanced Creator</TabsTrigger>
            <TabsTrigger value="my-landscapes">📁 My Landscapes</TabsTrigger>
          ...
          <TabsContent value="landscape-builder" className="space-y-6">
          ...
          <TabsContent value="advanced-creator" className="space-y-6">
            <VirtualLandscapeCreator />
            <LandscapeToolbox />
          </TabsContent>

          <TabsContent value="my-landscapes" className="space-y-6">
            <MyLandscapeManager />
          </TabsContent>
