  ...
  const posts: CommunityPost[] = [
    {
      ...
      content: 'Just wanted to share my 6-month solar journey. Generated 2,400 kWh and earned 240 GAiA tokens through verified green energy production!',
      category: 'Energy',
    ...
    },
    {
      ...
      content: 'Starting a new community garden in downtown area. Looking for volunteers and contributors. Together we can create a green oasis!',
      category: 'Gardening',
    ...
    },
    {
      ...
      content: 'Developed an open-source app that uses AI to track and reduce your carbon footprint. Check it out and let me know your thoughts!',
      category: 'Technology',
  ...
  const events: CommunityEvent[] = [
    {
      ...
      description: 'Join thousands of eco-warriors worldwide for coordinated climate action activities',
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4 items-center">
                  ...
                  <div className="flex gap-2">
                    {['all', 'Energy', 'Gardening', 'Technology', 'Conservation'].map(category => (
                      <Button
                        key={category}
                ...
                {[
                  ...
                  <div key={contributor.name} className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-green-400">{contributor.points.toLocaleString()} points</div>
                    </div>
