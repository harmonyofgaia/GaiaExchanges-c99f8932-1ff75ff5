        ...
        <div className="container mx-auto px-6 py-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            {featuredGames.map((game, index) => (
              <Card
                key={index}
                className={`border-2 bg-gradient-to-br ${game.color}/20 hover:scale-105 transition-all cursor-pointer`}
              >
                <CardHeader>
          ...
          <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
            ...
            <div className="text-sm text-green-300">
              ...
              <br />
              ✅ All games connected to GAIA token system
              <br />
              ✅ Real-time environmental impact tracking via blockchain
              <br />
              ✅ Secure player data and achievements on-chain
              <br />✅ Cross-game token transfers and rewards active
            </div>
          </div>
        </div>
      </div>
