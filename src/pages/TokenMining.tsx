      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
          <Card className="bg-gradient-to-br from-green-900/30 to-emerald-900/30 border-green-500/50">
            <CardContent className="p-6 text-center">
              ...
              <div className="text-2xl font-bold text-green-400">{totalHashRate.toFixed(1)} MH/s</div>
          ...
          <Card className="bg-gradient-to-br from-purple-900/30 to-pink-900/30 border-purple-500/50">
            <CardContent className="p-6 text-center">
              ...
              <div className="text-2xl font-bold text-purple-400">{networkDifficulty.toFixed(1)}%</div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-300">Automatically optimize mining operations for maximum efficiency</p>
              </div>
              <Button 
                size="lg"
                className={`${isAutoMining 
        ...
        <Tabs defaultValue="rigs" className="mb-8">
          <TabsList className="grid w-full grid-cols-4 bg-gray-900/50 border border-green-500/30">
            <TabsTrigger value="rigs" className="data-[state=active]:bg-green-600/20 data-[state=active]:text-green-400">Mining Rigs</TabsTrigger>
            <TabsTrigger value="stats" className="data-[state=active]:bg-green-600/20 data-[state=active]:text-green-400">Statistics</TabsTrigger>
            <TabsTrigger value="rewards" className="data-[state=active]:bg-green-600/20 data-[state=active]:text-green-400">Rewards</TabsTrigger>
            <TabsTrigger value="upgrade" className="data-[state=active]:bg-green-600/20 data-[state=active]:text-green-400">Upgrades</TabsTrigger>
          </TabsList>

          <TabsContent value="rigs" className="space-y-6 mt-8">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {miningRigs.map((rig) => (
                <Card key={rig.id} className="bg-gradient-to-br from-gray-900/50 to-green-900/20 border-green-500/30 hover:border-green-400/50 transition-all">
                  <CardHeader>
                    <div className="flex items-center justify-between">
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          ...
                          <div className="text-green-400 font-semibold">{rig.hashRate.toFixed(1)} MH/s</div>
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <div className={`font-semibold ${rig.powerConsumption === 0 ? 'text-green-400' : 'text-orange-400'}`}>
                            {rig.powerConsumption === 0 ? 'Solar' : `${rig.powerConsumption}W`}
                          </div>
                        </div>
                        <div>
                          <div className="text-gray-400">Daily Reward</div>
                          <div className="text-purple-400 font-semibold">{rig.dailyReward} GAiA</div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <Progress value={Math.min((rig.totalMined / 10000) * 100, 100)} className="h-2" />
                      </div>
          ...
          <TabsContent value="stats">
            <div className="text-center py-12">
              ...
              <p className="text-gray-300">Detailed analytics and performance metrics coming soon...</p>
            </div>
          </TabsContent>
          ...
          <TabsContent value="upgrade">
            <div className="text-center py-12">
              ...
              <p className="text-gray-300">Hardware and software upgrade marketplace coming soon...</p>
            </div>
          </TabsContent>
        </Tabs>
