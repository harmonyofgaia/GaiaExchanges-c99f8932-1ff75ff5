...
export default function EcoAvatar() {
  ...
  const accessories = [
    ...
    { id: 'solar_glasses', name: 'Solar Glasses', icon: '🕶️', cost: 50, eco: true },
    { id: 'nature_necklace', name: 'Nature Necklace', icon: '📿', cost: 75, eco: true },
    { id: 'wind_scarf', name: 'Wind Scarf', icon: '🧣', cost: 30, eco: true },
    { id: 'earth_boots', name: 'Earth Boots', icon: '👢', cost: 120, eco: true }
  ]

  const specialEffects = [
    { id: 'green_aura', name: 'Green Aura', icon: '✨', cost: 0, description: 'Eco energy glow' },
    { id: 'solar_rays', name: 'Solar Rays', icon: '☀️', cost: 200, description: 'Radiant solar energy' },
    { id: 'nature_particles', name: 'Nature Particles', icon: '🌿', cost: 150, description: 'Floating leaves and flowers' },
    { id: 'ocean_waves', name: 'Ocean Waves', icon: '🌊', cost: 180, description: 'Flowing water effects' },
    { id: 'earth_crystals', name: 'Earth Crystals', icon: '💎', cost: 250, description: 'Crystalline formations' },
    { id: 'wind_swirls', name: 'Wind Swirls', icon: '🌪️', cost: 170, description: 'Air currents and swirls' }
  ]
            ...
            <CardContent className="space-y-6">
              ...
              <div className="aspect-square bg-gradient-to-b from-sky-200 to-green-200 rounded-lg p-8 relative overflow-hidden">
                ...
                <div className="relative z-10 h-full flex flex-col items-center justify-end">
                  ...
                  <div className="text-8xl mb-4">
                    {avatar.clothing === 'nature_guardian' ? '🧙‍♀️' :
                     avatar.clothing === 'solar_suit' ? '👨‍🚀' :
                     avatar.clothing === 'ocean_protector' ? '🏊‍♀️' : '🧑‍🌾'}
                  </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="text-center p-3 bg-yellow-900/30 rounded-lg">
                  ...
                  <div className="text-lg font-bold text-yellow-400">{avatar.accessories.length}</div>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      {accessories.map(accessory => (
                        <div key={accessory.id} className="flex items-center justify-between p-3 bg-background/50 rounded-lg">
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      {specialEffects.map(effect => (
                        <div key={effect.id} className="flex items-center justify-between p-3 bg-background/50 rounded-lg">
                          <div className="flex items-center gap-3">
