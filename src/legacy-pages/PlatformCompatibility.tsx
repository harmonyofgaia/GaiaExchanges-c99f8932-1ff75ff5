      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Harmony of Gaia is designed to be the most universal, secure, and immersive platform for
            environmental gaming and blockchain integration. Experience the future of gaming and
            sustainability across all your devices and realities.
          </p>
