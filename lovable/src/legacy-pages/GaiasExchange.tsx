          ...
          <Card className="bg-gradient-to-br from-green-900/30 to-cyan-900/30 border-2 border-green-500/50">
            <CardContent className="pt-4 text-center">
              ...
              <div className="text-xs text-green-300 flex items-center justify-center gap-1">
                <ArrowUpRight className="h-3 w-3" />+{marketData.gaiaChange.toFixed(2)}%
              </div>
                ...
                <div className="mt-6 p-4 bg-gradient-to-r from-green-900/30 to-blue-900/30 border border-green-500/20 rounded-lg">
                  <div className="text-center">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Bank-level security, multi-factor authentication, and the highest trust score
                      in the industry
                    </p>
                  </div>
                </div>
              ...
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Every trade on Gaia's Exchange contributes to coral reef restoration and
                    environmental projects worldwide!
                  </p>
                  <div className="text-lg font-bold text-green-400 mb-1">0.05% of all trades</div>
            ...
            <CardContent className="py-8">
              <div className="text-center">
                ...
                <p className="text-xl text-muted-foreground mb-6">
                  🏛️ Building the future of environmental cryptocurrency trading with unmatched
