            ...
            <CardContent className="flex flex-col items-center space-y-4">
              {!gameState.isPlaying && !gameState.gameOver ? (
                <div className="text-center space-y-4">
                  ...
                  <p className="text-muted-foreground">Collect environmental power-ups and grow your snake!</p>
                  <Button 
                    onClick={resetGame}
            ...
            <CardContent className="space-y-6">
              ...
              <div className="p-4 bg-green-900/20 border border-green-500/30 rounded-lg">
                ...
                <p className="text-sm text-green-300">
                  Each power-up you collect represents saving an endangered species! 
                  Keep playing to make a positive environmental impact.
                </p>
              </div>
            </CardContent>
          </Card>
