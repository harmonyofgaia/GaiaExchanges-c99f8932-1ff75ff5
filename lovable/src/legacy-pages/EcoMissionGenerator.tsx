      ...
      const advancedMissionTemplates = [
        {
          ...
          description:
            "Plant {count} trees using AI-selected native species optimal for your location and current climate conditions. GPS verification required.",
        ...
        },
        {
          ...
          description:
            "AI-identified waste hotspot cleanup with automatic categorization. Use app to scan and categorize waste types for maximum environmental impact.",
          difficulty: Math.floor(Math.random() * 3) + 1,
          tokens: 50,
          carbon_impact: 20,
          icon: Recycle,
        ...
        },
        {
          ...
          description:
            "Monitor and document wildlife in AI-predicted migration corridors. Critical for biodiversity mapping and conservation planning.",
          difficulty: 3,
          tokens: 120,
          carbon_impact: 50,
          icon: Globe,
        ...
        },
        {
          ...
          description:
            "Help {count} households transition to renewable energy through education and resource sharing. Track adoption rates.",
          difficulty: 3,
          tokens: 150,
          carbon_impact: 80,
          icon: Zap,
        ...
        },
        {
          ...
          description:
            "Comprehensive ecosystem health assessment using IoT sensors and community observations. Data feeds into global climate models.",
          difficulty: 2,
          tokens: 90,
          carbon_impact: 45,
          icon: Globe,
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-cyan-400">
                {missionMetrics.aiAccuracy.toFixed(1)}%
              </div>
