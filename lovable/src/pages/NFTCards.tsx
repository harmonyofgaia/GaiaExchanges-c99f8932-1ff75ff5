...
export default function NFTCards() {
  ...
  const CardComponent = ({ card }: { card: NFTCard }) => (
    <Card className={`border-2 ${
      card.rarity === 'mythical' ? 'border-red-500/50 bg-gradient-to-br from-red-900/30 to-purple-900/30' :
      card.rarity === 'legendary' ? 'border-orange-500/50 bg-gradient-to-br from-orange-900/30 to-yellow-900/30' :
      card.rarity === 'epic' ? 'border-purple-500/50 bg-gradient-to-br from-purple-900/30 to-pink-900/30' :
      card.rarity === 'rare' ? 'border-blue-500/50 bg-gradient-to-br from-blue-900/30 to-cyan-900/30' :
