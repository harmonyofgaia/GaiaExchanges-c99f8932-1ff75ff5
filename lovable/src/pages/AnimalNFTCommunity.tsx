  ...
  const [investmentGoals] = useState([
    {
      ...
      description:
        "Create multi-layered forest ecosystems with canopy, understory, shrub, herbaceous, moss, root, and fungal layers",
      targetAmount: 500000,
    ...
    },
    {
      ...
      description:
        "Design specialized pollinator havens with native flowering plants and nesting sites",
      targetAmount: 150000,
      currentAmount: 98750,
      progress: 66,
          ...
          <Card className="border-red-500/30 bg-gradient-to-br from-red-900/30 to-pink-900/30 animate-fade-in">
            <CardContent className="pt-4 text-center">
              ...
              <div className="text-2xl font-bold text-red-400">
                {globalStats.liveViewers.toLocaleString()}
              </div>
                    ...
                    <div className="p-4 bg-gradient-to-r from-green-900/40 to-blue-900/40 rounded-lg border border-green-500/30 relative overflow-hidden">
                      ...
                      <div className="relative z-10">
                        ...
                        <div className="text-sm text-muted-foreground">
                          Investors: {animal.investors} | Total: $
                          {animal.totalInvested.toLocaleString()}
                        </div>
                      </div>
                    </div>
