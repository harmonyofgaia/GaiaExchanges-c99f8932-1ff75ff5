        ...
        <div className="container mx-auto px-6 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
            ...
            <Card className="border-green-500/30 bg-gradient-to-br from-green-900/30 to-black">
              <CardHeader>
                <CardTitle className="text-green-400 text-center">
                  🌱 GREEN INVESTMENTS MATRIX
                </CardTitle>
              </CardHeader>
              <CardContent>
                <MatrixWalletDisplay
                  walletAddress={GAIA_TOKEN.GREEN_INVESTMENTS_WALLET}
                  label="Green Investments Wallet"
                />
              </CardContent>
            </Card>
            ...
            <Card className="border-purple-500/30 bg-gradient-to-br from-purple-900/30 to-black">
              ...
              <CardContent>
                <MatrixWalletDisplay
                  walletAddress={GAIA_TOKEN.COMMUNITY_VAULT_WALLET}
                  label="Community Vault Wallet"
                />
              </CardContent>
            </Card>
              ...
              <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-4 mb-2">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Button
                    onClick={() => {
                      navigator.clipboard.writeText(GAIA_TOKEN.WALLET_ADDRESS);
                      toast.success("Main Community Wallet Address Copied!");
                    }}
                    variant="outline"
                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Button
                    onClick={() => {
                      ...
                      toast.success("Green Investments Wallet Address Copied!");
                    }}
                    variant="outline"
                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Button
                    onClick={() => {
                      ...
                      toast.success("Community Vault Wallet Address Copied!");
                    }}
                    variant="outline"
                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Button
                    onClick={() => {
                      ...
                      toast.success("Animal Welfare Wallet Address Copied!");
                    }}
                    variant="outline"
