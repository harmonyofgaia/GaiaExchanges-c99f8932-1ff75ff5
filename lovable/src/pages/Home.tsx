...
export default function Home() {
  ...
  // Supabase public bucket background image URL
  const backgroundUrl = "https://slheudxfcqqppyphyobq.supabase.co/storage/v1/object/public/public-bucket/home.jpg";

  return (
    <div className="min-h-screen relative overflow-hidden">
      {/* Supabase background image */}
      <img
        src={backgroundUrl}
        alt="Background"
      ...
      {/* Optionally, keep the EnhancedBackgroundManager for effects, but overlay content above the image */}
      <div className="absolute inset-0 z-10">
        <SystemMonitor />
        <CrossPagePersistence />
        <InvisibleEcoIndicator />

        {/* Optionally, comment out EnhancedBackgroundManager if you want only the image */}
