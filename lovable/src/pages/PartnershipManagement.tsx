            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="p-3 bg-blue-900/20 rounded-lg border border-blue-500/20">
                  ...
                  <p className="text-xs text-muted-foreground mb-2">Marine ecosystem protection partner</p>
                ...
                <div className="p-3 bg-purple-900/20 rounded-lg border border-purple-500/20">
                  ...
                  <p className="text-xs text-muted-foreground mb-2">Animal welfare and habitat restoration</p>
