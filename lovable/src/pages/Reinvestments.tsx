      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Complete transparency: 5% coral reef restoration, 90% project
            reinvestment, 10% community rewards
          </p>
        </div>
      ...
      <Card className="border-2 border-cyan-500/50 bg-gradient-to-br from-cyan-900/30 to-blue-900/30">
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-cyan-400">
            ...
            🌊 PERSONAL PROJECT: Sound Riffs Re Grau dio - Coral Reef
            Restoration
        ...
        <CardContent className="space-y-4">
          <div className="text-center">
            ...
            <p className="text-lg text-cyan-300 mb-4">
              Personal commitment: Revolutionary underwater audio technology
              helping coral reefs recover and attract marine life back to
              damaged ecosystems
            </p>
          </div>
          ...
          <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-lg p-4">
            <h4 className="font-bold text-cyan-400 mb-2">
              🎵 Connected to Official GAiA Wallet:
            </h4>
            <div className="font-mono text-sm bg-black/30 p-2 rounded break-all text-cyan-300 mb-2">
              {GAIA_TOKEN.WALLET_ADDRESS}
            </div>
            <p className="text-sm text-cyan-300">
              This is where 5% of ALL GAiA token burns are automatically sent to
              fund real-world coral reef restoration through Sound Riffs Re Grau
              dio technology.
            </p>
          </div>
      ...
      <Card className="border-green-500/20">
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-green-400">
            ...
            Environmental Reinvestment Projects - Updated Allocation (5% Coral /
            90% Project / 10% Community)
          </CardTitle>
        </CardHeader>
        <CardContent>
                  ...
                  {project.id === 1 && (
                    <div className="mt-3 space-y-2">
                      <div className="p-3 bg-cyan-500/10 rounded border border-cyan-500/20">
                        <p className="text-sm text-cyan-300">
                          🎵 Personal project: {project.burnContribution}% of
                          all GAiA token burns automatically fund coral reef
                          restoration through innovative sound technology.
                        </p>
                      </div>
        ...
        <CardContent className="p-6">
          <div className="text-center space-y-4">
            <h3 className="text-xl font-semibold text-primary">
              Expand Harmony of Gaia Network
            </h3>
            <p className="text-muted-foreground">
              Join the movement to create the world's most trusted and
              environmentally conscious crypto exchange with 90% project
              reinvestment
            </p>
          ...
          <div className="flex items-center gap-3 text-center justify-center">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Every token verified • Every transaction transparent • Every
                reinvestment tracked • 90% project reinvestment • Building the
