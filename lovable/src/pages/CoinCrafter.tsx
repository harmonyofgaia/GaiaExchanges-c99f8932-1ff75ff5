          ...
          <Card className="border-2 border-green-500/50 bg-gradient-to-r from-green-900/30 to-blue-900/30">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                ...
                <Badge className="bg-green-600 text-white">Connected to Official GAiA</Badge>
              </div>
            </CardContent>
          </Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="bg-purple-900/20 border border-purple-500/20 rounded-lg p-4">
                  ...
                  <div className="text-xs text-purple-300/80">
                    • Only usable in Gaia Fantasy Exchange • Powers character tactics & abilities •
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <Badge className="bg-purple-600 mb-2">{token.tactics}</Badge>
                      <div className="text-sm text-muted-foreground">Supply: {token.supply}</div>
                    </div>
                  </div>
          ...
          <Card className="border-2 border-orange-500/50 bg-gradient-to-br from-orange-900/20 to-yellow-900/20">
            <CardHeader>
              ...
              <p className="text-orange-300">
                Automated GAiA token creation and burning system that maintains perfect supply
                balance
              </p>
            </CardHeader>
            <CardContent>
              ...
              <div className="space-y-4">
                <div className="bg-orange-900/20 border border-orange-500/20 rounded-lg p-4">
                  ...
                  <p className="text-orange-300/90 mb-3">
                    An autonomous AI-powered forge that continuously monitors GAiA token supply and
                    demand. When demand increases, it mints new tokens. When supply exceeds demand,
                    it burns excess tokens. This ensures GAiA always maintains stable value for the
                    ecosystem.
                  </p>
