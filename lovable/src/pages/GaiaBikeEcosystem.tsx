                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-blue-400 font-semibold">
                        {userStats.distanceTraveled} km
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-300">Energy Generated</span>
                      <span className="text-yellow-400 font-semibold">
                        {userStats.energyGenerated} kWh
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
              ...
              <CardContent>
                <div className="space-y-4">
                  {[
                    ...
                    <div
                      key={rider.rank}
                      className="flex items-center justify-between p-4 rounded-lg bg-gray-800/30 border border-gray-600/30"
                    >
