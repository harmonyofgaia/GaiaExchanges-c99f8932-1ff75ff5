...
export function AIFighterCompanion() {
  ...
  const [chatMessages, setChatMessages] = useState([
    {
      ...
      sender: "ARIA",
      message:
        "Hello Fighter! I've analyzed your last 50 battles. Your combo timing has improved 23%!",
      time: "2m ago",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      sender: "ARIA",
      message:
        "Your defense patterns are predictable. Try mixing high and low blocks more randomly. I'll help you practice!",
      time: "30s ago",
    },
  ]);
  ...
  const [aiInsights, setAiInsights] = useState([
    {
      type: "strength",
      insight: "Excellent combo execution in close combat",
      confidence: 94,
    },
    {
      type: "weakness",
      insight: "Vulnerable to aerial attacks from top-left",
      confidence: 87,
    },
    {
      type: "opportunity",
      insight: "Counter-attack timing can be improved by 0.3s",
      confidence: 92,
    },
    {
      type: "prediction",
      insight: "Next opponent likely uses defensive strategy",
      confidence: 89,
    },
  ]);
