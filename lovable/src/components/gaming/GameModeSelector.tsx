  ...
  return (
    <Card className="border-blue-500/30 bg-blue-900/20">
      <CardHeader>
        ...
        <p className="text-muted-foreground text-sm">Choose your preferred gameplay style and challenge level</p>
      </CardHeader>
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {modes.map((mode, index) => (
            <div key={index} className="p-4 bg-purple-900/20 rounded-lg border border-purple-500/20 hover:scale-105 transition-all">
