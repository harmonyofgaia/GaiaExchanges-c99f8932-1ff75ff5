  ...
  return (
    <Card className="border-green-500/30 bg-green-900/20">
      <CardHeader>
        ...
        <p className="text-muted-foreground text-sm">Transform your gaming experience with unique visual styles</p>
      </CardHeader>
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {styles.map((style, index) => (
            <div key={index} className={`p-4 bg-gradient-to-br ${style.color}/20 rounded-lg border border-opacity-50 hover:scale-105 transition-all`}>
