  ...
  return (
    <div className="relative w-10 h-10 flex items-center justify-center">
      ...
      <div className="relative w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 via-green-500 to-blue-600 shadow-lg overflow-hidden">
        ...
        {/* Atmosphere glow */}
        <div
          className="absolute -inset-0.5 rounded-full bg-gradient-to-r from-transparent via-blue-300/20 to-transparent animate-spin"
      ...
      />
      <div
        className="absolute top-0 left-1/2 w-1 h-1 bg-green-400 rounded-full transform -translate-x-1/2 animate-bounce"
        style={{ animationDelay: "0s" }}
      />
      <div
        className="absolute bottom-0 right-1/2 w-0.5 h-0.5 bg-blue-400 rounded-full transform translate-x-1/2 animate-bounce"
