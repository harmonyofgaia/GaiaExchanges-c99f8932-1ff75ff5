...
export function WebsiteTemplateSystem() {
  ...
  const handleLayoutChange = (layoutType: keyof TemplateConfig['layout'], value: boolean | number) => {
    setCustomTemplate(prev => ({
      ...prev,
      layout: {
        ...prev.layout,
            ...
            <CardContent>
              ...
              >
                {customTemplate.layout.header && (
                  ...
                  >
                    <h1 className="text-2xl font-bold" style={{ color: customTemplate.colors.background }}>
                      {customTemplate.name}
                    </h1>
                  </div>
                )}
                
                <div className={`grid gap-4 ${customTemplate.layout.columns > 1 ? `grid-cols-${customTemplate.layout.columns}` : ''}`}>
                  <div className="p-4 rounded" style={{ backgroundColor: customTemplate.colors.secondary, color: customTemplate.colors.background }}>
                    <h2 className="text-xl font-semibold mb-2">Main Content</h2>
                    <p>This is a preview of your custom template with the selected colors and typography.</p>
                  </div>
                  
                  {customTemplate.layout.sidebar && (
                    <div className="p-4 rounded" style={{ backgroundColor: customTemplate.colors.accent, color: customTemplate.colors.background }}>
            ...
            <CardContent className="space-y-4">
              <div className="text-center">
                <p className="text-muted-foreground mb-6">
                  Ready to deploy your custom template? This will generate the necessary files and configuration.
                </p>
