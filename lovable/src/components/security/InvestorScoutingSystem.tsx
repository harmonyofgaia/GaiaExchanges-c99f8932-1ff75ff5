    ...
    const scoutForInvestors = () => {
      ...
      if (Math.random() < 0.3) {
        const investorCategories = [
          {
            name: "Quantum Tech Ventures",
            category: "Deep Tech",
            capacity: "$50M-$500M",
            specialization: "Quantum Computing & AI Security",
          },
          {
            name: "Blockchain Security Fund",
            category: "Crypto Security",
            capacity: "$10M-$100M",
            specialization: "Cryptocurrency & DeFi Protection",
          },
          {
            name: "Green Innovation Capital",
            category: "Environmental Tech",
            capacity: "$25M-$250M",
            specialization: "Sustainable Technology Solutions",
          },
          {
            name: "AI Revolution Partners",
            category: "Artificial Intelligence",
            capacity: "$100M-$1B",
            specialization: "Advanced AI & Machine Learning",
          },
          {
            name: "Fintech Disruptors LLC",
            category: "Financial Technology",
            capacity: "$20M-$200M",
            specialization: "Revolutionary Financial Systems",
          },
          {
            name: "Cyber Defense Ventures",
            category: "Cybersecurity",
            capacity: "$15M-$150M",
            specialization: "Advanced Threat Protection",
          },
          {
            name: "Future Tech Consortium",
            category: "Emerging Technology",
            capacity: "$75M-$750M",
            specialization: "Next-Generation Innovation",
          },
          {
            name: "Harmony Investment Group",
            category: "Holistic Solutions",
            capacity: "$30M-$300M",
            specialization: "Integrated Technology Ecosystems",
          },
        ];
        ...
        <div className="space-y-3 max-h-60 overflow-y-auto">
          {investorLeads.length === 0 ? (
            ...
            investorLeads.map((lead) => (
              <div
                key={lead.id}
                className="p-4 rounded-lg bg-gradient-to-r from-green-900/20 to-blue-900/20 border border-green-500/30"
              >
