          ...
          <div className="space-y-4">
            <div>
              <div className="flex justify-between text-sm mb-2">
                ...
                <span>
                  {securityStatus.secureChains}/{securityStatus.monitoredChains}
                </span>
              </div>
              <Progress
                value={
            ...
            {contractScans.length > 0 ? (
              contractScans.map((contract, index) => (
                <div
                  ...
                  className="p-4 bg-red-900/10 rounded-lg border border-red-500/20"
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <Badge
                      className={`${contract.riskScore > 0.7 ? "bg-red-600" : contract.riskScore > 0.4 ? "bg-orange-600" : "bg-green-600"} text-white`}
                    >
                      {contract.riskScore > 0.7
                        ? "HIGH RISK"
                        : contract.riskScore > 0.4
                          ? "MEDIUM RISK"
                          : "LOW RISK"}
                    </Badge>
                  </div>
          ...
          <div className="space-y-4">
            {crossChainTxs.length > 0 ? (
              crossChainTxs.map((tx, index) => (
                <div
                  key={tx.id}
                  className="p-4 bg-green-900/10 rounded-lg border border-green-500/20"
                >
                  <div className="flex items-start justify-between mb-3">
                    <div>
