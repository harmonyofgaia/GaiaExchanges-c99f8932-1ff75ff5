      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="space-y-2">
            ...
            <div className="text-2xl font-bold text-primary">{status.memeticWeapons.active}/{status.memeticWeapons.total}</div>
          </div>
          <div className="space-y-2">
            <div className="flex items-center gap-2">
            ...
            <div className="text-2xl font-bold text-primary">{status.consciousnessHijacks.successful}</div>
          </div>
          <div className="space-y-2">
            <div className="flex items-center gap-2">
            ...
            <div className="text-2xl font-bold text-primary">{status.psychicNetworks.connected}</div>
          </div>
          <div className="space-y-2">
            <div className="flex items-center gap-2">
            ...
            <div className="text-2xl font-bold text-primary">{status.realityGlitches.exploitable}</div>
          </div>
        </div>
        <div className="space-y-2">
          <div className="flex items-center gap-2">
          ...
          <div className="text-sm text-muted-foreground">{(status.globalMindControl * 100).toFixed(1)}% Mind Control</div>
        </div>
