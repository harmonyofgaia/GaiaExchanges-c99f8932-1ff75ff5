        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-black/30 p-4 rounded-lg border border-red-500/20">
            <div className="text-2xl font-bold text-red-400">
              {metrics.totalAttacksBlocked.toLocaleString()}
            </div>
          ...
          {counterAttacks.length === 0 ? (
            ...
            counterAttacks.map((attack) => {
              ...
              return (
                <div
                  key={attack.id}
                  className={`p-3 rounded-lg border bg-black/20 ${getStatusColor(attack.status)}`}
                >
                  ...
                  <div className="text-xs mt-2 space-y-1">
                    ...
                    <div className="text-gray-400">
                      Time: {attack.timestamp.toLocaleTimeString()}
                    </div>
                  </div>
                </div>
              );
