...
export function PageSpecificBackground() {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0" style={{ zIndex: -1 }}>
      ...
      <div
        className={`absolute inset-0 bg-gradient-to-br from-transparent via-black/3 to-black/8 ${
      ...
      <div
        className={`absolute inset-0 bg-[url('/lovable-uploads/2ab2dcf8-008f-4f94-9341-9b6fcb25cefb.png')] bg-cover bg-center opacity-1 mix-blend-soft-light ${
          config.disableMouseInteraction ? "opacity-1" : ""
        }`}
        style={{ zIndex: -1 }}
      />
      <div
        className={`absolute inset-0 bg-[url('/lovable-uploads/494a76f3-e002-482a-b606-e7af62367027.png')] bg-cover bg-center opacity-1 mix-blend-overlay ${
          config.disableMouseInteraction ? "opacity-1" : ""
        }`}
        style={{ zIndex: -1 }}
      />
      ...
      <div
        className={`absolute inset-0 bg-[radial-gradient(circle_at_30%_30%,rgba(0,255,255,0.08)_0%,transparent_50%)] ${
          config.disableMouseInteraction ? "opacity-5" : ""
        }`}
        style={{ zIndex: -1 }}
      />
      <div
        className={`absolute inset-0 bg-[radial-gradient(circle_at_70%_70%,rgba(255,100,200,0.06)_0%,transparent_50%)] ${
          config.disableMouseInteraction ? "opacity-5" : ""
        }`}
        style={{ zIndex: -1 }}
      />
