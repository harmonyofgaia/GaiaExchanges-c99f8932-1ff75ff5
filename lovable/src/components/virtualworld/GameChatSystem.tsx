...
export function GameChatSystem({ activeUsers }: GameChatSystemProps) {
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      ...
      user: "EcoWarrior123",
      message:
        "Just burned 50 tokens to plant virtual trees! 🌱 Anyone want to join my environmental quest?",
    ...
    },
    {
      ...
      user: "OceanGuardian",
      message:
        "Amazing virtual coral reef restoration happening in the Ocean Paradise! Come check it out!",
    ...
    },
    {
      ...
      user: "System",
      message:
        "Global Token Burning Event completed! 2,500 GAIA tokens burned for environmental projects. Next event in 2 hours!",
  ...
  const [onlineUsers] = useState<OnlineUser[]>([
    ...
    {
      name: "ForestProtector",
      level: 28,
      badge: "Tree Planter",
      room: "Enchanted Forest",
      status: "away",
      avatar: "🌲",
    },
    {
  ...
  const sendMessage = () => {
    if (newMessage.trim()) {
      ...
      const isTrade =
        newMessage.toLowerCase().includes("wts") ||
        newMessage.toLowerCase().includes("wtb") ||
        newMessage.toLowerCase().includes("wtt");
                    ...
                    >
                      <div className="flex items-center gap-2 flex-1">
                        <div className="relative">
                          ...
                          <div
                            className={`absolute -bottom-1 -right-1 w-2 h-2 rounded-full ${getStatusColor(user.status)}`}
                          />
                        </div>
