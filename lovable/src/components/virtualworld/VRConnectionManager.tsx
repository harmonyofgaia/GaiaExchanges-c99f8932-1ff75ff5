            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch 
                  ...
                  onCheckedChange={(checked) => setVrSettings(prev => ({...prev, trackingEnabled: checked}))}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch 
                  ...
                  onCheckedChange={(checked) => setVrSettings(prev => ({...prev, hapticFeedback: checked}))}
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch 
                  ...
                  onCheckedChange={(checked) => setVrSettings(prev => ({...prev, audioEnhanced: checked}))}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch 
                  ...
                  onCheckedChange={(checked) => setVrSettings(prev => ({...prev, environmentalEffects: checked}))}
                />
              </div>
            </div>
          </div>
