        ...
        <CardContent className="space-y-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Share your vision and ideas with our transparent GAiA community to help us find the
              best ways to eliminate swap costs for everyone.
            </p>
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <select
                ...
                onChange={(e) =>
                  setFromToken(
                    supportedTokens.find((t) => t.symbol === e.target.value) || supportedTokens[0]
                  )
                }
            ...
            {supportedTokens.map((token, index) => (
              ...
              >
                ...
                <div className="flex flex-col items-end gap-1">
                  <Badge
                    variant="outline"
                    className={token.fee === 0 ? "border-green-500/20 text-green-400" : ""}
                  >
