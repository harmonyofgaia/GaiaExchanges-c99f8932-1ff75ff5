              ...
              <div className="text-center space-y-4">
                ...
                <div className="grid grid-cols-3 gap-4 text-sm">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-red-400">{gameState.guildsConquered}</div>
                    <div>Guilds Conquered</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-blue-400">{gameState.legendaryItems}</div>
        ...
        <div className="bg-black/50 rounded-lg p-6 border-2 border-orange-500/30">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {Object.entries(visualEffects).map(([key, value]) => (
              <div key={key} className="text-center p-3 bg-gradient-to-br from-orange-900/30 to-red-900/30 rounded border border-orange-500/30">
                <div className="text-sm text-orange-300 capitalize">{key.replace(/([A-Z])/g, ' $1')}</div>
