    ...
    setSnake((prevSnake) => {
      ...
      setGaiaTokens((prevTokens) => {
        ...
        for (let i = 0; i < newTokens.length; i++) {
          if (
            newTokens[i].position.x === head.x &&
            newTokens[i].position.y === head.y
          ) {
            ...
            setGameStats((prev) => {
              ...
              if (newTokensCollected >= WIN_THRESHOLD) {
                ...
                toast.success("🌌 BLACKHOLE ACTIVATED!", {
                  description:
                    "You reached 100 GAIA tokens! Entering random multiplayer battle!",
                  duration: 6000,
                });
                return {
                  ...prev,
                  ...
                  tokensWonThisWeek:
                    prev.tokensWonThisWeek + newTokensCollected,
                };
              }
      ...
      <CardHeader>
        ...
        <div className="flex justify-between items-center">
          <p className="text-muted-foreground">
            Cost: {GAME_COST} GAIA to play | Win up to 100 GAIA | Max 10
            wins/week
          </p>
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-black/80 rounded-lg">
                <div className="text-center">
                  ...
                  <div className="text-sm text-muted-foreground mb-4">
                    Collect GAIA tokens to win! Reach 100 tokens to access the
                    blackhole!
                  </div>
                  <Button
                    onClick={startGame}
