  ...
  const [designPresets] = useState<DesignPreset[]>([
    {
      ...
      config: {
        colors: { primary: '#00ff00', secondary: '#00ffff', accent: '#ff00ff', background: '#000000', text: '#ffffff' },
        fonts: { heading: 'Orbitron', body: 'Inter', mono: 'Fira Code' },
        spacing: { container: 1400, padding: 32, gap: 24, borderRadius: 12 },
        effects: { shadows: true, animations: true, blur: true, gradient: true, particles: true, glow: true }
      }
    },
    {
      id: 'nature-green',
      ...
      config: {
        colors: { primary: '#22c55e', secondary: '#16a34a', accent: '#84cc16', background: '#f0fdf4', text: '#166534' },
        fonts: { heading: 'Playfair Display', body: 'Inter', mono: 'JetBrains Mono' },
        spacing: { container: 1200, padding: 24, gap: 16, borderRadius: 16 },
        effects: { shadows: true, animations: false, blur: false, gradient: true, particles: false, glow: false }
      }
    },
    {
      id: 'cosmic-purple',
      ...
      config: {
        colors: { primary: '#8b5cf6', secondary: '#a855f7', accent: '#d946ef', background: '#0c0a1e', text: '#e2e8f0' },
        fonts: { heading: 'Space Grotesk', body: 'Inter', mono: 'Source Code Pro' },
                ...
                <Card className="border-blue-500/30">
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <Select value={designConfig.layout.device} onValueChange={(value) => 
                        setDesignConfig(prev => ({ ...prev, layout: { ...prev.layout, device: value } }))
                      }>
                        <SelectTrigger>
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                          <SelectItem value="desktop"><Monitor className="h-4 w-4 mr-2 inline" />Desktop</SelectItem>
                          <SelectItem value="tablet"><Tablet className="h-4 w-4 mr-2 inline" />Tablet</SelectItem>
                    ...
                    <div>
                      ...
                      <Slider
                        ...
                        onValueChange={(value) => 
                          setDesignConfig(prev => ({ ...prev, spacing: { ...prev.spacing, container: value[0] } }))
                        }
                        min={800}
                        max={1600}
                        step={50}
                    ...
                    <div>
                      ...
                      <Slider
                        ...
                        onValueChange={(value) => 
                          setDesignConfig(prev => ({ ...prev, spacing: { ...prev.spacing, padding: value[0] } }))
                        }
                        min={8}
                        max={64}
                        step={4}
                    ...
                    <div>
                      ...
                      <Slider
                        ...
                        onValueChange={(value) => 
                          setDesignConfig(prev => ({ ...prev, spacing: { ...prev.spacing, borderRadius: value[0] } }))
                        }
                        min={0}
                        max={32}
                        step={2}
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          setDesignConfig(prev => ({ ...prev, layout: { ...prev.layout, sidebar: checked } }))
                        }
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          setDesignConfig(prev => ({ ...prev, layout: { ...prev.layout, header: checked } }))
                        }
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          setDesignConfig(prev => ({ ...prev, layout: { ...prev.layout, footer: checked } }))
                        }
                      />
                    </div>
                  </CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {Object.entries(designConfig.colors).map(([colorName, colorValue]) => (
                  <Card key={colorName} className="border-purple-500/30">
                    <CardHeader>
                      <CardTitle className="capitalize text-purple-400">{colorName} Color</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div 
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {Object.entries(designConfig.fonts).map(([fontType, fontValue]) => (
                  <Card key={fontType} className="border-blue-500/30">
                    ...
                    <CardContent className="space-y-4">
                      <Select value={fontValue} onValueChange={(value) => 
                        setDesignConfig(prev => ({ ...prev, fonts: { ...prev.fonts, [fontType]: value } }))
                      }>
                        <SelectTrigger>
                          <SelectValue />
                        </SelectTrigger>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            setDesignConfig(prev => ({ 
                              ...prev, 
                              effects: { ...prev.effects, [effectName]: checked } 
                            }))
                          }
                        />
                      </div>
            ...
            <TabsContent value="media" className="space-y-6 mt-6">
              <Card className="border-cyan-500/30">
                <CardHeader>
                  ...
                  <p className="text-muted-foreground">Upload and manage images, videos, and other media files</p>
                </CardHeader>
                <CardContent className="space-y-6">
                  ...
                  >
                    ...
                    <div className="text-lg font-bold text-cyan-400 mb-2">Drop files here or click to upload</div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                    {mediaFiles.map((file) => (
                      <Card key={file.id} className="border-gray-500/30 hover:border-cyan-500/50 transition-colors">
            ...
            <TabsContent value="presets" className="space-y-6 mt-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {designPresets.map((preset) => (
                  <Card key={preset.id} className="border-indigo-500/30 hover:border-indigo-500/50 transition-colors cursor-pointer">
                    <CardHeader>
                    ...
                    <CardContent className="space-y-4">
                      <div className="flex gap-2">
                        {Object.values(preset.config.colors).slice(0, 5).map((color, index) => (
                          <div 
                            key={index}
                      ...
                      <div className="space-y-2 text-xs">
                        ...
                        <div>Effects: {Object.values(preset.config.effects).filter(Boolean).length} enabled</div>
                      </div>
