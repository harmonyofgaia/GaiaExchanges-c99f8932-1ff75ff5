...
export function FullVisualControlPanel({ isOpen, onClose, activeEffects, onEffectToggle }: FullVisualControlPanelProps) {
  ...
  const presetThemes = [
    {
      name: 'Neon Cyberpunk',
      colors: { primary: '#00ff41', secondary: '#ff0080', accent: '#ffff00', background: '#0a0a0a', foreground: '#ffffff', muted: '#404040', border: '#00ff41' }
    },
    {
      name: 'Ocean Deep',
      colors: { primary: '#0066cc', secondary: '#00ccff', accent: '#66ccff', background: '#001122', foreground: '#ffffff', muted: '#336699', border: '#0066cc' }
    },
    {
      name: 'Forest Dream',
      colors: { primary: '#22c55e', secondary: '#16a34a', accent: '#84cc16', background: '#0f1a0f', foreground: '#ffffff', muted: '#4a7c59', border: '#22c55e' }
    },
    {
      name: 'Solar Flare',
      colors: { primary: '#ff6600', secondary: '#ff9933', accent: '#ffcc00', background: '#1a0f00', foreground: '#ffffff', muted: '#995c33', border: '#ff6600' }
    }
  ]
  ...
  return (
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
      <div className={`bg-background/98 backdrop-blur-md border border-primary/30 rounded-xl shadow-2xl overflow-hidden transition-all duration-300 ${
        ...
        <div className="flex items-center justify-between p-6 border-b border-primary/20 bg-gradient-to-r from-purple-900/30 to-indigo-900/30">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Complete interface customization suite</p>
            </div>
          </div>
        ...
        {/* Content */}
        <div className="overflow-y-auto" style={{ maxHeight: isMaximized ? 'calc(100vh - 80px)' : 'calc(95vh - 80px)' }}>
                    ...
                    <CardContent className="space-y-4">
                      <div>
                        ...
                        <Slider
                          ...
                          onValueChange={(value) => 
                            setThemeConfig(prev => ({ ...prev, effects: { ...prev.effects, blur: value[0] } }))
                          }
                          max={20}
                          step={1}
                          className="mt-2"
                      ...
                      <div>
                        ...
                        <Slider
                          ...
                          onValueChange={(value) => 
                            setThemeConfig(prev => ({ ...prev, effects: { ...prev.effects, brightness: value[0] } }))
                          }
                          max={200}
                          min={10}
                          className="mt-2"
                      ...
                      <div>
                        ...
                        <Slider
                          ...
                          onValueChange={(value) => 
                            setThemeConfig(prev => ({ ...prev, effects: { ...prev.effects, contrast: value[0] } }))
                          }
                          max={200}
                          min={10}
                          className="mt-2"
                      ...
                      <div>
                        ...
                        <Slider
                          ...
                          onValueChange={(value) => 
                            setThemeConfig(prev => ({ ...prev, effects: { ...prev.effects, saturation: value[0] } }))
                          }
                          max={200}
                          min={0}
                          className="mt-2"
                    ...
                    <CardContent className="space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            setThemeConfig(prev => ({ ...prev, animation: { ...prev.animation, enabled: checked } }))
                          }
                        />
                      </div>
                      <div>
                        ...
                        <Slider
                          ...
                          onValueChange={(value) => 
                            setThemeConfig(prev => ({ ...prev, animation: { ...prev.animation, speed: value[0] } }))
                          }
                          max={5}
                          min={0.1}
                          step={0.1}
                      ...
                      <div>
                        ...
                        <Slider
                          ...
                          onValueChange={(value) => 
                            setThemeConfig(prev => ({ ...prev, animation: { ...prev.animation, intensity: value[0] } }))
                          }
                          max={100}
                          className="mt-2"
                        />
                    ...
                    <CardContent className="space-y-4">
                      <div>
                        ...
                        <Slider
                          ...
                          onValueChange={(value) => 
                            setThemeConfig(prev => ({ ...prev, layout: { ...prev.layout, spacing: value[0] } }))
                          }
                          max={64}
                          min={4}
                          step={2}
                      ...
                      <div>
                        ...
                        <Slider
                          ...
                          onValueChange={(value) => 
                            setThemeConfig(prev => ({ ...prev, layout: { ...prev.layout, borderRadius: value[0] } }))
                          }
                          max={32}
                          step={1}
                          className="mt-2"
                    ...
                    <CardContent className="space-y-4">
                      <div>
                        ...
                        <Slider
                          ...
                          onValueChange={(value) => 
                            setThemeConfig(prev => ({ ...prev, layout: { ...prev.layout, fontSize: value[0] } }))
                          }
                          max={24}
                          min={12}
                          className="mt-2"
                      ...
                      <div>
                        ...
                        <Slider
                          ...
                          onValueChange={(value) => 
                            setThemeConfig(prev => ({ ...prev, layout: { ...prev.layout, lineHeight: value[0] } }))
                          }
                          max={3}
                          min={1}
                          step={0.1}
              ...
              <TabsContent value="presets" className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {presetThemes.map((preset, index) => (
                    <Card key={index} className="border-purple-500/30 cursor-pointer hover:bg-purple-500/5" onClick={() => applyPreset(preset)}>
                      <CardHeader>
