...
export function EnhancedCoinCrafter() {
  const [craftingPhase, setCraftingPhase] = useState<'preparation' | 'heating' | 'hammering' | 'finishing' | 'complete'>('preparation')
  ...
  const getPhaseDescription = () => {
    switch (craftingPhase) {
      case 'preparation': return '🔧 Preparing steel and tools...'
      case 'heating': return '🔥 Heating steel in dragon forge...'
      case 'hammering': return `🔨 Hammering coins (${hammerStrikes}/5)...`
      case 'finishing': return '✨ Adding final touches and polish...'
      case 'complete': return '✅ Batch complete! Ready for next craft.'
      default: return 'Crafting in progress...'
    }
  }
            ...
            <div className="flex flex-col items-center">
              <div className="relative">
                ...
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                  ...
                  {craftingPhase === 'hammering' && <div className="text-3xl animate-bounce">🟨</div>}
