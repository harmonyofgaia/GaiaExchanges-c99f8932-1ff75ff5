...
export function BlockchainStatus() {
  const networkStats = [
    { label: 'Network Status', value: 'OPERATIONAL', icon: Activity, color: 'text-green-400' },
    { label: 'Security Level', value: 'MAXIMUM', icon: Shield, color: 'text-blue-400' },
    { label: 'Transaction Speed', value: '< 1ms', icon: Zap, color: 'text-yellow-400' },
    { label: 'Data Integrity', value: '100%', icon: Database, color: 'text-purple-400' },
    { label: 'Network Nodes', value: '2,847', icon: Network, color: 'text-cyan-400' }
  ]
      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-4">
          {networkStats.map((stat, index) => {
            ...
            return (
              <div key={index} className="text-center p-3 bg-black/20 rounded-lg border border-gray-700">
