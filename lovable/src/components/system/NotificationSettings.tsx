    ...
    <Card className="border-blue-500/50 bg-gradient-to-r from-blue-900/30 to-indigo-900/30">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          <Label className="text-lg font-semibold text-orange-400">🐉 Dragon Level Notifications</Label>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              { key: 'tokenEarnings', label: 'GAIA Token Earnings', icon: '💰' },
              { key: 'videoApprovals', label: 'Video Approvals', icon: '🎥' },
              { key: 'securityAlerts', label: 'Security Alerts', icon: '🛡️' }
            ].map(({ key, label, icon }) => (
              <div key={key} className="flex items-center justify-between p-3 rounded bg-blue-500/10 border border-blue-500/20">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between p-3 rounded bg-purple-500/10 border border-purple-500/20">
              <Label className="flex items-center gap-2">
                {preferences.desktopNotifications ? <Bell className="h-4 w-4" /> : <BellOff className="h-4 w-4" />}
        ...
        <div className="pt-4 border-t border-blue-500/20">
          <Button onClick={testNotification} className="w-full bg-gradient-to-r from-blue-600 to-purple-600">
