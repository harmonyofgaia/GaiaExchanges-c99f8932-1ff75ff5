  ...
  const initializeCommunityProposals = () => {
    const proposals: CommunityProposal[] = [
      ...
      },
      {
        ...
        description:
          "Fund breakthrough research into quantum-enhanced solar panel technology",
      ...
      },
      {
        ...
        description:
          "Implement next-generation prediction algorithms for improved accuracy",
    ...
    const pools: StakingPool[] = [
      {
        ...
        description:
          "Stake tokens to earn rewards from accurate climate forecasting",
        totalStaked: 2450000,
        participants: 1847,
        apy: 12.5,
        lockPeriod: 90,
      ...
      },
      {
        ...
        description:
          "Support marine ecosystem protection and restoration projects",
        totalStaked: 1890000,
        participants: 1432,
        apy: 15.2,
        lockPeriod: 180,
      ...
      },
      {
        ...
        description:
          "Fund breakthrough research in sustainable energy technologies",
        totalStaked: 3120000,
        participants: 2156,
        apy: 18.7,
        lockPeriod: 365,
      ...
      prev.map((pool) => {
        if (pool.id === poolId) {
          return {
            ...
            participants:
              pool.userStaked === 0 ? pool.participants + 1 : pool.participants,
          };
        }
        return pool;
      }),
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-muted-foreground mb-3">
                          Proposed by: {proposal.proposer} • Staking
                          requirement: {proposal.stakingRequirement} GAIA •
                      ...
                      <div>
                        <div className="flex justify-between items-center mb-2">
                          ...
                          <span className="text-red-400 font-bold">
                            {Math.round(
                              (proposal.votesAgainst / proposal.totalVoters) *
                                100,
                            )}
                            %
                          </span>
                        ...
                        <Progress
                          value={
                            (proposal.votesAgainst / proposal.totalVoters) * 100
                          }
                          className="h-2"
                        />
                      </div>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-muted-foreground">
                          {Math.floor(
                            (Date.now() - reward.timestamp.getTime()) /
                              1000 /
                              60,
                          )}{" "}
                          minutes ago
