...
export function CommunityRewardsProgram() {
  ...
  const userLevels: UserLevel[] = [
    { level: 1, name: 'Eco Newbie', pointsRequired: 0, benefits: ['Basic rewards'], multiplier: 1.0, color: 'text-gray-400' },
    { level: 2, name: 'Green Starter', pointsRequired: 100, benefits: ['5% point bonus'], multiplier: 1.05, color: 'text-green-400' },
    { level: 3, name: 'Nature Friend', pointsRequired: 300, benefits: ['10% point bonus', 'Discount access'], multiplier: 1.1, color: 'text-green-500' },
    { level: 4, name: 'Eco Warrior', pointsRequired: 600, benefits: ['15% point bonus', 'Exclusive rewards'], multiplier: 1.15, color: 'text-blue-400' },
    { level: 5, name: 'Planet Guardian', pointsRequired: 1000, benefits: ['20% point bonus', 'Priority access'], multiplier: 1.2, color: 'text-blue-500' },
    { level: 6, name: 'Environmental Hero', pointsRequired: 1600, benefits: ['25% point bonus', 'VIP rewards'], multiplier: 1.25, color: 'text-purple-400' },
    { level: 7, name: 'Gaia Champion', pointsRequired: 2400, benefits: ['30% point bonus', 'Premium benefits'], multiplier: 1.3, color: 'text-purple-500' },
    { level: 8, name: 'Climate Leader', pointsRequired: 3500, benefits: ['35% point bonus', 'Leadership perks'], multiplier: 1.35, color: 'text-yellow-400' },
    { level: 9, name: 'Earth Protector', pointsRequired: 5000, benefits: ['40% point bonus', 'Elite access'], multiplier: 1.4, color: 'text-orange-400' },
    { level: 10, name: 'Planetary Sage', pointsRequired: 7500, benefits: ['50% point bonus', 'Master benefits'], multiplier: 1.5, color: 'text-red-400' }
  ]
      ...
      <CardContent className="space-y-6">
        ...
        {nextLevel && (
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              <span className={currentLevel.color}>Level {userLevel}: {currentLevel.name}</span>
              <span className={nextLevel.color}>Next: {nextLevel.name}</span>
            </div>
            <Progress 
              value={((userPoints - currentLevel.pointsRequired) / (nextLevel.pointsRequired - currentLevel.pointsRequired)) * 100} 
              className="h-3"
            />
        ...
        <Tabs defaultValue="discounts" className="w-full">
          <TabsList className="grid w-full grid-cols-4">
            ...
            <TabsTrigger value="exclusive" className="text-xs">👑 Exclusive</TabsTrigger>
                    ...
                    <div className="flex items-start justify-between mb-2">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          {reward.limited && (
                            <Badge className="bg-red-600 text-xs">Limited</Badge>
                          )}
                        </div>
                      </div>
                      <div className="text-right">
          ...
          <TabsContent value="levels" className="space-y-4">
            <h3 className="text-lg font-semibold text-yellow-400">📊 Level Progression & Benefits</h3>
                ...
                >
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <div className={`text-lg font-bold ${level.color}`}>{level.multiplier}x</div>
