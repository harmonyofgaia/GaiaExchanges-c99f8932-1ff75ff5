      ...
      <CardContent className="space-y-6">
        ...
        {isRiding && activeRide && (
          <div className="p-4 bg-gradient-to-r from-green-500/20 to-blue-500/20 rounded-lg border border-green-500/30 animate-pulse">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-bold text-green-400">🚴 Currently Riding: {activeRide.name}</h3>
            ...
            <div className="text-center text-sm text-muted-foreground mt-2">
              {distance.toFixed(1)} / {activeRide.distance}km • {activeRide.multiplier}x eco-multiplier active
            </div>
          </div>
        )}
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 gap-4">
            ...
            <div className="text-center p-4 bg-orange-900/30 rounded-lg border border-orange-500/20">
              <div className="text-xl font-bold text-orange-400">{bikeStats.caloriesBurned.toLocaleString()}</div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {ecoRoutes.map((route) => (
              <div key={route.id} className="p-4 bg-green-900/20 rounded-lg border border-green-500/20">
                ...
                <div className="space-y-2">
                  <h5 className="text-sm font-medium text-green-400">🌱 Eco Features Along Route:</h5>
        ...
        <div className="p-4 bg-gradient-to-r from-green-500/10 to-cyan-500/10 rounded-lg border border-green-500/20">
          <p className="text-sm text-green-300">
            💡 <strong>Eco Route Bonus:</strong> Special routes with environmental features earn multiplied rewards! Visit eco-points for extra tokens and help maintain local environmental projects!
          </p>
        </div>
      </CardContent>
    </Card>
