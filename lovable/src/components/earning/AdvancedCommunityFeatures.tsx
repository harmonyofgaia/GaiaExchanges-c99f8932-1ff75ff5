  ...
  const communityEvents: CommunityEvent[] = [
    {
      ...
      description: 'Join us for a weekend of tree planting and habitat restoration in the city center',
      date: '2024-02-15',
  ...
  const ideaExchange: IdeaExchange[] = [
    {
      ...
      description: 'Smart composting bins that optimize decomposition and track community waste reduction',
      author: 'TechEco Anna',
      votes: 127,
      category: 'technology',
    ...
    },
    {
      ...
      description: 'Teaching schools how to create living roofs that reduce energy costs and improve air quality',
        ...
        <Tabs value={selectedTab} onValueChange={setSelectedTab} className="w-full">
                  ...
                  <CardContent className="p-6">
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        <div className="flex items-center gap-2 mb-2">
                          <h4 className="text-lg font-semibold text-purple-300">{community.name}</h4>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      <div className="text-center p-2 bg-green-900/20 rounded-lg">
                        <div className="text-lg font-bold text-green-400">{community.impact.treesPlanted}</div>
                        <div className="text-xs text-muted-foreground">Trees Planted</div>
                      </div>
                      <div className="text-center p-2 bg-blue-900/20 rounded-lg">
                        <div className="text-lg font-bold text-blue-400">{community.impact.co2Reduced}</div>
                        <div className="text-xs text-muted-foreground">CO2 Reduced (kg)</div>
                      </div>
                      <div className="text-center p-2 bg-orange-900/20 rounded-lg">
                        <div className="text-lg font-bold text-orange-400">{community.impact.wasteCollected}</div>
                    ...
                    <div className="flex justify-between items-start mb-4">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <Badge className={`${
                            idea.implementation === 'completed' ? 'bg-green-600' :
                            idea.implementation === 'active' ? 'bg-yellow-600' : 'bg-blue-600'
                          }`}>
          ...
          <TabsContent value="impact" className="space-y-6">
            ...
            <Card className="border-green-500/30 bg-green-900/10">
              <CardContent className="p-6">
                <h4 className="text-lg font-semibold text-green-400 mb-4">🎉 Recent Community Achievements</h4>
