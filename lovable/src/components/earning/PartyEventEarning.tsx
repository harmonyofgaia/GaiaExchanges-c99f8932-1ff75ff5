      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          {activeEvents.map((event) => (
            <div
              key={event.id}
              className="flex items-center justify-between p-3 bg-pink-900/20 rounded-lg border border-pink-500/20"
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">
                    {event.theme} • {event.attendees} attendees
                  </div>
                </div>
              </div>
        ...
        <form
          ...
          className="space-y-4 p-4 bg-gradient-to-r from-pink-900/20 to-purple-900/20 rounded-lg border border-pink-500/20"
        >
