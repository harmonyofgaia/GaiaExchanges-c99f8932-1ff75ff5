          ...
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="text-2xl font-bold bg-gradient-to-r from-emerald-400 via-green-400 to-blue-400 bg-clip-text text-transparent flex items-center gap-3">
                ...
                <Activity
                  className={`h-6 w-6 ${isActive ? "animate-pulse text-green-400" : "text-gray-400"}`}
                />
              </CardTitle>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="border-blue-500/30 bg-gradient-to-br from-blue-900/30 to-cyan-900/30">
          ...
          <CardContent>
            ...
            <div
              className={`text-sm flex items-center gap-1 ${marketData.volumeChange24h >= 0 ? "text-green-400" : "text-red-400"}`}
            >
              ...
              {marketData.volumeChange24h >= 0 ? "+" : ""}
              {marketData.volumeChange24h.toFixed(2)}%
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-purple-500/30 bg-gradient-to-br from-purple-900/30 to-pink-900/30">
          ...
          <CardContent>
            ...
            <div
              className={`text-sm flex items-center gap-1 ${generationMetrics.netSupplyChange >= 0 ? "text-green-400" : "text-red-400"}`}
            >
              <Zap className="h-3 w-3" />
              {generationMetrics.netSupplyChange >= 0 ? "+" : ""}
              {generationMetrics.netSupplyChange}/min
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="text-emerald-400 font-bold">
                  {generationMetrics.generationRate} tokens/min
                </span>
              </div>
              <Progress
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="text-red-400 font-bold">
                  {generationMetrics.burnRate} tokens/min
                </span>
              </div>
              <Progress
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span
                  className={`font-bold ${generationMetrics.netSupplyChange >= 0 ? "text-green-400" : "text-red-400"}`}
                >
                  {generationMetrics.netSupplyChange >= 0 ? "+" : ""}
                  {generationMetrics.netSupplyChange} tokens/min
                </span>
              </div>
            </div>
              ...
              recentTransactions.map((tx) => (
                ...
                >
                  ...
                  <div className="text-right">
                    <div
                      className={`text-xs ${tx.impact >= 0 ? "text-green-400" : "text-red-400"}`}
                    >
                      {tx.impact >= 0 ? "+" : ""}
                      {tx.impact.toFixed(2)}%
                    </div>
