    ...
    <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            ...
            <div className="text-center p-3 rounded-lg bg-orange-900/20">
              ...
              <div className="text-2xl font-bold text-orange-400">
                {wildfireData.temperature.toFixed(1)}°C
              </div>
            ...
            <div className="text-center p-3 rounded-lg bg-blue-900/20">
              ...
              <div className="text-2xl font-bold text-blue-400">
                {wildfireData.humidity.toFixed(1)}%
              </div>
            ...
            <div className="text-center p-3 rounded-lg bg-gray-900/20">
              ...
              <div className="text-2xl font-bold text-gray-400">
                {wildfireData.windSpeed.toFixed(1)} km/h
              </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {protectionZones.map((zone) => (
          <Card
            key={zone.id}
            className="border-orange-500/20 bg-gradient-to-br from-orange-900/10 to-red-900/10 hover:scale-105 transition-all duration-300"
          >
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-orange-400">
