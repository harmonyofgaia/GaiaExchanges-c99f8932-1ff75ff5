...
import { Shield, Waves, Fish, Anchor, AlertTriangle, Heart, Target, Zap, TreePine, Flame } from 'lucide-react'
...
export function SandProtectInvestmentProject() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setProjectStats(prev => ({
        ...
        fundingRaised: Math.min(prev.fundingRaised + Math.floor(Math.random() * 100), prev.fundingGoal),
  ...
  const projectPhases = [
    {
      ...
      description: "Advanced sand barrier systems preventing beach erosion and protecting marine ecosystems",
      status: "Active",
      completion: 78,
      investment: 45000
    },
    {
      ...
      description: "Revolutionary sand cannon technology creating firebreaks to protect communities",
      status: "In Progress", 
      completion: 45,
      investment: 62000
    },
    {
      ...
      description: "Combining sand protection with marine life conservation and coral reef restoration",
      status: "Planning",
      completion: 12,
      investment: 43000
    }
  ...
  const investmentTiers = [
    ...
    },
    {
      ...
      benefits: ["All Guardian benefits", "Site visit opportunity", "Quarterly reports", "Named sand barrier"],
      color: "from-teal-500 to-green-500"
    },
    {
      amount: 2000,
      title: "Marine Defender",
      benefits: ["All Protector benefits", "Advisory board access", "Custom project updates", "Recognition plaque"],
      color: "from-green-500 to-emerald-500"
    },
    {
      amount: 10000,
      title: "Ecosystem Champion",
      benefits: ["All Defender benefits", "Strategic partnership", "Project naming rights", "Annual impact summit"],
    ...
    <div className="space-y-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-blue-300/80 mt-1">
                  Protecting coastal ecosystems and preventing wildfires through advanced sand barrier technology
                </p>
              </div>
            </div>
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              ...
              <span className="text-green-300">
                ${projectStats.fundingRaised.toLocaleString()} / ${projectStats.fundingGoal.toLocaleString()}
              </span>
            </div>
      ...
      <Card className="bg-gradient-to-br from-cyan-900/30 to-blue-900/30 border-cyan-500/30">
        <CardHeader>
          ...
          <p className="text-cyan-300/80">Choose your impact level and join the protection mission</p>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Your investment doesn't just generate returns - it protects coastlines, prevents wildfires, 
          and preserves marine ecosystems for future generations.
        </p>
