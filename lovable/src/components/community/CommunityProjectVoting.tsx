...
export function CommunityProjectVoting() {
  const [projects, setProjects] = useState<Project[]>([
    {
      ...
      description: 'Install solar panels on community buildings to create a local renewable energy grid',
      category: 'renewable',
      fundingGoal: 50000,
    ...
    },
    {
      ...
      description: 'Plant 1000 native trees throughout the city to improve air quality and biodiversity',
  ...
  const getCategoryIcon = (category: Project['category']) => {
    switch (category) {
      ...
      case 'infrastructure': return Droplets
      default: return Vote
    }
  }
  ...
  const getCategoryColor = (category: Project['category']) => {
    switch (category) {
      ...
      case 'infrastructure': return 'bg-purple-600'
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span>{project.currentFunding.toLocaleString()} / {project.fundingGoal.toLocaleString()} GAiA</span>
                  </div>
