        ...
        {contracts.length === 0 ? (
          <Card>
            <CardContent className="pt-6 text-center">
              ...
              <p className="text-muted-foreground">
                No contracts yet. Create your first big holder contract!
              </p>
            </CardContent>
          </Card>
        ) : (
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      <span className="font-semibold text-lg">
                        {contract.investment_amount.toLocaleString()} GAIA
                      </span>
                      <Badge
                        className={
                          contract.contract_status === "active"
                            ? "bg-green-600"
                            : contract.contract_status === "qr_verified"
                              ? "bg-blue-600"
                              : "bg-yellow-600"
                        }
                      >
                    ...
                    <div className="flex items-center gap-4 text-sm">
                      <div className="flex items-center gap-1">
                        <CheckCircle
                          className={`h-4 w-4 ${contract.google_auth_verified ? "text-green-400" : "text-gray-400"}`}
                        />
                        <span>Google Auth</span>
                      </div>
                      <div className="flex items-center gap-1">
                        <QrCode
                          className={`h-4 w-4 ${contract.qr_code_verified ? "text-green-400" : "text-gray-400"}`}
                        />
