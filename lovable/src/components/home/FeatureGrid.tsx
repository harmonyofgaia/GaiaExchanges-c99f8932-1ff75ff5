  ...
  const features = [
    {
      ...
      description:
        "Quantum-level security with mythical dragon power protecting every transaction and user interaction.",
    ...
    },
    {
      ...
      description:
        "Military-grade encryption with quantum computing protection against all future threats.",
    ...
    },
    {
      ...
      description:
        "Completely invincible defense system - 100x stronger than any technology that will ever be created.",
    ...
    },
    {
      ...
      description:
        "Building the most harmonious and united global community in cryptocurrency history.",
    ...
    },
    {
      ...
      description:
        "Revolutionary trading platform with the most advanced security and user experience in the world.",
    ...
    },
    {
      ...
      description:
        "Advanced AI-powered defense system that evolves and adapts to neutralize any threat instantly.",
          ...
          return (
            <div key={index} className="relative group h-full">
              ...
              >
                ...
                <div className="absolute inset-0 opacity-10 graffiti-texture" />

                <CardContent className="p-6 h-full flex flex-col justify-between relative z-10">
                  <div>
                    <div className="flex items-center justify-center mb-4">
                      <div
                        className={`p-4 rounded-full bg-gradient-to-r ${feature.gradient} shadow-lg`}
                      >
