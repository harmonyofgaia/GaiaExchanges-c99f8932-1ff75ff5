    ...
    <Card className="bg-gradient-to-br from-orange-900/30 via-red-900/20 to-yellow-900/30 border-orange-500/30 relative overflow-hidden">
      ...
      <CardHeader>
        ...
        <div className="flex items-center gap-2">
          <Badge className={`${isRealTimeCrafting ? 'bg-orange-600 animate-pulse' : 'bg-red-600'} text-white`}>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex flex-col items-center space-y-6 p-8 bg-black/40 rounded-lg border border-orange-500/30 relative overflow-hidden">
          ...
          <div className="relative z-10 text-center">
            ...
            <div className="text-sm text-orange-400 uppercase tracking-widest">Master GAiA Forge</div>
          </div>
          ...
          <div className="relative z-10 flex items-center justify-center space-x-8">
            ...
            <div className="flex flex-col items-center">
              <div className={`text-4xl transition-transform duration-200 ${hammerAnimation ? 'animate-bounce' : ''}`}>
                🔨
              </div>
        ...
        <div className="bg-gradient-to-r from-orange-500/10 to-red-500/10 border border-orange-500/20 rounded-lg p-6">
          ...
          <div className="text-sm text-orange-300 space-y-2">
            <p>
              Our legendary Master Craftsman forges 100 premium GAiA coins monthly using ancient techniques
              combined with quantum-level precision. Each coin is hand-crafted with love and joy protocols.
            </p>
