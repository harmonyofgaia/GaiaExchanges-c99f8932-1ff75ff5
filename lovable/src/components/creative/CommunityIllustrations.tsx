          ...
          <div className="text-center space-y-6">
            <div className="bg-red-900/20 border border-red-500/30 rounded-lg p-6">
              ...
              <p className="text-red-300 mb-4">
                Community artworks are now exclusively used for background creation and GAiA token sales. 
                Only administrators can access this system to maintain quality and control.
              </p>
