...
export function CreativeEngine({
  ...
  const generateAnimationsFromAsset = (asset: CreativeAsset): any[] => {
    ...
    return [
      {
        type: "flow",
        speed: processingParams.speed / 100,
        direction: "radial",
      },
      {
        type: "pulse",
        intensity: processingParams.intensity / 100,
        frequency: 0.5,
      },
      {
        type: "morph",
        complexity: processingParams.complexity / 100,
        style: processingParams.style,
      },
    ];
  };
            ...
            <TabsContent value="generate" className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-4">
                  ...
                  <div>
                    <Label className="text-gray-300">
                      Complexity: {processingParams.complexity}
                    </Label>
                    <Slider
                ...
                <div className="space-y-4">
                  <div>
                    <Label className="text-gray-300">
                      Animation Speed: {processingParams.speed}
                    </Label>
                    <Slider
                  ...
                  <div>
                    <Label className="text-gray-300">
                      Neural Density: {processingParams.neuralDensity}
                    </Label>
                    <Slider
                  ...
                  <div>
                    ...
                    <Select
                      value={processingParams.colorHarmony}
                      onValueChange={(value) =>
                        setProcessingParams((prev) => ({
                          ...prev,
                          colorHarmony: value,
              ...
              {selectedAsset ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-400">
                    Select an asset to process with the creative engine
                  </p>
                </div>
              )}
            </TabsContent>
              ...
              {templates.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {templates.map((template) => (
                    <Card
                      key={template.id}
                      className="bg-gray-800/50 hover:bg-gray-700/50 transition-all"
                    >
                      <CardContent className="p-4">
