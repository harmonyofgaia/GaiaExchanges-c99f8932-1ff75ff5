    ...
    <div className="space-y-6">
            ...
            <CardContent className="space-y-4">
              <div>
                <div className="flex justify-between text-sm mb-2">
                  ...
                  <span className="text-green-400">${project.funding.toLocaleString()} / ${project.goal.toLocaleString()}</span>
                </div>
      ...
      <Card className="border-purple-500/20 bg-purple-900/10">
        <CardContent className="pt-6">
          <h3 className="text-xl font-bold text-purple-400 mb-4 text-center">🌍 Global Conservation Impact</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center space-y-2">
              ...
              <p className="text-sm text-muted-foreground">Protecting crucial habitats and biodiversity</p>
            </div>
            <div className="text-center space-y-2">
              <Droplets className="h-12 w-12 text-blue-400 mx-auto" />
              <h4 className="font-semibold text-blue-400">Ocean Conservation</h4>
              <p className="text-sm text-muted-foreground">Cleaning oceans and protecting marine life</p>
            </div>
            <div className="text-center space-y-2">
              <Shield className="h-12 w-12 text-purple-400 mx-auto" />
              <h4 className="font-semibold text-purple-400">Wildlife Security</h4>
              <p className="text-sm text-muted-foreground">Anti-poaching and animal tracking systems</p>
            </div>
          </div>
        </CardContent>
      </Card>
