            ...
            >
              ...
              <div className="relative h-48 bg-gradient-to-br from-black via-gray-900 to-black overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div
                    className={`w-24 h-24 rounded-full bg-gradient-to-r ${getRarityColor(nft.rarity)} flex items-center justify-center animate-pulse group-hover:scale-110 transition-transform`}
                  >
                ...
                <div className="absolute top-2 right-2">
                  <Badge
                    className={`bg-gradient-to-r ${getRarityColor(nft.rarity)} text-white border-none`}
                  >
                    {nft.rarity}
                  </Badge>
                </div>
