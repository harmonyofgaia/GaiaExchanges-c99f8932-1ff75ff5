...
import { Palette, Wand2, Sparkles, Eye, Settings, Zap } from "lucide-react";
  ...
  const applyLandscapeStyle = (style: LandscapeStyle) => {
    ...
    if (applyToTools || applyToDesigns) {
      ...
      window.dispatchEvent(
        new CustomEvent("landscapeStyleApplied", {
          detail: {
            style,
            applyToTools,
            applyToDesigns,
                ...
                ${
                  style.difficulty === "Medium"
                    ...
                    : style.difficulty === "Hard"
                      ? "bg-orange-600"
                      : style.difficulty === "Expert"
                        ? "bg-red-600"
                        : style.difficulty === "Insane"
                          ? "bg-red-800"
                          : style.difficulty === "Legendary"
                            ? "bg-purple-600"
                            : style.difficulty === "Impossible"
                              ? "bg-black"
                              : "bg-gray-600"
                }
              `}
