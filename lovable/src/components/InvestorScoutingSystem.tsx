            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-purple-400">
                  {((totalInterested / totalContacted) * 100).toFixed(1)}%
                </p>
              </div>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex gap-4 flex-wrap">
            ...
            <Button variant="outline" asChild>
              <a
                href="https://8dfae018-363f-4770-8e5c-27c14bec8426.lovableproject.com/markets"
                target="_blank"
        ...
        <CardContent className="space-y-4">
          <div className="bg-black/20 p-4 rounded-lg">
            <div className="text-sm text-muted-foreground mb-2">
              🌍 LIVE WEBSITE URL (Test on any device):
            </div>
          ...
          <div className="flex gap-4 flex-wrap">
            ...
            <Button asChild variant="outline">
              <a
                href="https://8dfae018-363f-4770-8e5c-27c14bec8426.lovableproject.com"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Globe className="h-4 w-4 mr-2" />
