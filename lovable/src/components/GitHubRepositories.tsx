      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {repositories.map((repo) => (
            <div key={repo.name} className={`p-4 border border-border/50 rounded-lg bg-muted/20 hover:bg-muted/30 transition-colors ${repo.isMain ? 'ring-2 ring-green-500/30' : ''}`}>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h3 className="font-semibold text-sm flex items-center gap-2">
                        {repo.name}
                        {repo.isMain && <Badge className="bg-green-600 text-white text-xs">MAIN</Badge>}
                      </h3>
        ...
        <div className="pt-4 border-t border-border/20">
          <div className="text-center space-y-3">
            <h4 className="font-semibold text-blue-400">🌍 Culture of Harmony - Repository Features</h4>
            ...
            <div className="flex items-center justify-center gap-4 pt-2 flex-wrap">
              ...
              <Button size="sm" variant="outline" asChild>
                <a href={`${baseUrl}/gaia-exchanges/releases`} target="_blank" rel="noopener noreferrer">
