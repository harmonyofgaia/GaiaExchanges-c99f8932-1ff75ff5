              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    >
                      <CardContent className="pt-6">
                        <div className="text-center space-y-3">
                          ...
                          <h4
                            className={`text-xl font-bold ${getRarityColor(selectedWorm.rarity)}`}
                          >
                            {selectedWorm.name}
                          </h4>
                          <Badge
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    {[
                      "Fire Worm Elite",
                      "Ice Serpent Champion",
                      "Shadow Crawler Boss",
                      "Golden Beast Legend",
                      "Crystal Armor Giant",
                      "Lightning Storm Worm",
                    ].map((opponent, index) => (
                      <div
                        key={index}
                        className="flex items-center justify-between p-4 bg-black/20 rounded-lg border border-gray-500/20"
                      >
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      {battleResults.slice(0, 5).map((result, index) => (
                        <div
                          key={index}
                          className="flex items-center justify-between p-2 bg-green-900/20 rounded border border-green-500/20"
                        >
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-yellow-400">
                    {playerTokens.toLocaleString()} GAiA
                  </span>
                </div>
              </div>
            ...
            <TabsContent value="tournaments" className="space-y-4">
              <div className="space-y-4">
                {tournaments.map((tournament) => (
                  <Card
                    key={tournament.id}
                    className="border-purple-500/30 bg-gradient-to-r from-purple-900/20 to-pink-900/20"
                  >
                    <CardContent className="pt-6">
