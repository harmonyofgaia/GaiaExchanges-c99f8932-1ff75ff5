...
import { Wallet, ArrowUpDown, Shield, Zap, CheckCircle, AlertTriangle, Users, Repeat, Crown, Send, DollarSign, ExternalLink, Copy } from 'lucide-react'
                  ...
                  <CardContent className="p-4">
                    <div className="flex justify-between items-start mb-2">
                      <div>
                        ...
                        <p className="text-sm text-gray-400">{walletAccount.address.slice(0, 8)}...{walletAccount.address.slice(-6)}</p>
                      </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                      {walletAccount.tokens.map((token, tokenIndex) => (
                        <div key={tokenIndex} className="bg-gray-700/50 rounded p-2 text-center">
                          ...
                          <div className="text-sm font-semibold text-white">{token.balance.toFixed(2)}</div>
                        </div>
                      ))}
                    </div>
                  </CardContent>
