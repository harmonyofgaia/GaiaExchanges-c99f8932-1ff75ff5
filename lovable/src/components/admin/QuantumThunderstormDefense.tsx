      ...
      <Card className="border-red-500/50 bg-gradient-to-br from-red-900/30 to-black/80">
        ...
        <CardContent>
          ...
          <div className="flex gap-4 mb-6">
            ...
            <Badge
              className={`${attackMode === "THUNDERSTORM_ACTIVE" ? "bg-red-600 animate-bounce" : "bg-blue-600"}`}
            >
            ...
            <CardContent className="space-y-4">
              <div className="text-center">
                ...
                >
                  ...
                  {attackMode === "THUNDERSTORM_ACTIVE"
                    ? "THUNDERSTORM ACTIVE..."
                    : "UNLEASH THUNDERSTORM"}
                </Button>
              </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-4 gap-2">
                {Array.from({ length: Math.min(defenseWalls, 16) }, (_, i) => (
                  <div
                    key={i}
                    className="h-8 bg-blue-500/20 border border-blue-500/50 rounded flex items-center justify-center"
                  >
