...
export function AnimalTransferProtocols() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'recovering': return 'bg-green-600'
      ...
      <Card className="bg-gradient-to-br from-blue-900/30 to-cyan-900/30 border border-blue-500/30">
        <CardHeader>
          ...
          <p className="text-muted-foreground">
            Revolutionary animal welfare system ensuring zero-stress transportation to restoration sites
          </p>
        </CardHeader>
      </Card>
        ...
        <TabsContent value="protocols" className="space-y-6">
          <div className="grid gap-6">
            {transferProtocols.map((protocol) => (
              <Card key={protocol.id} className="bg-gradient-to-r from-gray-900/50 to-gray-800/50 border border-gray-700/50">
                <CardHeader>
        ...
        <TabsContent value="active" className="space-y-6">
          <div className="grid gap-6">
            {activeTransfers.map((transfer) => (
              <Card key={transfer.id} className="bg-gradient-to-br from-purple-900/30 to-blue-900/30 border border-purple-500/30">
                <CardHeader>
                  <div className="flex justify-between items-start">
