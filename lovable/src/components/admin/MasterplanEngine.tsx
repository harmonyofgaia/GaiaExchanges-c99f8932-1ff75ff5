  ...
  const masterplanIdeas: MasterplanIdea[] = [
    {
      ...
      description:
        "Link GAiA Token directly to verified carbon credits through quantum satellite verification, making each token backed by real environmental impact measurable from space.",
    ...
    },
    {
      ...
      description:
        "Deploy undetectable marketing bots across all social platforms that subtly promote GAiA through authentic-seeming conversations and recommendations.",
      category: "marketing",
      impact: 88,
      feasibility: 85,
      innovation: 90,
    },
    {
      ...
      description:
        "Create the first cryptocurrency exchange that operates across multiple virtual dimensions, allowing trading in VR, AR, and traditional spaces simultaneously.",
      category: "technology",
      impact: 94,
      feasibility: 72,
      innovation: 98,
    },
    {
      ...
      description:
        "Use unused satellite bandwidth to mine GAiA tokens, creating the first space-based mining operation with zero Earth environmental impact.",
      category: "global",
      impact: 91,
      feasibility: 68,
      innovation: 95,
    },
    {
      ...
      description:
        "Deploy AI that predicts and creates market conditions for explosive token growth before they happen, essentially manifesting baby booms.",
      category: "finance",
      impact: 89,
      feasibility: 82,
      innovation: 88,
    },
    {
      ...
      description:
        "Make GAiA Token evolve in real-time based on global environmental data, becoming more valuable as the planet heals.",
      category: "ecosystem",
      impact: 96,
      feasibility: 75,
      innovation: 94,
    },
    {
      ...
      description:
        "Create a completely undetectable system for wealthy investors to move funds into GAiA without any public record.",
      category: "finance",
      impact: 87,
      feasibility: 90,
      innovation: 85,
    },
    {
      ...
      description:
        "Pioneer the first thought-based cryptocurrency trading where users can buy/sell GAiA tokens through pure mental intention.",
      category: "technology",
      impact: 99,
      feasibility: 45,
      innovation: 100,
