...
export function AutonomousMastermind() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'implementing': return 'bg-blue-600'
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
            ...
            <div className="text-center p-3 rounded-lg bg-blue-900/30">
              ...
              <div className="text-lg font-bold text-blue-400">
                {features.filter(f => f.status === 'analyzing' || f.status === 'implementing').length}
              </div>
          ...
          {countdownTimer && pendingFeature && (
            <div className="bg-orange-900/30 border border-orange-500/30 rounded-lg p-4 mb-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-orange-400 font-bold">⏰ Auto-Apply in {countdownTimer} seconds</p>
        ...
        <CardContent className="pt-4">
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              className={autoApplyEnabled ? 'bg-green-600 hover:bg-green-700' : 'bg-red-600 hover:bg-red-700'}
            >
