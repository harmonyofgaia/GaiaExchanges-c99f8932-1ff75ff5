...
export function AdminNFTMarketplace() {
    ...
    const adminNFTs: GAiANFT[] = [
      {
        ...
        description:
          "Legendary armor crafted from ancient dragon scales with quantum enhancement",
      ...
      },
      {
        ...
        description:
          "Complete toolkit for environmental manipulation and world building",
      ...
      },
      {
        ...
        description:
          "Ultimate enhancement device for game mechanics and player abilities",
  ...
  const toggleSaleStatus = (nftId: string) => {
    setNfts((prev) =>
      prev.map((nft) =>
        nft.id === nftId ? { ...nft, forSale: !nft.forSale } : nft,
      ),
    );
    ...
    <div className="space-y-6">
      ...
      <Card className="border-2 border-purple-500/50 bg-gradient-to-br from-purple-900/30 to-pink-900/30">
        <CardHeader>
          ...
          <p className="text-muted-foreground">
            Complete admin control over NFT creation, pricing, and marketplace
            management
          </p>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-center">
            ...
            <div className="p-3 rounded-lg bg-orange-900/30 border border-orange-500/20">
              <div className="text-xl font-bold text-orange-400">
                {Math.round(
                  nfts.reduce((sum, n) => sum + n.burnRate, 0) / nfts.length,
                )}
                %
              </div>
      ...
      <Tabs defaultValue="marketplace" className="w-full">
        ...
        <TabsContent value="marketplace" className="space-y-4">
          ...
          <div className="flex gap-2 flex-wrap">
            {["all", "armor", "weapon", "tool", "landscape", "enhancement"].map(
              (category) => (
                <Button
                  key={category}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    value={newNFT.name || ""}
                    onChange={(e) =>
                      setNewNFT((prev) => ({ ...prev, name: e.target.value }))
                    }
        ...
        <TabsContent value="analytics" className="space-y-4">
          <div className="text-center py-8">
            ...
            <p className="text-muted-foreground">
              Track NFT performance and marketplace metrics
            </p>
          </div>
        </TabsContent>
      </Tabs>
