        ...
        <Card className="bg-gradient-to-br from-purple-900/40 to-indigo-900/40 border-purple-500/50">
          <CardContent className="p-4 text-center">
            ...
            <div className="text-2xl font-bold text-purple-400">
              {totalTargetsNeutralized.toLocaleString()}
            </div>
        ...
        <Card className="bg-gradient-to-br from-green-900/40 to-emerald-900/40 border-green-500/50">
          <CardContent className="p-4 text-center">
            ...
            <div className="text-2xl font-bold text-green-400">
              {dailyTasks.filter((t) => t.status === "running").length}
            </div>
        ...
        <TabsContent value="operations" className="space-y-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {tacticalOperations.map((operation) => (
              <Card
                key={operation.id}
                className="bg-gradient-to-br from-gray-900/50 to-gray-800/50 border-gray-700/50 hover:border-red-500/50 transition-all duration-300"
              >
