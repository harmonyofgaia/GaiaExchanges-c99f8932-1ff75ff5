...
export function BiometricAccessControl() {
  ...
  const getBiometricIcon = (type: string) => {
    switch (type) {
      ...
      case 'retina': return <Eye className="h-6 w-6" />
      case 'voice': return <Mic className="h-6 w-6" />
      case 'dna': return <Shield className="h-6 w-6" />
  ...
  const getBiometricColor = (type: string) => {
    switch (type) {
      case 'fingerprint': return 'text-blue-400 border-blue-500/30 bg-blue-900/20'
      case 'retina': return 'text-green-400 border-green-500/30 bg-green-900/20'
      case 'voice': return 'text-purple-400 border-purple-500/30 bg-purple-900/20'
      case 'dna': return 'text-red-400 border-red-500/30 bg-red-900/20'
    ...
    <Card className="bg-gradient-to-br from-indigo-900/30 to-purple-900/30 border border-indigo-500/30">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="text-center p-4 bg-gradient-to-r from-indigo-900/20 to-purple-900/20 rounded-lg border border-indigo-500/20">
          ...
          <div className="text-green-400 text-sm mt-1">ULTIMATE PROTECTION • DNA VERIFIED • QUANTUM SECURED</div>
        </div>
      </CardContent>
    </Card>
  )
