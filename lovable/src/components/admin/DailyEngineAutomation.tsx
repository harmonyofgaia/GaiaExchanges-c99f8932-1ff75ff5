...
export function DailyEngineAutomation() {
  ...
  const [tasks, setTasks] = useState<AutomationTask[]>([
    { id: '1', name: 'System Health Check', status: 'pending', progress: 0, priority: 'critical' },
    { id: '2', name: 'Database Optimization', status: 'pending', progress: 0, priority: 'high' },
    { id: '3', name: 'Security Scan', status: 'pending', progress: 0, priority: 'critical' },
    { id: '4', name: 'Backup Creation', status: 'pending', progress: 0, priority: 'high' },
    { id: '5', name: 'Performance Analytics', status: 'pending', progress: 0, priority: 'medium' },
    { id: '6', name: 'Threat Intelligence Update', status: 'pending', progress: 0, priority: 'high' },
    { id: '7', name: 'Resource Cleanup', status: 'pending', progress: 0, priority: 'medium' },
    { id: '8', name: 'Network Optimization', status: 'pending', progress: 0, priority: 'high' }
  ])
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="border rounded-lg p-4">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-sm font-bold">{tacticalMovements.defensive.toFixed(1)}%</span>
                </div>
              ...
              <div className="border rounded-lg p-4">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-sm font-bold">{tacticalMovements.offensive.toFixed(1)}%</span>
                </div>
              ...
              <div className="border rounded-lg p-4">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-sm font-bold">{tacticalMovements.reconnaissance.toFixed(1)}%</span>
                </div>
