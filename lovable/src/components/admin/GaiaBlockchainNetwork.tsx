...
export function GaiaBlockchainNetwork() {
  ...
  const [nodes, setNodes] = useState<BlockchainNode[]>([
    { id: 'gaia-001', status: 'offline', location: 'North America', power: 0, connections: 0 },
    { id: 'gaia-002', status: 'offline', location: 'Europe', power: 0, connections: 0 },
    { id: 'gaia-003', status: 'offline', location: 'Asia Pacific', power: 0, connections: 0 },
    { id: 'gaia-004', status: 'offline', location: 'South America', power: 0, connections: 0 },
    { id: 'gaia-005', status: 'offline', location: 'Africa', power: 0, connections: 0 },
    { id: 'gaia-006', status: 'offline', location: 'Oceania', power: 0, connections: 0 }
  ])
    ...
    if (networkActive) {
      const interval = setInterval(() => {
        setNodes(prevNodes => 
          prevNodes.map(node => ({
            ...node,
            status: node.status === 'offline' ? 'syncing' : 
                   node.status === 'syncing' ? 'online' : 'online',
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-blue-50 dark:bg-blue-950 p-4 rounded-lg text-center">
              <div className="text-2xl font-bold text-blue-600">{stats.activeNodes}/{stats.totalNodes}</div>
            ...
            <div className="bg-purple-50 dark:bg-purple-950 p-4 rounded-lg text-center">
              <div className="text-2xl font-bold text-purple-600">{stats.dominanceLevel.toFixed(1)}%</div>
            ...
            <div className="bg-orange-50 dark:bg-orange-950 p-4 rounded-lg text-center">
              <div className="text-2xl font-bold text-orange-600">{stats.networkSecurity.toFixed(1)}%</div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
                  <div className="text-center">
                    ...
                    <div className="text-2xl font-mono text-primary">{stats.blockHeight.toLocaleString()}</div>
                  </div>
                </div>
              </div>
            </div>
